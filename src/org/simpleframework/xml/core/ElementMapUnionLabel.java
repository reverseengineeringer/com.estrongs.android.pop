  ...
  implements Label
{
  ...
  public ElementMapUnionLabel(Contact paramContact, ElementMapUnion paramElementMapUnion, ElementMap paramElementMap)
  {
    extractor = new GroupExtractor(paramContact, paramElementMapUnion);
    label = new ElementMapLabel(paramContact, paramElementMap);
