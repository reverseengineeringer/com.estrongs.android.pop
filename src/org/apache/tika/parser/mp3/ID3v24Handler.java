  ...
  implements ID3Tags
{
  ...
  public ID3v24Handler(ID3v2Frame paramID3v2Frame)
  {
    paramID3v2Frame = new ID3v24Handler.RawV24TagIterator(this, paramID3v2Frame, null);
...
/* Location:
 * Qualified Name:     org.apache.tika.parser.mp3.ID3v24Handler
