  ...
  extends HttpRequestBase
{
  ...
  public HttpMove(String paramString1, String paramString2)
  {
    this(URI.create(paramString1), URI.create(paramString2));
  }
  
  public HttpMove(URI paramURI1, URI paramURI2)
  {
...
/* Location:
 * Qualified Name:     de.aflx.sardine.impl.methods.HttpMove
