...
public class Encdec
{
  ...
  public static int enc_time(Date paramDate, byte[] paramArrayOfByte, int paramInt1, int paramInt2)
  {
    ...
    case 3: 
      return enc_uint32be((int)(paramDate.getTime() / 1000L + 2082844800L & 0xFFFFFFFFFFFFFFFF), paramArrayOfByte, paramInt1);
    case 4: 
      return enc_uint32le((int)(paramDate.getTime() / 1000L + 2082844800L & 0xFFFFFFFFFFFFFFFF), paramArrayOfByte, paramInt1);
    case 6: 
