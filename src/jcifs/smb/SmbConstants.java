...
abstract interface SmbConstants
{
  ...
  static
  {
    ...
    SND_BUF_SIZE = Config.getInt("jcifs.smb.client.snd_buf_size", 61510);
    RCV_BUF_SIZE = Config.getInt("jcifs.smb.client.rcv_buf_size", 61510);
    ...
    for (int k = n;; k = 0)
    {
      DEFAULT_CAPABILITIES = i | j | k | 0x1000;
