...
public class netdfs$DfsEnumArray3
  extends NdrObject
{
  public int count;
  ...
  public void decode(NdrBuffer paramNdrBuffer)
  {
    ...
    if (paramNdrBuffer.dec_ndr_long() != 0)
    {
      ...
      int i = index;
      paramNdrBuffer.advance(j * 20);
      if (s == null)
      {
        if ((j < 0) || (j > 65535)) {
          throw new NdrException("invalid array conformance");
        }
        s = new netdfs.DfsInfo3[j];
      }
...
/* Location:
 * Qualified Name:     jcifs.dcerpc.msrpc.netdfs.DfsEnumArray3
