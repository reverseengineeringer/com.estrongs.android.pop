...
public class cz
{
  private static final Interpolator v = new da();
  private int a;
  private int b;
  private int c = -1;
  private float[] d;
  ...
  private final Runnable w = new db(this);
  
  private cz(Context paramContext, ViewGroup paramViewGroup, dc paramdc)
  {
  ...
  private int a(View paramView, int paramInt1, int paramInt2, int paramInt3, int paramInt4)
  {
    ...
    {
      paramInt1 = a(paramInt1, paramInt3, r.b(paramView));
      paramInt2 = a(paramInt2, paramInt4, r.a(paramView));
      float f3 = paramInt1;
  ...
  public static cz a(ViewGroup paramViewGroup, float paramFloat, dc paramdc)
  {
    paramViewGroup = a(paramViewGroup, paramdc);
    b = ((int)(b * (1.0F / paramFloat)));
    return paramViewGroup;
  }
  
  public static cz a(ViewGroup paramViewGroup, dc paramdc)
  {
    return new cz(paramViewGroup.getContext(), paramViewGroup, paramdc);
  }
  ...
  private void b(int paramInt1, int paramInt2, int paramInt3, int paramInt4)
  {
    ...
    if (paramInt3 != 0)
    {
      paramInt1 = r.b(s, paramInt1, paramInt3);
      cn.f(s, paramInt1 - i1);
    }
    for (;;)
    {
      if (paramInt4 != 0)
      {
        paramInt2 = r.a(s, paramInt2, paramInt4);
        cn.e(s, paramInt2 - i2);
      }
      for (;;)
      {
  ...
  {
    int i2 = bi.c(paramMotionEvent);
    int i1 = 0;
    while (i1 < i2)
    {
      int i3 = bi.b(paramMotionEvent, i1);
      float f1 = bi.c(paramMotionEvent, i1);
      float f2 = bi.d(paramMotionEvent, i1);
      f[i3] = f1;
      g[i3] = f2;
      i1 += 1;
    }
  ...
  private void h()
  {
    ...
    a(a(ci.a(l, c), n, m), a(ci.b(l, c), n, m));
  }
  ...
  public boolean a(int paramInt1, int paramInt2)
  {
    ...
    return a(paramInt1, paramInt2, (int)ci.a(l, c), (int)ci.b(l, c));
  }
  
  public boolean a(MotionEvent paramMotionEvent)
  {
    int i2 = bi.a(paramMotionEvent);
    ...
    while (a == 1)
    {
      ...
      if ((p & i2) != 0)
      {
        r.a(i2 & p, i1);
        continue;
        i2 = bi.b(paramMotionEvent, i1);
        f1 = bi.c(paramMotionEvent, i1);
        f2 = bi.d(paramMotionEvent, i1);
        a(f1, f2, i2);
        if (a == 0)
        {
          i1 = h[i2];
            ...
            if ((d != null) && (e != null))
            {
              ...
              while (i1 < i3)
              {
                ...
                else
                {
                  ...
                  int i6 = (int)f3;
                  i6 = r.b(localView, i6 + i5, (int)f3);
                  int i7 = localView.getTop();
                  int i8 = (int)f4;
                  i8 = r.a(localView, i8 + i7, (int)f4);
                  int i9 = r.b(localView);
                  int i10 = r.a(localView);
  ...
  public void b(MotionEvent paramMotionEvent)
  {
    int i1 = 0;
    int i2 = 0;
    int i4 = bi.a(paramMotionEvent);
    int i3 = bi.b(paramMotionEvent);
    if (i4 == 0) {
      e();
    }
    if (l == null) {
      ...
      do
      {
        do
        {
          do
          {
            ...
            f1 = bi.c(paramMotionEvent, i3);
            f2 = bi.d(paramMotionEvent, i3);
            a(f1, f2, i1);
            if (a != 0) {
              break;
            }
...
/* Location:
 * Qualified Name:     android.support.v4.widget.cz
