  ...
  extends q
{
  ...
  @Deprecated
  public bm(Context paramContext, int paramInt, Cursor paramCursor)
  {
  ...
  public bm(Context paramContext, int paramInt1, Cursor paramCursor, int paramInt2)
  {
  ...
  public bm(Context paramContext, int paramInt, Cursor paramCursor, boolean paramBoolean)
  {
