...
public abstract class q
  extends BaseAdapter
  implements v, Filterable
{
  @Deprecated
  public static final int FLAG_AUTO_REQUERY = 1;
  public static final int FLAG_REGISTER_CONTENT_OBSERVER = 2;
  protected boolean mAutoRequery;
  protected s mChangeObserver;
  protected Context mContext;
  protected Cursor mCursor;
  protected u mCursorFilter;
  ...
  @Deprecated
  public q(Context paramContext, Cursor paramCursor)
  {
    init(paramContext, paramCursor, 1);
  }
  
  public q(Context paramContext, Cursor paramCursor, int paramInt)
  {
    init(paramContext, paramCursor, paramInt);
  }
  
  public q(Context paramContext, Cursor paramCursor, boolean paramBoolean)
  {
    if (paramBoolean) {}
    for (int i = 1;; i = 2)
    {
  ...
  void init(Context paramContext, Cursor paramCursor, int paramInt)
  {
    ...
    if ((paramInt & 0x1) == 1)
    {
      ...
      mChangeObserver = new s(this);
    }
    for (mDataSetObserver = new t(this, null);; mDataSetObserver = null)
    {
      if (bool)
      {
