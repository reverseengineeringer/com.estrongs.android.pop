  ...
  extends NotificationCompat.NotificationCompatImplBase
{
  ...
  {
    return NotificationCompatHoneycomb.a(mContext, mNotification, mContentTitle, mContentText, mContentInfo, mTickerView, mNumber, mContentIntent, mFullScreenIntent, mLargeIcon);
  }
}
