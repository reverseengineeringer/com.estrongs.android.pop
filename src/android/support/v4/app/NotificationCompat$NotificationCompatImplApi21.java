  ...
  extends NotificationCompat.NotificationCompatImplApi20
{
  ...
  {
    return NotificationCompatApi21.a(paramUnreadConversation);
  }
  ...
  public NotificationCompatBase.UnreadConversation getUnreadConversationFromBundle(Bundle paramBundle, NotificationCompatBase.UnreadConversation.Factory paramFactory, cf paramcf)
  {
    return NotificationCompatApi21.a(paramBundle, paramFactory, paramcf);
  }
}
