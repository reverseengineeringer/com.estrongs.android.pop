...
public class AlertController$AlertParams
{
  ...
  {
    ListView localListView = (ListView)mInflater.inflate(AlertController.access$1100(paramAlertController), null);
    Object localObject;
    if (mIsMultiChoice) {
      if (mCursor == null)
      {
        localObject = new AlertController.AlertParams.1(this, mContext, AlertController.access$1200(paramAlertController), 16908308, mItems, localListView);
