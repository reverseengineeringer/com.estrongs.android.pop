...
class SupportMenuInflater$MenuState
{
  ...
  private void setItem(MenuItem paramMenuItem)
  {
    ...
    for (boolean bool = true;; bool = false)
    {
      ...
      if (itemShowAsAction >= 0) {
        ax.a(paramMenuItem, itemShowAsAction);
      }
    ...
    else
    {
      ...
      ax.a(paramMenuItem, (View)newInstance(itemActionViewClassName, SupportMenuInflater.access$500(), SupportMenuInflater.access$600(this$0)));
    }
    for (;;)
    {
      if (itemActionViewLayout > 0)
      {
        ...
        ax.b(paramMenuItem, itemActionViewLayout);
      }
      for (;;)
      {
        if (itemActionProvider != null) {
          ax.a(paramMenuItem, itemActionProvider);
        }
        return;
  ...
  public void readItem(AttributeSet paramAttributeSet)
  {
    ...
    for (itemActionProvider = ((n)newInstance(itemActionProviderClassName, SupportMenuInflater.access$200(), SupportMenuInflater.access$300(this$0)));; itemActionProvider = null)
    {
      paramAttributeSet.recycle();
      itemAdded = false;
      return;
