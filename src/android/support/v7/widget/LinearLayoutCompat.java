  ...
  extends ViewGroup
{
  ...
  void layoutVertical(int paramInt1, int paramInt2, int paramInt3, int paramInt4)
  {
    ...
    for (;;)
    {
      ...
      if (localView.getVisibility() != 8)
      {
        ...
        switch (v.a(paramInt3, cn.h(this)) & 0x7)
        {
        default: 
  ...
  void measureVertical(int paramInt1, int paramInt2)
  {
    ...
    for (;;)
    {
      ...
      int i8 = ViewUtils.combineMeasuredStates(i, cn.l(localView));
      if ((k != 0) && (width == -1))
      {
        k = 1;
        label615:
      ...
      i6 = cn.a(Math.max(mTotalLength, getSuggestedMinimumHeight()), paramInt2, 0);
          ...
          if (i2 < i10)
          {
            ...
            else
            {
              ...
              if ((height != 0) || (i12 != 1073741824))
              {
                ...
                i = ViewUtils.combineMeasuredStates(i, cn.l(localView) & 0xFF00);
                i1 = n - i4;
                n = i;
                f1 -= f2;
                i = i1;
      ...
      for (;;)
      {
        ...
        for (;;)
        {
          ...
          for (;;)
          {
            setMeasuredDimension(cn.a(Math.max(j + (getPaddingLeft() + getPaddingRight()), getSuggestedMinimumWidth()), paramInt1, i), i6);
            if (i3 != 0) {
