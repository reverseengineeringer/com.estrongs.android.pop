  ...
  extends CompoundButton
{
  ...
  public void draw(Canvas paramCanvas)
  {
    ...
    for (int i = i4 + i3;; i = i3)
    {
      if (mThumbDrawable != null)
      {
        ...
        if (localObject != null) {
          a.a((Drawable)localObject, j, n, i, i1);
        }
      }
  ...
  public void drawableHotspotChanged(float paramFloat1, float paramFloat2)
  {
    ...
    if (mThumbDrawable != null) {
      a.a(mThumbDrawable, paramFloat1, paramFloat2);
    }
    if (mTrackDrawable != null) {
      a.a(mTrackDrawable, paramFloat1, paramFloat2);
    }
  }
  ...
  public void onMeasure(int paramInt1, int paramInt2)
  {
    ...
    for (int j = mTrackDrawable.getIntrinsicHeight();; j = m)
    {
      ...
      if (getMeasuredHeight() < i) {
        setMeasuredDimension(cn.k(this), i);
      }
      return;
      i = 0;
      j = 0;
  ...
  public void setChecked(boolean paramBoolean)
  {
    ...
    if ((getWindowToken() != null) && (cn.H(this)) && (isShown()))
    {
