  ...
  implements CollapsibleActionView
{
  ...
  private boolean onSuggestionsKey(View paramView, int paramInt, KeyEvent paramKeyEvent)
  {
    ...
    do
    {
      ...
      {
        return false;
      } while ((mSuggestionsAdapter == null) || (paramKeyEvent.getAction() != 0) || (!aa.a(paramKeyEvent)));
  ...
  public q getSuggestionsAdapter()
  {
  ...
  public void setSuggestionsAdapter(q paramq)
  {
    mSuggestionsAdapter = paramq;
    mSearchSrcTextView.setAdapter(mSuggestionsAdapter);
  }
}
