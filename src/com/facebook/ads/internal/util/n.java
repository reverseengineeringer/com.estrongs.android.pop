  ...
  implements j
{
  ...
  public Bitmap a(Bitmap paramBitmap, float paramFloat)
  {
    ...
    while (i < m)
    {
      paramBitmap.add(new n.a(arrayOfInt, j, k, (int)paramFloat, m, i, 1));
      localArrayList.add(new n.a(arrayOfInt, j, k, (int)paramFloat, m, i, 2));
      i += 1;
    }
    try
    {
      r.b.invokeAll(paramBitmap);
      return null;
    }
