...
public abstract class i
{
  ...
  public void a(com.estrongs.io.a.b paramb)
  {
    ...
    int k = ((h)localObject1).b();
    paramb.a((String)localObject2, l, ((h)localObject1).c() + k);
  ...
  public void a(ArchiveEntryFile paramArchiveEntryFile, com.estrongs.io.a.b paramb)
  {
    if (paramb.b()) {}
    label191:
    do
    {
      ...
      if (paramArchiveEntryFile.isDirectory())
      {
        ...
        if (!com.estrongs.fs.impl.local.i.a(((File)localObject).getCanonicalPath()))
        {
          if (d.a() == null) {
            break label191;
          }
        ...
        for (;;)
        {
          ...
          break;
          com.estrongs.fs.impl.local.i.g(((File)localObject).getCanonicalPath());
        }
      }
  ...
  protected void a(File paramFile)
  {
    ...
    do
    {
      ...
      if (com.estrongs.fs.impl.media.b.a(paramFile))
      {
        a.add(paramFile);
        return;
      }
      if (com.estrongs.fs.impl.media.b.b(paramFile))
      {
        b.add(paramFile);
        return;
      }
    } while (!com.estrongs.fs.impl.media.b.c(paramFile));
    c.add(paramFile);
  }
  
  public void a(String paramString, com.estrongs.io.a.b paramb)
  {
    try
    {
      if ((!ap.bC(paramString)) && (m.a(null, false)))
      {
        r localr = m.f(paramString);
        if (localr != null)
        {
          a |= 0x1FF;
  ...
  public void a(List<String> paramList, com.estrongs.io.a.b paramb)
  {
    ...
    //   12: putfield 50	com/estrongs/io/archive/i:f	[B
    //   15: aload_0
    //   16: lconst_0
    //   17: putfield 30	com/estrongs/io/archive/i:a	J
    //   20: new 196	com/estrongs/io/archive/h
    //   23: dup
    //   24: invokespecial 197	com/estrongs/io/archive/h:<init>	()V
    //   27: astore 10
    ...
    //   81: istore_3
    //   82: aload_0
    //   83: invokevirtual 346	com/estrongs/io/archive/i:a	()Z
    //   86: istore 8
    //   88: iload 8
    //   90: ifne +12 -> 102
    //   93: iload 7
    //   95: istore_3
    //   96: aload_0
    //   97: invokevirtual 199	com/estrongs/io/archive/i:b	()V
    //   100: iconst_1
    //   101: istore_3
    //   102: iload_3
    //   103: istore 4
    ...
    //   106: istore 5
    //   108: aload_0
    //   109: getfield 48	com/estrongs/io/archive/i:e	Ljava/util/Map;
    ...
    //   125: istore 5
    //   127: aload_0
    //   128: invokespecial 349	com/estrongs/io/archive/i:l	()Lcom/estrongs/io/model/ArchiveEntryFile;
    //   131: pop
    //   132: iload_3
    //   133: istore 4
    //   135: iload_3
    ...
    //   182: istore 5
    //   184: aload_0
    //   185: getfield 48	com/estrongs/io/archive/i:e	Ljava/util/Map;
    //   188: aload 9
    ...
    //   222: aload 10
    //   224: aload 9
    //   226: invokevirtual 202	com/estrongs/io/archive/h:a	(Ljava/io/File;)V
    //   229: goto -83 -> 146
    //   232: astore_1
    //   233: iload 4
    //   235: istore_3
    ...
    //   239: aload_0
    //   240: aconst_null
    //   241: putfield 50	com/estrongs/io/archive/i:f	[B
    //   244: iload_3
    //   245: ifeq +7 -> 252
    //   248: aload_0
    //   249: invokevirtual 220	com/estrongs/io/archive/i:c	()V
    //   252: aload_1
    //   253: athrow
    //   254: iload_3
    //   255: istore 4
    ...
    //   264: dup
    //   265: aload_0
    //   266: getfield 56	com/estrongs/io/archive/i:b	Ljava/lang/String;
    //   269: invokespecial 79	java/io/File:<init>	(Ljava/lang/String;)V
    //   272: invokevirtual 205	java/io/File:getName	()Ljava/lang/String;
    //   275: aload 10
    //   277: invokevirtual 207	com/estrongs/io/archive/h:a	()J
    //   280: aload 10
    //   282: invokevirtual 209	com/estrongs/io/archive/h:b	()I
    //   285: aload 10
    //   287: invokevirtual 211	com/estrongs/io/archive/h:c	()I
    //   290: iadd
    ...
    //   361: aload_0
    //   362: aconst_null
    //   363: putfield 50	com/estrongs/io/archive/i:f	[B
    //   366: iload_3
    //   367: ifeq +7 -> 374
    //   370: aload_0
    //   371: invokevirtual 220	com/estrongs/io/archive/i:c	()V
    //   374: return
    //   375: iload_3
    //   376: istore 4
    //   378: iload_3
    ...
    //   382: aload 9
    //   384: aload_2
    //   385: invokevirtual 223	com/estrongs/io/archive/i:a	(Lcom/estrongs/io/model/ArchiveEntryFile;Lcom/estrongs/io/a/b;)V
    //   388: goto -78 -> 310
    //   391: astore_1
    //   392: iload 5
    //   394: istore_3
    ...
    //   0	405	2	paramb	com.estrongs.io.a.b
    //   81	321	3	k	int
    //   75	302	4	m	int
    //   78	315	5	n	int
    //   4	396	6	i1	int
  ...
  protected File b(ArchiveEntryFile paramArchiveEntryFile, com.estrongs.io.a.b paramb)
  {
  ...
  protected File c(ArchiveEntryFile paramArchiveEntryFile, com.estrongs.io.a.b paramb)
  {
    ...
    if (paramArchiveEntryFile.isDirectory())
    {
      ...
      for (;;)
      {
        ...
        {
          com.estrongs.fs.impl.local.i.g(localFile1.getAbsolutePath());
    ...
    if (!com.estrongs.fs.impl.local.i.a(localFile2.getAbsolutePath()))
    {
      if (d.a() != null) {}
      for (;;)
      {
        ...
        {
          bool = com.estrongs.fs.impl.local.i.g(localFile2.getAbsolutePath());
          localFileSystemException.printStackTrace();
          continue;
        }
        boolean bool = com.estrongs.fs.impl.local.i.g(localFile2.getAbsolutePath());
      }
    }
    if (!com.estrongs.fs.impl.local.i.h(localFile2.getAbsolutePath())) {
      throw new IOException("FILENAME_CONFLICT " + localFile2.getName());
    }
    if ((com.estrongs.fs.impl.local.i.a(localFile1.getAbsolutePath())) && (!paramb.a(localFile1.getAbsolutePath())))
    {
      paramb.a(d(paramArchiveEntryFile.getPath()), com.estrongs.fs.impl.local.i.e(paramArchiveEntryFile.getAbsolutePath()));
      return null;
    }
    if (!com.estrongs.fs.impl.local.i.a(localFile1.getAbsolutePath()))
    {
      try
      {
        if (!com.estrongs.fs.impl.local.i.a(localFile1.getAbsolutePath(), false, false)) {
  ...
  public File d(ArchiveEntryFile paramArchiveEntryFile, com.estrongs.io.a.b paramb)
  {
    ...
    //   7: aload_1
    //   8: aload_2
    //   9: invokevirtual 390	com/estrongs/io/archive/i:c	(Lcom/estrongs/io/model/ArchiveEntryFile;Lcom/estrongs/io/a/b;)Ljava/io/File;
    //   12: astore 8
    //   14: aload 8
    //   16: ifnonnull +5 -> 21
    //   19: aconst_null
    ...
    //   26: aload_0
    //   27: aload_1
    //   28: invokevirtual 392	com/estrongs/io/archive/i:a	(Ljava/lang/String;)Ljava/io/InputStream;
    //   31: astore_1
    //   32: aload_0
    //   33: getfield 50	com/estrongs/io/archive/i:f	[B
    //   36: ifnonnull +12 -> 48
    //   39: aload_0
    //   40: ldc_w 338
    //   43: newarray <illegal type>
    //   45: putfield 50	com/estrongs/io/archive/i:f	[B
    //   48: new 394	java/io/BufferedInputStream
    //   51: dup
    //   52: aload_1
    //   53: aload_0
    //   54: getfield 50	com/estrongs/io/archive/i:f	[B
    //   57: arraylength
    ...
    //   73: aload 9
    //   75: aload_0
    //   76: getfield 50	com/estrongs/io/archive/i:f	[B
    //   79: iconst_0
    //   80: aload_0
    //   81: getfield 50	com/estrongs/io/archive/i:f	[B
    //   84: arraylength
    ...
    //   99: aload_1
    //   100: aload_0
    //   101: getfield 50	com/estrongs/io/archive/i:f	[B
    //   104: iconst_0
    //   105: iload 5
    ...
    //   151: aload_0
    //   152: aload_0
    //   153: getfield 30	com/estrongs/io/archive/i:a	J
    //   156: iload 5
    //   158: i2l
    //   159: ladd
    //   160: putfield 30	com/estrongs/io/archive/i:a	J
    //   163: aload_2
    //   164: aload_0
    //   165: getfield 30	com/estrongs/io/archive/i:a	J
    ...
    //   0	196	2	paramb	com.estrongs.io.a.b
    //   92	38	3	k	int
    //   4	87	4	m	int
    //   88	69	5	n	int
