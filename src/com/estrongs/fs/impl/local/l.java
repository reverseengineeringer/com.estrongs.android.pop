...
public class l
{
  static List<u> a = new ArrayList();
  static List<u> b = new ArrayList();
  public static Object c = new Object();
  static ArrayList<Integer> d = new ArrayList();
  private static String e = null;
  private static String f = null;
  private static String g = null;
  private static Queue<r> h = new LinkedList();
  private static Queue<r> i = new LinkedList();
  ...
  public static int a()
  {
    ...
    localo.b();
    if (((Boolean)localo.c()).booleanValue())
    {
      b((r)localObject);
    ...
    Log.e("Error", "uname ret:" + (String)localObject);
  ...
  public static int a(Object paramObject, byte[] paramArrayOfByte, int paramInt1, int paramInt2)
  {
    try
    {
      p.a((p)paramObject, paramInt2);
      p.b((p)paramObject, paramInt1);
      p.a((p)paramObject, paramArrayOfByte);
      e(paramObject);
      paramInt1 = p.j((p)paramObject);
      return paramInt1;
    }
    finally
    {
  ...
  public static long a(Object paramObject, long paramLong, int paramInt)
  {
    try
    {
      p.c((p)paramObject, paramInt);
      p.a((p)paramObject, paramLong);
      f(paramObject);
      paramLong = p.k((p)paramObject);
      return paramLong;
    }
    finally
    {
  ...
  public static r a(boolean paramBoolean)
  {
    return a(paramBoolean, false);
  }
  
  /* Error */
  public static r a(boolean paramBoolean1, boolean paramBoolean2)
  {
    // Byte code:
    //   0: iload_1
    //   1: ifeq +215 -> 216
    //   4: getstatic 52	com/estrongs/fs/impl/local/l:i	Ljava/util/Queue;
    //   7: astore_2
    //   8: aload_2
    //   9: monitorenter
    //   10: getstatic 52	com/estrongs/fs/impl/local/l:i	Ljava/util/Queue;
    //   13: invokeinterface 185 1 0
    //   18: checkcast 187	com/estrongs/fs/impl/local/r
    //   21: astore_3
    //   22: ldc -67
    //   24: invokestatic 194	com/estrongs/android/util/v:a	(Ljava/lang/String;)V
    //   27: aload_2
    //   28: monitorexit
    //   29: aload_3
    ...
    //   34: ifeq +319 -> 353
    //   37: ldc -60
    //   39: invokestatic 194	com/estrongs/android/util/v:a	(Ljava/lang/String;)V
    //   42: iload_1
    //   43: ifeq +212 -> 255
    //   46: ldc -58
    //   48: astore_2
    ...
    //   60: aload 4
    //   62: ifnull +414 -> 476
    //   65: new 187	com/estrongs/fs/impl/local/r
    //   68: dup
    //   69: invokespecial 209	com/estrongs/fs/impl/local/r:<init>	()V
    //   72: astore_3
    //   73: aload_3
    ...
    //   93: putfield 228	com/estrongs/fs/impl/local/r:c	Ljava/io/BufferedReader;
    //   96: aload_3
    ...
    //   116: putfield 245	com/estrongs/fs/impl/local/r:b	Ljava/io/BufferedWriter;
    //   119: aload_3
    //   120: getfield 245	com/estrongs/fs/impl/local/r:b	Ljava/io/BufferedWriter;
    //   123: ldc -9
    //   125: invokevirtual 250	java/io/BufferedWriter:write	(Ljava/lang/String;)V
    //   128: aload_3
    //   129: getfield 245	com/estrongs/fs/impl/local/r:b	Ljava/io/BufferedWriter;
    //   132: invokevirtual 253	java/io/BufferedWriter:flush	()V
    //   135: aload_3
    //   136: iconst_1
    //   137: putfield 255	com/estrongs/fs/impl/local/r:d	Z
    //   140: aload_3
    //   141: iload_1
    //   142: putfield 257	com/estrongs/fs/impl/local/r:e	Z
    //   145: ldc2_w 258
    //   148: invokestatic 265	java/lang/Thread:sleep	(J)V
    //   151: aload_3
    //   152: getfield 228	com/estrongs/fs/impl/local/r:c	Ljava/io/BufferedReader;
    ...
    //   170: ifne +92 -> 262
    //   173: aload_3
    //   174: getfield 228	com/estrongs/fs/impl/local/r:c	Ljava/io/BufferedReader;
    ...
    //   191: ifle +71 -> 262
    //   194: aload_3
    //   195: getfield 228	com/estrongs/fs/impl/local/r:c	Ljava/io/BufferedReader;
    ...
    //   214: aload_3
    //   215: athrow
    //   216: getstatic 50	com/estrongs/fs/impl/local/l:h	Ljava/util/Queue;
    //   219: astore_2
    //   220: aload_2
    //   221: monitorenter
    //   222: getstatic 50	com/estrongs/fs/impl/local/l:h	Ljava/util/Queue;
    //   225: invokeinterface 185 1 0
    //   230: checkcast 187	com/estrongs/fs/impl/local/r
    //   233: astore_3
    //   234: ldc -67
    //   236: invokestatic 194	com/estrongs/android/util/v:a	(Ljava/lang/String;)V
    //   239: aload_2
    //   240: monitorexit
    //   241: goto -212 -> 29
    //   244: astore_3
    ...
    //   301: invokestatic 194	com/estrongs/android/util/v:a	(Ljava/lang/String;)V
    //   304: aconst_null
    //   305: astore_2
    //   306: goto +170 -> 476
    //   309: ldc_w 291
    //   312: invokestatic 194	com/estrongs/android/util/v:a	(Ljava/lang/String;)V
    //   315: aload_3
    //   316: astore_2
    //   317: goto +159 -> 476
    //   320: astore_2
    ...
    //   348: invokestatic 194	com/estrongs/android/util/v:a	(Ljava/lang/String;)V
    //   351: aconst_null
    //   352: areturn
    //   353: aload_3
    //   354: astore_2
    ...
    //   396: aload 4
    //   398: ifnull +78 -> 476
    //   401: new 187	com/estrongs/fs/impl/local/r
    //   404: dup
    //   405: invokespecial 209	com/estrongs/fs/impl/local/r:<init>	()V
    //   408: astore_2
    //   409: aload_2
    //   410: iconst_0
    //   411: putfield 255	com/estrongs/fs/impl/local/r:d	Z
    //   414: aload_2
    ...
    //   434: putfield 228	com/estrongs/fs/impl/local/r:c	Ljava/io/BufferedReader;
    //   437: aload_2
    ...
    //   457: putfield 245	com/estrongs/fs/impl/local/r:b	Ljava/io/BufferedWriter;
    //   460: aload_2
    //   461: aload 4
    //   463: putfield 314	com/estrongs/fs/impl/local/r:a	Ljava/lang/Process;
    //   466: goto +10 -> 476
    //   469: astore_2
    //   470: aconst_null
    //   471: areturn
  ...
  public static void a(String paramString, Object paramObject)
  {
    ...
    //   4: ifnonnull +4 -> 8
    //   7: return
    //   8: invokestatic 408	com/estrongs/fs/impl/local/l:p	()Landroid/net/LocalSocket;
    //   11: astore 11
    //   13: aload 11
    //   15: ifnull -8 -> 7
    //   18: aload 11
    ...
    //   36: aload 9
    //   38: iconst_1
    //   39: invokestatic 369	com/estrongs/fs/impl/local/l:a	(Ljava/io/OutputStream;I)V
    //   42: aload 9
    //   44: aload_0
    //   45: invokestatic 414	com/estrongs/fs/impl/local/l:a	(Ljava/io/OutputStream;Ljava/lang/String;)V
    //   48: aload 8
    //   50: invokestatic 416	com/estrongs/fs/impl/local/l:a	(Ljava/io/InputStream;)Ljava/lang/String;
    //   53: astore_0
    //   54: aload 8
    //   56: invokestatic 419	com/estrongs/fs/impl/local/l:c	(Ljava/io/InputStream;)I
    //   59: istore_2
    //   60: aload 8
    //   62: invokestatic 419	com/estrongs/fs/impl/local/l:c	(Ljava/io/InputStream;)I
    //   65: istore_3
    //   66: iload_2
    //   67: i2l
    //   68: lstore 4
    ...
    //   72: lstore 6
    //   74: aload 8
    //   76: invokestatic 419	com/estrongs/fs/impl/local/l:c	(Ljava/io/InputStream;)I
    //   79: istore_2
    //   80: aload 8
    //   82: invokestatic 419	com/estrongs/fs/impl/local/l:c	(Ljava/io/InputStream;)I
    //   85: istore_3
    //   86: aload 8
    //   88: invokestatic 416	com/estrongs/fs/impl/local/l:a	(Ljava/io/InputStream;)Ljava/lang/String;
    //   91: astore 10
    //   93: aconst_null
    //   94: invokestatic 424	com/estrongs/fs/impl/local/w:a	(Landroid/content/Context;)Lcom/estrongs/fs/impl/local/w;
    //   97: aload_0
    //   98: lload 6
    //   100: lload 4
    //   102: bipush 32
    ...
    //   108: aload 10
    //   110: aload_1
    //   111: invokevirtual 427	com/estrongs/fs/impl/local/w:a	(Ljava/lang/String;JIILjava/lang/String;Ljava/lang/Object;)Z
    //   114: pop
    //   115: goto -67 -> 48
    //   118: astore_0
    //   119: aload 8
  ...
  public static boolean a(Context paramContext)
  {
    ...
    try
    {
      ...
      bd.a(paramContext, e, -1);
      paramContext.close();
      try
      {
        if (ac.a() >= 9)
        {
          paramContext = new al(localFile);
        ...
        for (;;)
        {
          ad.a(FexApplication.a()).V(FexApplication.a().getResources().getResourceName(n));
          return true;
          a(e, "755", false);
        }
      }
  ...
  public static boolean a(Context paramContext, boolean paramBoolean)
  {
    ...
    for (;;)
    {
      ...
      if ((ad.a(paramContext).m()) && (ad.a(paramContext).j())) {}
  ...
  public static boolean a(String paramString, long paramLong)
  {
    ...
    //   9: aconst_null
    //   10: astore 4
    //   12: invokestatic 408	com/estrongs/fs/impl/local/l:p	()Landroid/net/LocalSocket;
    //   15: astore 9
    //   17: aload 9
    ...
    //   51: aload 6
    //   53: sipush 207
    //   56: invokestatic 369	com/estrongs/fs/impl/local/l:a	(Ljava/io/OutputStream;I)V
    //   59: aload 6
    //   61: astore 5
    //   63: aload 8
    //   65: astore 4
    ...
    //   71: aload 6
    //   73: aload_0
    //   74: invokestatic 414	com/estrongs/fs/impl/local/l:a	(Ljava/io/OutputStream;Ljava/lang/String;)V
    //   77: aload 6
    //   79: astore 5
    //   81: aload 8
    //   83: astore 4
    ...
    //   89: aload 6
    //   91: lload_1
    //   92: invokestatic 519	com/estrongs/fs/impl/local/l:a	(Ljava/io/OutputStream;J)V
    //   95: aload 6
    //   97: astore 5
    //   99: aload 8
    //   101: astore 4
    ...
    //   105: astore 7
    //   107: aload 8
    //   109: invokestatic 419	com/estrongs/fs/impl/local/l:c	(Ljava/io/InputStream;)I
    //   112: istore_3
    //   113: iload_3
    //   114: ifeq +30 -> 144
    //   117: aload 8
  ...
  public static boolean a(String paramString, q paramq)
  {
    if (paramString == null) {
      return false;
    }
    String[] arrayOfString = am.k(paramString, "rw");
    q.a(paramq, paramString);
    c(paramq);
  ...
  public static boolean a(String paramString1, String paramString2)
  {
    ...
    paramString1 = am.k(paramString1, "rw");
    o localo = new o();
    a = localr;
    b = paramString2;
    c = Integer.valueOf(4);
    ...
    for (;;)
    {
      ...
      return ((Boolean)localo.c()).booleanValue();
      a(localr);
    }
  }
  
  public static boolean a(String paramString1, String paramString2, r paramr)
  {
  ...
  public static boolean a(String paramString1, String paramString2, boolean paramBoolean)
  {
    ...
    for (;;)
    {
      return ((Boolean)((o)localObject).c()).booleanValue();
      a(paramString2);
    }
  }
  ...
  private static boolean a(String paramString, boolean paramBoolean1, boolean paramBoolean2)
  {
    ...
    //   21: aload_0
    //   22: iload_1
    //   23: invokestatic 572	com/estrongs/android/util/am:b	(Ljava/lang/String;Z)Ljava/lang/String;
    //   26: astore 8
    //   28: aload 8
    //   30: ifnonnull +10 -> 40
    //   33: iconst_0
    ...
    //   36: istore_3
    //   37: goto -16 -> 21
    //   40: invokestatic 408	com/estrongs/fs/impl/local/l:p	()Landroid/net/LocalSocket;
    //   43: astore 7
    //   45: aload 7
    //   47: ifnonnull +5 -> 52
    //   50: iconst_0
    ...
    //   73: aload 5
    //   75: iload_3
    //   76: invokestatic 369	com/estrongs/fs/impl/local/l:a	(Ljava/io/OutputStream;I)V
    //   79: aload 5
    //   81: astore 4
    //   83: aload 5
    //   85: aload 8
    //   87: invokestatic 414	com/estrongs/fs/impl/local/l:a	(Ljava/io/OutputStream;Ljava/lang/String;)V
    //   90: aload 5
    //   92: astore 4
    //   94: aload_0
    //   95: invokestatic 419	com/estrongs/fs/impl/local/l:c	(Ljava/io/InputStream;)I
    //   98: istore_3
    //   99: iload_3
    //   100: ifne +31 -> 131
    //   103: aload_0
    ...
    //   131: aload 5
    //   133: astore 4
    //   135: new 574	com/estrongs/fs/impl/local/NativeException
    //   138: dup
    //   139: iload_3
    //   140: invokestatic 578	com/estrongs/fs/impl/local/k:a	(I)Ljava/lang/String;
    //   143: invokespecial 579	com/estrongs/fs/impl/local/NativeException:<init>	(Ljava/lang/String;)V
    //   146: athrow
    //   147: astore 4
    //   149: aload_0
    //   150: astore 4
  ...
  public static void b(Context paramContext)
  {
    ...
    localct.b(2131428513);
    localct.a(paramContext.getString(2131427339), null);
    localct.c(false);
    localct.c();
  }
  ...
  private static void b(Object paramObject)
  {
    ...
    label122:
    paramObject = localObject1;
    q.a(localq, c((InputStream)localObject1), c((InputStream)localObject1), c((InputStream)localObject1));
  }
  ...
  private static boolean b(String paramString1, String paramString2, boolean paramBoolean)
  {
    ...
    //   6: aconst_null
    //   7: astore 4
    //   9: invokestatic 408	com/estrongs/fs/impl/local/l:p	()Landroid/net/LocalSocket;
    //   12: astore 8
    //   14: aload 8
    //   16: ifnonnull +5 -> 21
    //   19: iconst_0
    ...
    //   47: aload 6
    //   49: bipush 6
    //   51: invokestatic 369	com/estrongs/fs/impl/local/l:a	(Ljava/io/OutputStream;I)V
    //   54: aload 6
    //   56: astore 5
    //   58: aload 6
    //   60: aload_0
    //   61: invokestatic 414	com/estrongs/fs/impl/local/l:a	(Ljava/io/OutputStream;Ljava/lang/String;)V
    //   64: aload 6
    //   66: astore 5
    //   68: aload 6
    //   70: aload_1
    //   71: invokestatic 414	com/estrongs/fs/impl/local/l:a	(Ljava/io/OutputStream;Ljava/lang/String;)V
    //   74: iload_2
    //   75: ifeq +56 -> 131
    //   78: iconst_1
    //   79: istore_3
    ...
    //   84: aload 6
    //   86: iload_3
    //   87: invokestatic 369	com/estrongs/fs/impl/local/l:a	(Ljava/io/OutputStream;I)V
    //   90: aload 6
    //   92: astore 5
    //   94: aload 4
    //   96: invokestatic 419	com/estrongs/fs/impl/local/l:c	(Ljava/io/InputStream;)I
    //   99: istore_3
    //   100: iload_3
    //   101: ifne +35 -> 136
    //   104: aload 4
    ...
    //   163: invokestatic 113	android/util/Log:e	(Ljava/lang/String;Ljava/lang/String;)I
    //   166: pop
    //   167: aload 4
    //   169: ifnull +8 -> 177
    //   172: aload 4
    //   174: invokevirtual 430	java/io/InputStream:close	()V
    //   177: aload 6
    //   179: ifnull +8 -> 187
    //   182: aload 6
    //   184: invokevirtual 431	java/io/OutputStream:close	()V
    //   187: aload 8
    //   189: invokevirtual 432	android/net/LocalSocket:close	()V
    //   192: iconst_0
    //   193: ireturn
    //   194: astore_0
    //   195: iconst_0
    ...
    //   204: ifnull +7 -> 211
    //   207: aload_1
    //   208: invokevirtual 430	java/io/InputStream:close	()V
    //   211: aload_0
    //   212: ifnull +7 -> 219
    //   215: aload_0
    //   216: invokevirtual 431	java/io/OutputStream:close	()V
    //   219: aload 8
    //   221: invokevirtual 432	android/net/LocalSocket:close	()V
    //   224: iconst_0
    //   225: ireturn
    //   226: astore_0
    //   227: iconst_0
    ...
    //   235: ifnull +8 -> 243
    //   238: aload 4
    //   240: invokevirtual 430	java/io/InputStream:close	()V
    //   243: aload 5
    //   245: ifnull +8 -> 253
    //   248: aload 5
    //   250: invokevirtual 431	java/io/OutputStream:close	()V
    //   253: aload 8
    //   255: invokevirtual 432	android/net/LocalSocket:close	()V
    //   258: aload_0
    //   259: athrow
    //   260: astore_0
    //   261: iconst_0
    ...
    //   0	289	2	paramBoolean	boolean
    //   79	78	3	n	int
    //   7	274	4	localObject1	Object
    //   1	248	5	localObject2	Object
    //   4	274	6	localOutputStream	OutputStream
    //   26	3	7	localInputStream	InputStream
    //   12	242	8	localLocalSocket	LocalSocket
    // Exception table:
    //   from	to	target	type
    //   172	177	194	java/io/IOException
    //   182	187	194	java/io/IOException
    ...
    //   21	28	229	finally
    //   238	243	260	java/io/IOException
    ...
    //   94	100	263	finally
    //   140	167	263	finally
    //   36	43	267	java/io/IOException
    //   47	54	276	java/io/IOException
    //   58	64	276	java/io/IOException
    //   68	74	276	java/io/IOException
    //   84	90	276	java/io/IOException
    //   94	100	276	java/io/IOException
    //   140	167	276	java/io/IOException
    //   109	114	286	java/io/IOException
    //   119	124	286	java/io/IOException
  ...
  public static boolean b(String paramString, boolean paramBoolean)
  {
    ...
    //   9: iconst_1
    //   10: istore_3
    //   11: getstatic 63	com/estrongs/fs/impl/local/l:c	Ljava/lang/Object;
    //   14: astore 8
    //   16: aload 8
    //   18: monitorenter
    //   19: aload_0
    ...
    //   28: aload_0
    //   29: iconst_0
    //   30: invokestatic 572	com/estrongs/android/util/am:b	(Ljava/lang/String;Z)Ljava/lang/String;
    //   33: astore 10
    //   35: aload 10
    //   37: ifnonnull +14 -> 51
    //   40: aload 8
    ...
    //   49: aload_0
    //   50: athrow
    //   51: invokestatic 408	com/estrongs/fs/impl/local/l:p	()Landroid/net/LocalSocket;
    //   54: astore 9
    //   56: aload 9
    //   58: ifnonnull +8 -> 66
    //   61: aload 8
    ...
    //   92: aload 5
    //   94: bipush 16
    //   96: invokestatic 369	com/estrongs/fs/impl/local/l:a	(Ljava/io/OutputStream;I)V
    //   99: aload 5
    //   101: astore 6
    //   103: aload 5
    //   105: aload 10
    //   107: invokestatic 414	com/estrongs/fs/impl/local/l:a	(Ljava/io/OutputStream;Ljava/lang/String;)V
    //   110: iload_1
    //   111: ifeq +171 -> 282
    //   114: iconst_1
    //   115: istore_2
    ...
    //   120: aload 5
    //   122: iload_2
    //   123: invokestatic 369	com/estrongs/fs/impl/local/l:a	(Ljava/io/OutputStream;I)V
    //   126: aload 5
    //   128: astore 6
    //   130: aload 4
    //   132: invokestatic 419	com/estrongs/fs/impl/local/l:c	(Ljava/io/InputStream;)I
    //   135: istore_2
    //   136: aload 5
    //   138: astore 6
    ...
    //   183: invokestatic 194	com/estrongs/android/util/v:a	(Ljava/lang/String;)V
    //   186: iload_2
    //   187: ifeq +346 -> 533
    //   190: aload 5
    //   192: astore 6
    ...
    //   228: aload 5
    //   230: astore 6
    //   232: invokestatic 664	com/estrongs/android/util/bd:l	()Z
    //   235: ifeq +52 -> 287
    //   238: aload 5
    //   240: astore 6
    //   242: iconst_1
    //   243: iconst_1
    //   244: invokestatic 176	com/estrongs/fs/impl/local/l:a	(ZZ)Lcom/estrongs/fs/impl/local/r;
    //   247: astore_0
    //   248: aload_0
    ...
    //   289: astore 6
    //   291: iconst_1
    //   292: invokestatic 70	com/estrongs/fs/impl/local/l:a	(Z)Lcom/estrongs/fs/impl/local/r;
    //   295: astore_0
    //   296: goto -48 -> 248
    //   299: astore_0
    //   300: aload 8
    ...
    //   305: aload 5
    //   307: astore 6
    //   309: new 72	com/estrongs/fs/impl/local/o
    //   312: dup
    //   313: invokespecial 73	com/estrongs/fs/impl/local/o:<init>	()V
    //   316: astore 10
    //   318: aload 5
    //   320: astore 6
    //   322: aload 10
    //   324: aload_0
    //   325: putfield 75	com/estrongs/fs/impl/local/o:a	Ljava/lang/Object;
    //   328: aload 5
    //   330: astore 6
    //   332: aload 10
    //   334: aload 7
    //   336: putfield 79	com/estrongs/fs/impl/local/o:b	Ljava/lang/Object;
    //   339: aload 5
    //   341: astore 6
    //   343: aload 10
    //   345: bipush 16
    //   347: invokestatic 85	java/lang/Integer:valueOf	(I)Ljava/lang/Integer;
    //   350: putfield 86	com/estrongs/fs/impl/local/o:c	Ljava/lang/Object;
    //   353: aload 5
    //   355: astore 6
    //   357: aload 10
    //   359: invokevirtual 88	com/estrongs/fs/impl/local/o:b	()V
    //   362: aload 5
    //   364: astore 6
    ...
    //   409: invokestatic 194	com/estrongs/android/util/v:a	(Ljava/lang/String;)V
    //   412: aload 5
    //   414: astore 6
    //   416: aload 10
    //   418: getfield 547	com/estrongs/fs/impl/local/o:e	Ljava/lang/Object;
    ...
    //   432: astore 6
    //   434: aload_0
    //   435: invokestatic 100	com/estrongs/fs/impl/local/l:b	(Lcom/estrongs/fs/impl/local/r;)V
    //   438: aload 5
    //   440: astore 6
    //   442: aload 10
    //   444: invokevirtual 91	com/estrongs/fs/impl/local/o:c	()Ljava/lang/Object;
    ...
    //   486: astore 6
    //   488: aload_0
    //   489: invokestatic 115	com/estrongs/fs/impl/local/l:a	(Lcom/estrongs/fs/impl/local/r;)V
    //   492: goto -54 -> 438
    //   495: astore_0
    //   496: aload 5
    //   498: astore_0
        ...
        if (new File(arrayOfString[n]).exists()) {
          if (paramBoolean)
          {
            if (ac.a() >= 18)
            {
              ...
              {
                if (!new File(new String[] { "/system/xbin/daemonsu", "/system/sbin/daemonsu", "/system/bin/daemonsu", "/vendor/bin/daemonsu", "/sbin/daemonsu" }[i1]).exists()) {
                  break label162;
                }
                return true;
              }
  ...
  public static String[] b(String paramString1, String paramString2)
  {
    ...
    {
      if (((am.i(arrayOfString1[(n * 3)], paramString1)) && (!arrayOfString1[(n * 3)].equals("/"))) || ((paramString1.equals("/")) && (arrayOfString1[(n * 3)].equals("/"))))
      {
  ...
  private static boolean c(r paramr)
  {
    ...
    //   25: invokestatic 732	com/estrongs/fs/impl/local/l:o	()Ljava/lang/String;
    ...
    //   34: astore_1
    //   35: aload_0
    //   36: getfield 245	com/estrongs/fs/impl/local/r:b	Ljava/io/BufferedWriter;
    //   39: new 121	java/lang/StringBuilder
    //   42: dup
    //   43: invokespecial 122	java/lang/StringBuilder:<init>	()V
    //   46: getstatic 41	com/estrongs/fs/impl/local/l:e	Ljava/lang/String;
    ...
    //   68: aload_0
    //   69: getfield 245	com/estrongs/fs/impl/local/r:b	Ljava/io/BufferedWriter;
    ...
    //   83: astore_0
    //   84: ldc_w 736
    //   87: invokestatic 194	com/estrongs/android/util/v:a	(Ljava/lang/String;)V
    //   90: aload_0
    //   91: invokevirtual 297	java/lang/Exception:toString	()Ljava/lang/String;
    //   94: invokestatic 194	com/estrongs/android/util/v:a	(Ljava/lang/String;)V
    //   97: iconst_0
    //   98: ireturn
    //   99: astore_0
    //   100: goto -19 -> 81
  ...
  public static boolean c(boolean paramBoolean)
  {
    ...
    //   15: aload 6
    //   17: astore_1
    //   18: invokestatic 408	com/estrongs/fs/impl/local/l:p	()Landroid/net/LocalSocket;
    //   21: astore 7
    //   23: aload 7
    //   25: ifnull +49 -> 74
    //   28: aload 4
    ...
    //   47: astore_1
    //   48: iconst_1
    //   49: putstatic 56	com/estrongs/fs/impl/local/l:k	Z
    //   52: iconst_0
    //   53: ifeq +15 -> 68
    //   56: getstatic 56	com/estrongs/fs/impl/local/l:k	Z
    //   59: ifeq +9 -> 68
    //   62: aconst_null
    //   63: putstatic 54	com/estrongs/fs/impl/local/l:j	Lcom/estrongs/fs/impl/local/r;
    //   66: iconst_1
    //   67: ireturn
    //   68: aconst_null
    //   69: invokestatic 115	com/estrongs/fs/impl/local/l:a	(Lcom/estrongs/fs/impl/local/r;)V
    //   72: iconst_1
    //   73: ireturn
    //   74: aload 4
    //   76: astore_2
    ...
    //   80: aload 6
    //   82: astore_1
    //   83: invokestatic 740	com/estrongs/fs/impl/local/l:g	()Z
    //   86: ifne +54 -> 140
    //   89: aload 4
    //   91: astore_2
    //   92: aload 5
    ...
    //   97: astore_1
    //   98: ldc_w 742
    //   101: invokestatic 194	com/estrongs/android/util/v:a	(Ljava/lang/String;)V
    //   104: aload 4
    //   106: astore_2
    //   107: aload 5
    //   109: astore_3
    ...
    //   112: astore_1
    //   113: iconst_0
    //   114: putstatic 56	com/estrongs/fs/impl/local/l:k	Z
    //   117: iconst_0
    //   118: ifeq +15 -> 133
    //   121: getstatic 56	com/estrongs/fs/impl/local/l:k	Z
    //   124: ifeq +9 -> 133
    //   127: aconst_null
    //   128: putstatic 54	com/estrongs/fs/impl/local/l:j	Lcom/estrongs/fs/impl/local/r;
    //   131: iconst_0
    //   132: ireturn
    //   133: aconst_null
    //   134: invokestatic 115	com/estrongs/fs/impl/local/l:a	(Lcom/estrongs/fs/impl/local/r;)V
    //   137: goto -6 -> 131
    //   140: aload 4
    //   142: astore_2
    //   143: aload 5
    ...
    //   148: astore_1
    //   149: iconst_1
    //   150: invokestatic 70	com/estrongs/fs/impl/local/l:a	(Z)Lcom/estrongs/fs/impl/local/r;
    //   153: astore 4
    //   155: aload 4
    //   157: ifnull +563 -> 720
    //   160: aload 4
    ...
    //   168: astore_1
    //   169: iconst_1
    //   170: putstatic 56	com/estrongs/fs/impl/local/l:k	Z
    //   173: aload 4
    //   175: astore_2
    //   176: aload 4
    //   178: astore_3
    ...
    //   185: dup
    //   186: getstatic 41	com/estrongs/fs/impl/local/l:e	Ljava/lang/String;
    ...
    //   217: aload 4
    //   219: astore_1
    //   220: new 465	com/estrongs/android/util/al
    //   223: dup
    //   224: aload 5
    //   226: invokespecial 467	com/estrongs/android/util/al:<init>	(Ljava/lang/Object;)V
    //   229: astore 5
    //   231: aload 4
    //   233: astore_2
    //   234: aload 4
    ...
    //   278: aastore
    //   279: invokevirtual 481	com/estrongs/android/util/al:a	(Ljava/lang/String;[Ljava/lang/Class;[Ljava/lang/Object;)Ljava/lang/Object;
    //   282: pop
    //   283: aload 4
    //   285: astore_2
    //   286: aload 4
    ...
    //   330: aastore
    //   331: invokevirtual 481	com/estrongs/android/util/al:a	(Ljava/lang/String;[Ljava/lang/Class;[Ljava/lang/Object;)Ljava/lang/Object;
    //   334: pop
    //   335: aload 4
    //   337: astore_2
    //   338: aload 4
    ...
    //   341: aload 4
    //   343: astore_1
    //   344: getstatic 41	com/estrongs/fs/impl/local/l:e	Ljava/lang/String;
    //   347: ldc_w 744
    //   350: aload 4
    //   352: invokestatic 746	com/estrongs/fs/impl/local/l:a	(Ljava/lang/String;Ljava/lang/String;Lcom/estrongs/fs/impl/local/r;)Z
    //   355: ifeq +166 -> 521
    //   358: aload 4
    //   360: astore_2
    //   361: aload 4
    ...
    //   366: astore_1
    //   367: ldc_w 748
    //   370: invokestatic 194	com/estrongs/android/util/v:a	(Ljava/lang/String;)V
    //   373: aload 4
    //   375: astore_2
    //   376: aload 4
    //   378: astore_3
    ...
    //   381: astore_1
    //   382: aload 4
    //   384: invokestatic 750	com/estrongs/fs/impl/local/l:c	(Lcom/estrongs/fs/impl/local/r;)Z
    //   387: ifne +221 -> 608
    //   390: aload 4
    //   392: astore_2
    //   393: aload 4
    ...
    //   398: astore_1
    //   399: ldc_w 752
    //   402: invokestatic 194	com/estrongs/android/util/v:a	(Ljava/lang/String;)V
    //   405: aload 4
    //   407: astore_2
    //   408: aload 4
    //   410: astore_3
    ...
    //   413: astore_1
    //   414: iconst_0
    //   415: putstatic 56	com/estrongs/fs/impl/local/l:k	Z
    //   418: aload 4
    //   420: astore_2
    //   421: aload 4
    //   423: astore_3
    ...
    //   443: getstatic 56	com/estrongs/fs/impl/local/l:k	Z
    //   446: invokevirtual 759	java/lang/StringBuilder:append	(Z)Ljava/lang/StringBuilder;
    //   449: invokevirtual 131	java/lang/StringBuilder:toString	()Ljava/lang/String;
    //   452: invokestatic 113	android/util/Log:e	(Ljava/lang/String;Ljava/lang/String;)I
    //   455: pop
    //   456: aload 4
    //   458: astore_2
    //   459: aload 4
    ...
    //   478: getstatic 56	com/estrongs/fs/impl/local/l:k	Z
    //   481: invokevirtual 759	java/lang/StringBuilder:append	(Z)Ljava/lang/StringBuilder;
    //   484: invokevirtual 131	java/lang/StringBuilder:toString	()Ljava/lang/String;
    //   487: invokestatic 194	com/estrongs/android/util/v:a	(Ljava/lang/String;)V
    //   490: aload 4
    //   492: astore_2
    //   493: aload 4
    //   495: astore_3
    //   496: aload 4
    //   498: astore_1
    //   499: getstatic 56	com/estrongs/fs/impl/local/l:k	Z
    //   502: istore_0
    //   503: aload 4
    //   505: ifnull +208 -> 713
    //   508: getstatic 56	com/estrongs/fs/impl/local/l:k	Z
    //   511: ifeq +202 -> 713
    //   514: aload 4
    //   516: putstatic 54	com/estrongs/fs/impl/local/l:j	Lcom/estrongs/fs/impl/local/r;
    //   519: iload_0
    //   520: ireturn
    //   521: aload 4
    //   523: astore_2
    ...
    //   529: astore_1
    //   530: ldc_w 761
    //   533: invokestatic 194	com/estrongs/android/util/v:a	(Ljava/lang/String;)V
    //   536: goto -163 -> 373
    //   539: astore_3
    //   540: aload_2
    //   541: astore_1
    //   542: aload_3
    //   543: invokevirtual 762	java/lang/SecurityException:printStackTrace	()V
    //   546: aload_2
    //   547: astore_1
    //   548: iconst_0
    //   549: putstatic 56	com/estrongs/fs/impl/local/l:k	Z
    //   552: aload_2
    //   553: astore_1
    //   554: ldc_w 764
    //   557: new 121	java/lang/StringBuilder
    //   560: dup
    //   561: invokespecial 122	java/lang/StringBuilder:<init>	()V
    //   564: ldc_w 766
    //   567: invokevirtual 128	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   570: aload_3
    //   571: invokevirtual 769	java/lang/SecurityException:getMessage	()Ljava/lang/String;
    //   574: invokevirtual 128	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   577: invokevirtual 131	java/lang/StringBuilder:toString	()Ljava/lang/String;
    //   580: invokestatic 113	android/util/Log:e	(Ljava/lang/String;Ljava/lang/String;)I
    //   583: pop
    //   584: aload_2
    //   585: astore_1
    //   586: ldc_w 771
    //   589: invokestatic 194	com/estrongs/android/util/v:a	(Ljava/lang/String;)V
    //   592: aload_2
    //   593: ifnull +181 -> 774
    //   596: getstatic 56	com/estrongs/fs/impl/local/l:k	Z
    //   599: ifeq +175 -> 774
    //   602: aload_2
    //   603: putstatic 54	com/estrongs/fs/impl/local/l:j	Lcom/estrongs/fs/impl/local/r;
    //   606: iconst_0
    //   607: ireturn
    //   608: aload 4
    //   610: astore_2
    ...
    //   616: astore_1
    //   617: ldc_w 773
    //   620: invokestatic 194	com/estrongs/android/util/v:a	(Ljava/lang/String;)V
    //   623: aload 4
    //   625: astore_2
    //   626: aload 4
    //   628: astore_3
    //   629: aload 4
    //   631: astore_1
    //   632: invokestatic 408	com/estrongs/fs/impl/local/l:p	()Landroid/net/LocalSocket;
    //   635: astore 5
    //   637: aload 5
    //   639: ifnonnull +56 -> 695
    //   642: aload 4
    //   644: astore_2
    //   645: aload 4
    //   647: astore_3
    ...
    //   650: astore_1
    //   651: iconst_0
    //   652: putstatic 56	com/estrongs/fs/impl/local/l:k	Z
    //   655: goto -237 -> 418
    //   658: astore_2
    //   659: aload_3
    //   660: astore_1
    //   661: aload_2
    //   662: invokevirtual 294	java/lang/Exception:printStackTrace	()V
    //   665: aload_3
    //   666: astore_1
    //   667: iconst_0
    //   668: putstatic 56	com/estrongs/fs/impl/local/l:k	Z
    //   671: aload_3
    //   672: astore_1
    //   673: ldc_w 775
    //   676: invokestatic 194	com/estrongs/android/util/v:a	(Ljava/lang/String;)V
    //   679: aload_3
    //   680: ifnull +101 -> 781
    //   683: getstatic 56	com/estrongs/fs/impl/local/l:k	Z
    //   686: ifeq +95 -> 781
    //   689: aload_3
    //   690: putstatic 54	com/estrongs/fs/impl/local/l:j	Lcom/estrongs/fs/impl/local/r;
    //   693: iconst_0
    //   694: ireturn
    //   695: aload 4
    //   697: astore_2
    ...
    //   700: astore_1
    //   701: aload 5
    //   703: invokevirtual 432	android/net/LocalSocket:close	()V
    //   706: goto -288 -> 418
    //   709: astore_1
    //   710: goto -292 -> 418
    //   713: aload 4
    //   715: invokestatic 115	com/estrongs/fs/impl/local/l:a	(Lcom/estrongs/fs/impl/local/r;)V
    //   718: iload_0
    //   719: ireturn
    //   720: aload 4
    //   722: astore_2
    ...
    //   728: astore_1
    //   729: ldc_w 777
    //   732: invokestatic 194	com/estrongs/android/util/v:a	(Ljava/lang/String;)V
    //   735: aload 4
    //   737: astore_2
    //   738: aload 4
    //   740: astore_3
    ...
    //   743: astore_1
    //   744: iconst_0
    //   745: putstatic 56	com/estrongs/fs/impl/local/l:k	Z
    //   748: aload 4
    //   750: ifnull +16 -> 766
    //   753: getstatic 56	com/estrongs/fs/impl/local/l:k	Z
    //   756: ifeq +10 -> 766
    //   759: aload 4
    //   761: putstatic 54	com/estrongs/fs/impl/local/l:j	Lcom/estrongs/fs/impl/local/r;
    //   764: iconst_0
    //   765: ireturn
    //   766: aload 4
    //   768: invokestatic 115	com/estrongs/fs/impl/local/l:a	(Lcom/estrongs/fs/impl/local/r;)V
    //   771: goto -7 -> 764
    //   774: aload_2
    //   775: invokestatic 115	com/estrongs/fs/impl/local/l:a	(Lcom/estrongs/fs/impl/local/r;)V
    //   778: goto -172 -> 606
    //   781: aload_3
    //   782: invokestatic 115	com/estrongs/fs/impl/local/l:a	(Lcom/estrongs/fs/impl/local/r;)V
    //   785: goto -92 -> 693
    //   788: astore_2
    //   789: aload_1
    //   790: ifnull +15 -> 805
    //   793: getstatic 56	com/estrongs/fs/impl/local/l:k	Z
    //   796: ifeq +9 -> 805
    //   799: aload_1
    //   800: putstatic 54	com/estrongs/fs/impl/local/l:j	Lcom/estrongs/fs/impl/local/r;
    //   803: aload_2
    //   804: athrow
    //   805: aload_1
    //   806: invokestatic 115	com/estrongs/fs/impl/local/l:a	(Lcom/estrongs/fs/impl/local/r;)V
    //   809: goto -6 -> 803
    //   812: astore_1
    //   813: goto -774 -> 39
    // Local variable table:
    //   start	length	slot	name	signature
    //   0	816	0	paramBoolean	boolean
    //   17	684	1	localObject1	Object
    //   709	1	1	localException1	Exception
    //   728	78	1	localr1	r
    //   812	1	1	localException2	Exception
    //   11	634	2	localr2	r
    //   658	4	2	localException3	Exception
    //   697	78	2	localr3	r
    //   788	16	2	localObject2	Object
    //   14	513	3	localObject3	Object
    //   539	32	3	localSecurityException	SecurityException
    //   613	169	3	localr4	r
    //   7	760	4	localr5	r
    //   1	701	5	localObject4	Object
    //   4	143	6	localObject5	Object
    //   21	14	7	localLocalSocket	LocalSocket
    // Exception table:
    //   from	to	target	type
    //   18	23	539	java/lang/SecurityException
    //   34	39	539	java/lang/SecurityException
    //   48	52	539	java/lang/SecurityException
    //   83	89	539	java/lang/SecurityException
    //   98	104	539	java/lang/SecurityException
    //   113	117	539	java/lang/SecurityException
    //   149	155	539	java/lang/SecurityException
    //   169	173	539	java/lang/SecurityException
    //   182	194	539	java/lang/SecurityException
    //   203	211	539	java/lang/SecurityException
    //   220	231	539	java/lang/SecurityException
    //   240	283	539	java/lang/SecurityException
    //   292	335	539	java/lang/SecurityException
    //   344	358	539	java/lang/SecurityException
    //   367	373	539	java/lang/SecurityException
    //   382	390	539	java/lang/SecurityException
    //   399	405	539	java/lang/SecurityException
    //   414	418	539	java/lang/SecurityException
    //   427	456	539	java/lang/SecurityException
    //   465	490	539	java/lang/SecurityException
    //   499	503	539	java/lang/SecurityException
    //   530	536	539	java/lang/SecurityException
    //   617	623	539	java/lang/SecurityException
    //   632	637	539	java/lang/SecurityException
    //   651	655	539	java/lang/SecurityException
    //   701	706	539	java/lang/SecurityException
    //   729	735	539	java/lang/SecurityException
    //   744	748	539	java/lang/SecurityException
    //   18	23	658	java/lang/Exception
    //   48	52	658	java/lang/Exception
    //   83	89	658	java/lang/Exception
    //   98	104	658	java/lang/Exception
    //   113	117	658	java/lang/Exception
    //   149	155	658	java/lang/Exception
    //   169	173	658	java/lang/Exception
    //   182	194	658	java/lang/Exception
    //   203	211	658	java/lang/Exception
    //   220	231	658	java/lang/Exception
    //   240	283	658	java/lang/Exception
    //   292	335	658	java/lang/Exception
    //   344	358	658	java/lang/Exception
    //   367	373	658	java/lang/Exception
    //   382	390	658	java/lang/Exception
    //   399	405	658	java/lang/Exception
    //   414	418	658	java/lang/Exception
    //   427	456	658	java/lang/Exception
    //   465	490	658	java/lang/Exception
    //   499	503	658	java/lang/Exception
    //   530	536	658	java/lang/Exception
    //   617	623	658	java/lang/Exception
    //   632	637	658	java/lang/Exception
    //   651	655	658	java/lang/Exception
    //   729	735	658	java/lang/Exception
    //   744	748	658	java/lang/Exception
  ...
  public static com.estrongs.fs.c d(String paramString)
  {
    ...
    //   5: areturn
    //   6: aload_0
    //   7: invokestatic 782	com/estrongs/android/util/am:bo	(Ljava/lang/String;)Ljava/lang/String;
    //   10: astore 11
    //   12: aload 11
    //   14: ifnonnull +5 -> 19
    //   17: aconst_null
    //   18: areturn
    //   19: invokestatic 408	com/estrongs/fs/impl/local/l:p	()Landroid/net/LocalSocket;
    //   22: astore 10
    //   24: aload 10
    //   26: ifnonnull +5 -> 31
    //   29: aconst_null
    ...
    //   45: aload 9
    //   47: bipush 9
    //   49: invokestatic 369	com/estrongs/fs/impl/local/l:a	(Ljava/io/OutputStream;I)V
    //   52: aload 9
    //   54: aload 11
    //   56: invokestatic 414	com/estrongs/fs/impl/local/l:a	(Ljava/io/OutputStream;Ljava/lang/String;)V
    //   59: aload 8
    //   61: invokestatic 419	com/estrongs/fs/impl/local/l:c	(Ljava/io/InputStream;)I
    //   64: istore_1
    //   65: iload_1
    //   66: ifeq +33 -> 99
    //   69: aload 8
    ...
    //   98: areturn
    //   99: aload 8
    //   101: invokestatic 416	com/estrongs/fs/impl/local/l:a	(Ljava/io/InputStream;)Ljava/lang/String;
    //   104: astore 12
    //   106: aload 8
    //   108: invokestatic 419	com/estrongs/fs/impl/local/l:c	(Ljava/io/InputStream;)I
    //   111: istore_1
    //   112: aload 8
    //   114: invokestatic 419	com/estrongs/fs/impl/local/l:c	(Ljava/io/InputStream;)I
    //   117: istore_2
    //   118: iload_1
    //   119: i2l
    //   120: lstore_3
    ...
    //   123: lstore 5
    //   125: aload 8
    //   127: invokestatic 419	com/estrongs/fs/impl/local/l:c	(Ljava/io/InputStream;)I
    //   130: istore_1
    //   131: aload 8
    //   133: invokestatic 419	com/estrongs/fs/impl/local/l:c	(Ljava/io/InputStream;)I
    //   136: istore_2
    //   137: aload 8
    //   139: invokestatic 416	com/estrongs/fs/impl/local/l:a	(Ljava/io/InputStream;)Ljava/lang/String;
    //   142: astore 13
    //   144: new 784	com/estrongs/fs/c
    //   147: dup
    //   148: ldc_w 343
    //   151: invokespecial 785	com/estrongs/fs/c:<init>	(Ljava/lang/String;)V
    //   154: astore 11
    //   156: aload 11
    //   158: aload 13
    //   160: putfield 787	com/estrongs/fs/c:o	Ljava/lang/String;
    //   163: aload 12
    //   165: iconst_0
    ...
    //   188: aload 11
    //   190: iload 7
    //   192: putfield 788	com/estrongs/fs/c:d	Z
    //   195: aload 11
    //   197: aload_0
    //   198: putfield 789	com/estrongs/fs/c:b	Ljava/lang/String;
    //   201: aload 11
    //   203: getfield 788	com/estrongs/fs/c:d	Z
    //   206: ifeq +203 -> 409
    //   209: aload 11
    //   211: lconst_0
    //   212: putfield 792	com/estrongs/fs/c:e	J
    //   215: aload 11
    //   217: iload_1
    //   218: i2l
    //   219: putfield 794	com/estrongs/fs/c:j	J
    //   222: aload 11
    //   224: aload 11
    //   226: getfield 794	com/estrongs/fs/c:j	J
    //   229: ldc2_w 258
    //   232: lmul
    //   233: putfield 794	com/estrongs/fs/c:j	J
    //   236: aload 11
    //   238: iload_2
    //   239: putfield 796	com/estrongs/fs/c:q	I
    //   242: aload 11
    //   244: aload 12
    //   246: iconst_1
    //   247: bipush 10
    //   249: invokevirtual 559	java/lang/String:substring	(II)Ljava/lang/String;
    //   252: putfield 798	com/estrongs/fs/c:p	Ljava/lang/String;
    //   255: aload 11
    //   257: getfield 787	com/estrongs/fs/c:o	Ljava/lang/String;
    //   260: iconst_0
    ...
    //   272: aload 11
    //   274: iload 7
    //   276: putfield 799	com/estrongs/fs/c:m	Z
    //   279: aload 11
    //   281: getfield 789	com/estrongs/fs/c:b	Ljava/lang/String;
    //   284: invokestatic 802	com/estrongs/android/util/am:bl	(Ljava/lang/String;)Z
    //   287: ifeq +186 -> 473
    //   290: aload 11
    //   292: getfield 798	com/estrongs/fs/c:p	Ljava/lang/String;
    //   295: iconst_3
    ...
    //   307: aload 11
    //   309: iload 7
    //   311: putfield 803	com/estrongs/fs/c:k	Z
    //   314: aload 11
    //   316: getfield 798	com/estrongs/fs/c:p	Ljava/lang/String;
    //   319: iconst_4
    ...
    //   331: aload 11
    //   333: iload 7
    //   335: putfield 805	com/estrongs/fs/c:l	Z
    //   338: aload 12
    //   340: iconst_0
    ...
    //   360: aload 11
    //   362: iconst_1
    //   363: putfield 808	com/estrongs/fs/c:n	Z
    //   366: aload 8
    //   368: ifnull +8 -> 376
    //   371: aload 8
    ...
    //   391: iconst_1
    //   392: anewarray 784	com/estrongs/fs/c
    //   395: dup
    //   396: iconst_0
    //   397: aload 11
    //   399: aastore
    ...
    //   416: lshl
    //   417: ladd
    //   418: putfield 792	com/estrongs/fs/c:e	J
    //   421: goto -206 -> 215
    //   424: astore_0
    //   425: aload 8
    //   427: ifnull +8 -> 435
    ...
    //   470: goto -139 -> 331
    //   473: aload 11
    //   475: getfield 798	com/estrongs/fs/c:p	Ljava/lang/String;
    //   478: iconst_0
    ...
    //   490: aload 11
    //   492: iload 7
    //   494: putfield 803	com/estrongs/fs/c:k	Z
    //   497: aload 11
    //   499: getfield 798	com/estrongs/fs/c:p	Ljava/lang/String;
    //   502: iconst_1
    ...
    //   514: aload 11
    //   516: iload 7
    //   518: putfield 805	com/estrongs/fs/c:l	Z
    //   521: goto -183 -> 338
    //   524: astore_0
    //   525: aload 8
    //   527: ifnull +8 -> 535
  ...
  private static void d(Object paramObject)
  {
    ...
    try
    {
      ...
      try
      {
        ...
        paramObject = localObject1;
        a(localOutputStream, p.a(localp));
        paramObject = localObject1;
        if (c((InputStream)localObject1) == 0) {
          break label116;
        }
  ...
  public static String[] d(boolean paramBoolean)
  {
    ...
    if (ac.a() >= 21)
    {
      ...
      {
        localObject3 = o.a(localObject4[n], Boolean.valueOf(paramBoolean));
        if (localObject3 == null) {
          break label308;
        }
        if (localObject1 == null) {
    ...
    for (;;)
    {
      ...
      try
      {
        ...
        paramBoolean = ((Boolean)((o)localObject4).c()).booleanValue();
        if (!paramBoolean)
        {
          if (n != 0)
          {
  ...
  private static LocalSocket e(boolean paramBoolean)
  {
    ...
    //   2: ldc 2
    //   4: monitorenter
    //   5: new 837	android/net/LocalSocketAddress
    //   8: dup
    //   9: invokestatic 732	com/estrongs/fs/impl/local/l:o	()Ljava/lang/String;
    //   12: getstatic 843	android/net/LocalSocketAddress$Namespace:ABSTRACT	Landroid/net/LocalSocketAddress$Namespace;
    //   15: invokespecial 846	android/net/LocalSocketAddress:<init>	(Ljava/lang/String;Landroid/net/LocalSocketAddress$Namespace;)V
    //   18: astore 4
    //   20: new 410	android/net/LocalSocket
    //   23: dup
    //   24: invokespecial 847	android/net/LocalSocket:<init>	()V
    //   27: astore_2
    //   28: aload_2
    //   29: aload 4
    //   31: invokevirtual 851	android/net/LocalSocket:connect	(Landroid/net/LocalSocketAddress;)V
    //   34: aload_2
    //   35: ifnull +192 -> 227
    //   38: ldc_w 853
    //   41: invokestatic 194	com/estrongs/android/util/v:a	(Ljava/lang/String;)V
    //   44: aload_2
    ...
    //   56: aload 5
    //   58: bipush 80
    //   60: invokestatic 369	com/estrongs/fs/impl/local/l:a	(Ljava/io/OutputStream;I)V
    //   63: aload 6
    //   65: invokestatic 419	com/estrongs/fs/impl/local/l:c	(Ljava/io/InputStream;)I
    //   68: istore_1
    //   69: iload_1
    //   70: bipush 38
    //   72: if_icmpeq +86 -> 158
    ...
    //   82: dup
    //   83: invokespecial 847	android/net/LocalSocket:<init>	()V
    //   86: astore_2
    //   87: aload_2
    //   88: aload 4
    //   90: invokevirtual 851	android/net/LocalSocket:connect	(Landroid/net/LocalSocketAddress;)V
    //   93: aload_2
    //   94: invokevirtual 412	android/net/LocalSocket:getOutputStream	()Ljava/io/OutputStream;
    //   97: bipush 100
    //   99: invokestatic 369	com/estrongs/fs/impl/local/l:a	(Ljava/io/OutputStream;I)V
    //   102: aload_2
    ...
    //   109: invokestatic 514	com/estrongs/fs/impl/local/l:a	(Landroid/content/Context;)Z
    //   112: pop
    //   113: ldc_w 855
    //   116: invokestatic 194	com/estrongs/android/util/v:a	(Ljava/lang/String;)V
    //   119: aload_3
    //   120: astore_2
    //   121: ldc 2
    //   123: monitorexit
    ...
    //   150: invokestatic 194	com/estrongs/android/util/v:a	(Ljava/lang/String;)V
    //   153: aconst_null
    //   154: astore_2
    //   155: goto -121 -> 34
    //   158: aload 5
    //   160: sipush 208
    //   163: invokestatic 369	com/estrongs/fs/impl/local/l:a	(Ljava/io/OutputStream;I)V
    //   166: aload_2
    //   167: invokevirtual 860	java/lang/Object:hashCode	()I
    //   170: invokestatic 866	java/lang/Math:abs	(I)I
    //   173: istore_1
    //   174: getstatic 870	com/estrongs/android/nativetool/NativeAuth:a	Z
    //   177: istore_0
    //   178: iload_0
    //   179: ifne +36 -> 215
    //   182: iload_1
    //   183: invokestatic 874	com/estrongs/android/nativetool/NativeAuth:putAuth	(I)V
    //   186: aload 5
    //   188: iload_1
    //   189: invokestatic 369	com/estrongs/fs/impl/local/l:a	(Ljava/io/OutputStream;I)V
    //   192: aload 6
    //   194: invokestatic 419	com/estrongs/fs/impl/local/l:c	(Ljava/io/InputStream;)I
    //   197: pop
    //   198: ldc_w 876
    //   201: invokestatic 194	com/estrongs/android/util/v:a	(Ljava/lang/String;)V
    //   204: goto -83 -> 121
    //   207: astore 4
    //   209: invokestatic 878	com/estrongs/android/nativetool/NativeAuth:a	()V
    //   212: goto -26 -> 186
    //   215: invokestatic 878	com/estrongs/android/nativetool/NativeAuth:a	()V
    //   218: goto -32 -> 186
    //   221: astore_2
    //   222: ldc 2
    //   224: monitorexit
    ...
    //   229: iload_0
    //   230: ifeq -109 -> 121
    //   233: invokestatic 512	com/estrongs/fs/impl/local/l:h	()Z
    //   236: ifeq +14 -> 250
    //   239: aload_3
    //   240: astore_2
    //   241: invokestatic 488	com/estrongs/android/pop/FexApplication:a	()Lcom/estrongs/android/pop/FexApplication;
    //   244: invokestatic 514	com/estrongs/fs/impl/local/l:a	(Landroid/content/Context;)Z
    //   247: ifeq -126 -> 121
    //   250: aload_3
    //   251: astore_2
    //   252: iconst_1
    //   253: invokestatic 517	com/estrongs/fs/impl/local/l:c	(Z)Z
    //   256: ifeq -135 -> 121
    //   259: iconst_0
    //   260: invokestatic 880	com/estrongs/fs/impl/local/l:e	(Z)Landroid/net/LocalSocket;
    //   263: astore_2
    //   264: goto -143 -> 121
    //   267: astore_2
    //   268: aload_3
  ...
  public static OutputStream e(String paramString)
  {
    ...
    //   12: aload 5
    //   14: ifnull -10 -> 4
    //   17: invokestatic 408	com/estrongs/fs/impl/local/l:p	()Landroid/net/LocalSocket;
    //   20: astore 7
    //   22: aload 7
    //   24: ifnull -20 -> 4
    //   27: aload 7
    ...
    //   45: aload_0
    //   46: bipush 10
    //   48: invokestatic 369	com/estrongs/fs/impl/local/l:a	(Ljava/io/OutputStream;I)V
    //   51: aload_0
    //   52: astore_3
    //   53: aload 4
    //   55: astore_2
    //   56: aload_0
    //   57: aload 5
    //   59: invokestatic 414	com/estrongs/fs/impl/local/l:a	(Ljava/io/OutputStream;Ljava/lang/String;)V
    //   62: aload_0
    //   63: astore_3
    //   64: aload 4
    //   66: astore_2
    //   67: aload 4
    //   69: invokestatic 419	com/estrongs/fs/impl/local/l:c	(Ljava/io/InputStream;)I
    //   72: istore_1
    //   73: iload_1
    //   74: ifeq +39 -> 113
    //   77: iconst_0
    ...
    //   106: astore_0
    //   107: aload_0
    //   108: invokevirtual 883	java/io/IOException:printStackTrace	()V
    //   111: aconst_null
    //   112: areturn
    //   113: aload_0
    //   114: astore_3
    //   115: aload 4
    //   117: astore_2
    //   118: new 885	com/estrongs/fs/impl/local/t
    //   121: dup
    //   122: aload 7
    //   124: aload 4
    //   126: aload_0
    //   127: invokespecial 888	com/estrongs/fs/impl/local/t:<init>	(Landroid/net/LocalSocket;Ljava/io/InputStream;Ljava/io/OutputStream;)V
    //   130: astore 5
    //   132: aload 5
    ...
    //   163: astore_0
    //   164: aload_0
    //   165: invokevirtual 883	java/io/IOException:printStackTrace	()V
    //   168: aconst_null
    //   169: areturn
    //   170: astore 5
    //   172: aconst_null
    ...
    //   181: astore_2
    //   182: aload 5
    //   184: invokevirtual 883	java/io/IOException:printStackTrace	()V
    //   187: iconst_0
    //   188: ifne -184 -> 4
    //   191: aload_0
    //   192: ifnull +7 -> 199
    ...
    //   216: astore_0
    //   217: aload_0
    //   218: invokevirtual 883	java/io/IOException:printStackTrace	()V
    //   221: aconst_null
    //   222: areturn
    //   223: astore 4
    //   225: aconst_null
    ...
    //   257: astore_0
    //   258: aload_0
    //   259: invokevirtual 883	java/io/IOException:printStackTrace	()V
    //   262: aconst_null
    //   263: areturn
    //   264: astore 4
    //   266: aconst_null
  ...
  private static void e(Object paramObject)
  {
    ...
    if ((paramObject == null) || (p.b((p)paramObject)))
    {
      ((p)paramObject).a(-1);
      return;
    }
    ...
    try
    {
      OutputStream localOutputStream = p.c((p)paramObject).getOutputStream();
      localInputStream = p.c((p)paramObject).getInputStream();
      a(localOutputStream, 11);
      a(localOutputStream, p.d((p)paramObject));
    ...
    for (;;)
    {
      ...
      if (n > 0)
      {
        i2 = localInputStream.read(p.e((p)paramObject), p.f((p)paramObject) + i1 - n, n);
        if (i2 > 0) {}
      }
      else
      {
  ...
  public static q f(String paramString)
  {
    q localq = new q(paramString, null);
    if (paramString == null) {
      return localq;
    }
    b(localq);
  ...
  private static void f(Object paramObject)
  {
    ...
    {
      OutputStream localOutputStream = p.c((p)paramObject).getOutputStream();
      InputStream localInputStream = p.c((p)paramObject).getInputStream();
      a(localOutputStream, 201);
      a(localOutputStream, p.g((p)paramObject));
      a(localOutputStream, p.h((p)paramObject));
      ((p)paramObject).a(d(localInputStream));
      return;
    }
    catch (Exception localException)
    {
  ...
  public static boolean h()
  {
    ...
    //   0: iconst_0
    //   1: istore_1
    //   2: getstatic 60	com/estrongs/fs/impl/local/l:m	Z
    //   5: ifeq +9 -> 14
    //   8: iconst_0
    //   9: putstatic 60	com/estrongs/fs/impl/local/l:m	Z
    //   12: iconst_1
    //   13: ireturn
    //   14: new 435	java/io/File
    //   17: dup
    //   18: getstatic 41	com/estrongs/fs/impl/local/l:e	Ljava/lang/String;
    //   21: invokespecial 437	java/io/File:<init>	(Ljava/lang/String;)V
    //   24: astore 11
    //   26: aload 11
    //   28: invokevirtual 679	java/io/File:exists	()Z
    //   31: ifeq -19 -> 12
    //   34: invokestatic 442	com/estrongs/fs/impl/local/l:c	()I
    //   37: istore_0
    //   38: aload 11
    //   40: invokevirtual 933	java/io/File:length	()J
    //   43: lstore 9
    //   45: lconst_0
    //   46: lstore 5
    //   48: aconst_null
    ...
    //   166: astore 12
    //   168: aload 14
    //   170: invokevirtual 936	com/estrongs/android/pop/ad:ba	()Ljava/lang/String;
    //   173: astore 14
    //   175: aload 14
    //   177: ifnull +26 -> 203
    //   180: aload 13
  ...
  public static InputStream j(String paramString)
  {
    ...
    //   11: aload_3
    //   12: ifnull -8 -> 4
    //   15: invokestatic 408	com/estrongs/fs/impl/local/l:p	()Landroid/net/LocalSocket;
    //   18: astore 4
    //   20: aload 4
    //   22: ifnull -18 -> 4
    //   25: aload 4
    ...
    //   37: aload_0
    //   38: bipush 11
    //   40: invokestatic 369	com/estrongs/fs/impl/local/l:a	(Ljava/io/OutputStream;I)V
    //   43: aload_0
    //   44: aload_3
    //   45: invokestatic 414	com/estrongs/fs/impl/local/l:a	(Ljava/io/OutputStream;Ljava/lang/String;)V
    //   48: aload_2
    //   49: invokestatic 419	com/estrongs/fs/impl/local/l:c	(Ljava/io/InputStream;)I
    //   52: istore_1
    //   53: iload_1
    //   54: ifeq +33 -> 87
    //   57: iconst_0
    ...
    //   85: aconst_null
    //   86: areturn
    //   87: new 948	com/estrongs/fs/impl/local/s
    //   90: dup
    //   91: aload 4
    //   93: aload_2
    //   94: aload_0
    //   95: invokespecial 949	com/estrongs/fs/impl/local/s:<init>	(Landroid/net/LocalSocket;Ljava/io/InputStream;Ljava/io/OutputStream;)V
    //   98: astore_3
    //   99: aload_3
  ...
  public static boolean l(String paramString)
  {
    ...
    //   8: iconst_1
    //   9: istore_2
    //   10: getstatic 63	com/estrongs/fs/impl/local/l:c	Ljava/lang/Object;
    //   13: astore 7
    //   15: aload 7
    //   17: monitorenter
    //   18: aload_0
    ...
    //   25: iconst_0
    //   26: ireturn
    //   27: invokestatic 408	com/estrongs/fs/impl/local/l:p	()Landroid/net/LocalSocket;
    //   30: astore 8
    //   32: aload 8
    //   34: ifnonnull +14 -> 48
    //   37: aload 7
    ...
    //   73: aload 4
    //   75: bipush 17
    //   77: invokestatic 369	com/estrongs/fs/impl/local/l:a	(Ljava/io/OutputStream;I)V
    //   80: aload 4
    //   82: astore 5
    //   84: aload 4
    //   86: aload_0
    ...
    //   146: invokestatic 194	com/estrongs/android/util/v:a	(Ljava/lang/String;)V
    //   149: iload_1
    //   150: ifeq +335 -> 485
    //   153: aload 4
    //   155: astore 5
    ...
    //   191: aload 4
    //   193: astore 5
    //   195: invokestatic 664	com/estrongs/android/util/bd:l	()Z
    //   198: ifeq +45 -> 243
    //   201: aload 4
    //   203: astore 5
    //   205: iconst_1
    //   206: iconst_1
    //   207: invokestatic 176	com/estrongs/fs/impl/local/l:a	(ZZ)Lcom/estrongs/fs/impl/local/r;
    //   210: astore_0
    //   211: aload_0
    ...
    //   245: astore 5
    //   247: iconst_1
    //   248: invokestatic 70	com/estrongs/fs/impl/local/l:a	(Z)Lcom/estrongs/fs/impl/local/r;
    //   251: astore_0
    //   252: goto -41 -> 211
    //   255: astore_0
    //   256: aload 7
    ...
    //   261: aload 4
    //   263: astore 5
    //   265: new 72	com/estrongs/fs/impl/local/o
    //   268: dup
    //   269: invokespecial 73	com/estrongs/fs/impl/local/o:<init>	()V
    //   272: astore 9
    //   274: aload 4
    //   276: astore 5
    //   278: aload 9
    //   280: aload_0
    //   281: putfield 75	com/estrongs/fs/impl/local/o:a	Ljava/lang/Object;
    //   284: aload 4
    //   286: astore 5
    //   288: aload 9
    //   290: aload 6
    //   292: putfield 79	com/estrongs/fs/impl/local/o:b	Ljava/lang/Object;
    //   295: aload 4
    //   297: astore 5
    //   299: aload 9
    //   301: bipush 17
    //   303: invokestatic 85	java/lang/Integer:valueOf	(I)Ljava/lang/Integer;
    //   306: putfield 86	com/estrongs/fs/impl/local/o:c	Ljava/lang/Object;
    //   309: aload 4
    //   311: astore 5
    //   313: aload 9
    //   315: invokevirtual 88	com/estrongs/fs/impl/local/o:b	()V
    //   318: aload 4
    //   320: astore 5
    //   322: aload 9
    //   324: getfield 547	com/estrongs/fs/impl/local/o:e	Ljava/lang/Object;
    ...
    //   338: astore 5
    //   340: aload_0
    //   341: invokestatic 100	com/estrongs/fs/impl/local/l:b	(Lcom/estrongs/fs/impl/local/r;)V
    //   344: aload 4
    //   346: astore 5
    ...
    //   391: invokestatic 194	com/estrongs/android/util/v:a	(Ljava/lang/String;)V
    //   394: aload 4
    //   396: astore 5
    //   398: aload 9
    //   400: invokevirtual 91	com/estrongs/fs/impl/local/o:c	()Ljava/lang/Object;
    ...
    //   440: astore 5
    //   442: aload_0
    //   443: invokestatic 115	com/estrongs/fs/impl/local/l:a	(Lcom/estrongs/fs/impl/local/r;)V
    //   446: goto -102 -> 344
    //   449: astore_0
    //   450: aload 4
    //   452: astore_0
  ...
  {
    return am.bk(am.bk(e)) + "files/comm/su_port";
  }
  ...
  private static boolean q()
  {
    ...
    //   0: iconst_1
    //   1: istore_3
    //   2: invokestatic 408	com/estrongs/fs/impl/local/l:p	()Landroid/net/LocalSocket;
    //   5: astore 5
    //   7: aload 5
    //   9: ifnonnull +7 -> 16
    //   12: iconst_0
    ...
    //   30: aload 4
    //   32: sipush 204
    //   35: invokestatic 369	com/estrongs/fs/impl/local/l:a	(Ljava/io/OutputStream;I)V
    //   38: aload 4
    //   40: sipush 5000
    //   43: invokestatic 369	com/estrongs/fs/impl/local/l:a	(Ljava/io/OutputStream;I)V
    //   46: sipush 1024
    ...
    //   58: aload 6
    //   60: aload 7
    //   62: invokevirtual 705	java/io/InputStream:read	([B)I
    //   65: istore_0
    //   66: iload_0
    //   67: ifgt +66 -> 133
    //   70: getstatic 37	com/estrongs/fs/impl/local/l:a	Ljava/util/List;
    //   73: invokeinterface 964 1 0
    //   78: getstatic 39	com/estrongs/fs/impl/local/l:b	Ljava/util/List;
    //   81: invokeinterface 964 1 0
    //   86: aload 4
    //   88: ldc_w 351
    //   91: invokevirtual 823	java/lang/String:split	(Ljava/lang/String;)[Ljava/lang/String;
    //   94: astore 4
    //   96: iconst_0
    //   97: istore_0
    //   98: iload_0
    ...
    //   108: aaload
    //   109: ldc_w 966
    //   112: invokevirtual 823	java/lang/String:split	(Ljava/lang/String;)[Ljava/lang/String;
    //   115: astore 5
    //   117: aload 5
    //   119: arraylength
    //   120: istore_1
    ...
    //   139: iconst_0
    //   140: iload_0
    //   141: invokespecial 969	java/lang/String:<init>	([BII)V
    //   144: astore 5
    ...
    //   187: goto -117 -> 70
    //   190: new 329	com/estrongs/fs/impl/local/u
    //   193: dup
    //   194: aconst_null
    //   195: invokespecial 972	com/estrongs/fs/impl/local/u:<init>	(Lcom/estrongs/fs/impl/local/m;)V
    //   198: astore 6
    //   200: aload 6
    //   202: aload 5
    //   204: iconst_0
    //   205: aaload
    //   206: invokevirtual 975	java/lang/String:trim	()Ljava/lang/String;
    //   209: putfield 333	com/estrongs/fs/impl/local/u:b	Ljava/lang/String;
    //   212: aload 6
    //   214: aload 5
    //   216: iconst_1
    //   217: aaload
    //   218: invokevirtual 975	java/lang/String:trim	()Ljava/lang/String;
    //   221: invokestatic 978	java/lang/Integer:parseInt	(Ljava/lang/String;)I
    //   224: putfield 331	com/estrongs/fs/impl/local/u:a	I
    //   227: getstatic 39	com/estrongs/fs/impl/local/l:b	Ljava/util/List;
    //   230: aload 6
    //   232: invokeinterface 979 2 0
    //   237: pop
    //   238: aload 6
    //   240: aload 5
    //   242: iconst_2
    //   243: aaload
    //   244: invokevirtual 975	java/lang/String:trim	()Ljava/lang/String;
    //   247: putfield 333	com/estrongs/fs/impl/local/u:b	Ljava/lang/String;
    //   250: aload 6
    //   252: aload 5
    //   254: iconst_3
    //   255: aaload
    //   256: invokevirtual 975	java/lang/String:trim	()Ljava/lang/String;
    //   259: invokestatic 978	java/lang/Integer:parseInt	(Ljava/lang/String;)I
    //   262: putfield 331	com/estrongs/fs/impl/local/u:a	I
    //   265: getstatic 37	com/estrongs/fs/impl/local/l:a	Ljava/util/List;
    //   268: aload 6
    //   270: invokeinterface 979 2 0
    //   275: pop
    //   276: goto -150 -> 126
    //   279: astore 4
    //   281: getstatic 37	com/estrongs/fs/impl/local/l:a	Ljava/util/List;
    //   284: invokeinterface 320 1 0
    //   289: iconst_2
    //   290: if_icmpge +5 -> 295
    //   293: iconst_0
    //   294: ireturn
    //   295: new 981	com/estrongs/fs/impl/local/n
    //   298: dup
    //   299: invokespecial 982	com/estrongs/fs/impl/local/n:<init>	()V
    //   302: astore 4
    //   304: getstatic 37	com/estrongs/fs/impl/local/l:a	Ljava/util/List;
    //   307: invokeinterface 986 1 0
    //   312: astore 5
    //   314: aload 5
    //   316: aload 4
    //   318: invokestatic 992	java/util/Arrays:sort	([Ljava/lang/Object;Ljava/util/Comparator;)V
    //   321: getstatic 37	com/estrongs/fs/impl/local/l:a	Ljava/util/List;
    //   324: invokeinterface 964 1 0
    //   329: getstatic 37	com/estrongs/fs/impl/local/l:a	Ljava/util/List;
    //   332: aload 5
    //   334: iconst_0
    //   335: aaload
    //   336: checkcast 329	com/estrongs/fs/impl/local/u
    //   339: invokeinterface 979 2 0
    //   344: pop
    //   345: iconst_1
    //   346: istore_0
    //   347: iload_0
    ...
    //   354: getstatic 37	com/estrongs/fs/impl/local/l:a	Ljava/util/List;
    //   357: invokeinterface 320 1 0
    //   362: istore_1
    //   363: getstatic 37	com/estrongs/fs/impl/local/l:a	Ljava/util/List;
    ...
    //   377: iload_0
    //   378: aaload
    //   379: checkcast 329	com/estrongs/fs/impl/local/u
    //   382: getfield 331	com/estrongs/fs/impl/local/u:a	I
    //   385: getstatic 37	com/estrongs/fs/impl/local/l:a	Ljava/util/List;
    //   388: iload_1
    //   389: iconst_1
    //   390: isub
    //   391: invokeinterface 327 2 0
    //   396: checkcast 329	com/estrongs/fs/impl/local/u
    //   399: getfield 331	com/estrongs/fs/impl/local/u:a	I
    //   402: if_icmpeq +19 -> 421
    //   405: getstatic 37	com/estrongs/fs/impl/local/l:a	Ljava/util/List;
    //   408: aload 5
    //   410: iload_0
    //   411: aaload
    //   412: checkcast 329	com/estrongs/fs/impl/local/u
    //   415: invokeinterface 979 2 0
    //   420: pop
    //   421: iload_0
    //   422: iconst_1
    //   423: iadd
    //   424: istore_0
    //   425: goto -78 -> 347
    //   428: getstatic 39	com/estrongs/fs/impl/local/l:b	Ljava/util/List;
    //   431: invokeinterface 986 1 0
    //   436: astore 5
    //   438: aload 5
    //   440: aload 4
    //   442: invokestatic 992	java/util/Arrays:sort	([Ljava/lang/Object;Ljava/util/Comparator;)V
    //   445: getstatic 39	com/estrongs/fs/impl/local/l:b	Ljava/util/List;
    //   448: invokeinterface 964 1 0
    //   453: getstatic 39	com/estrongs/fs/impl/local/l:b	Ljava/util/List;
    //   456: aload 5
    //   458: iconst_0
    //   459: aaload
    //   460: checkcast 329	com/estrongs/fs/impl/local/u
    //   463: invokeinterface 979 2 0
    //   468: pop
    //   469: iconst_1
    //   470: istore_0
    //   471: iload_3
    ...
    //   480: getstatic 39	com/estrongs/fs/impl/local/l:b	Ljava/util/List;
    ...
    //   496: iload_0
    //   497: aaload
    //   498: checkcast 329	com/estrongs/fs/impl/local/u
    //   501: getfield 331	com/estrongs/fs/impl/local/u:a	I
    //   504: getstatic 39	com/estrongs/fs/impl/local/l:b	Ljava/util/List;
    //   507: iload_1
    //   508: iconst_1
    //   509: isub
    //   510: invokeinterface 327 2 0
    //   515: checkcast 329	com/estrongs/fs/impl/local/u
    //   518: getfield 331	com/estrongs/fs/impl/local/u:a	I
    //   521: if_icmpeq +19 -> 540
    //   524: getstatic 39	com/estrongs/fs/impl/local/l:b	Ljava/util/List;
    //   527: aload 5
    //   529: iload_0
    //   530: aaload
    //   531: checkcast 329	com/estrongs/fs/impl/local/u
    //   534: invokeinterface 979 2 0
    //   539: pop
    //   540: iload_0
    //   541: iconst_1
    //   542: iadd
  ...
  {
    // Byte code:
    //   0: invokestatic 408	com/estrongs/fs/impl/local/l:p	()Landroid/net/LocalSocket;
    //   3: astore 4
    //   5: aload 4
    //   7: ifnonnull +5 -> 12
    //   10: aconst_null
    ...
    //   24: aload_2
    //   25: iconst_5
    //   26: invokestatic 369	com/estrongs/fs/impl/local/l:a	(Ljava/io/OutputStream;I)V
    //   29: aload_1
    //   30: invokestatic 419	com/estrongs/fs/impl/local/l:c	(Ljava/io/InputStream;)I
    //   33: istore_0
    //   34: iload_0
    //   35: ifeq +29 -> 64
    //   38: aload_1
    ...
    //   63: areturn
    //   64: aload_1
    //   65: invokestatic 416	com/estrongs/fs/impl/local/l:a	(Ljava/io/InputStream;)Ljava/lang/String;
    //   68: astore_3
    //   69: aload_3
    //   70: ifnull +38 -> 108
    //   73: aload_3
    //   74: invokevirtual 555	java/lang/String:length	()I
    //   77: istore_0
    //   78: iload_0
    //   79: ifne +29 -> 108
    //   82: aload_1
