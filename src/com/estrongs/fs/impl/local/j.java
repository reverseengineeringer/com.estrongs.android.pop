...
public class j
{
  ...
  {
    // Byte code:
    //   0: getstatic 10	com/estrongs/fs/impl/local/j:a	Z
    //   3: ifne +5 -> 8
    //   6: aconst_null
    //   7: areturn
    ...
    //   36: ldc 118
    //   38: aastore
    //   39: invokestatic 123	com/estrongs/android/util/h:a	(Ljava/lang/Object;Ljava/lang/String;Ljava/lang/String;[Ljava/lang/Object;)Ljava/lang/Object;
    //   42: astore_3
    //   43: aload_3
    //   44: ifnonnull +15 -> 59
    //   47: iconst_0
    ...
    //   151: ifnull +86 -> 237
    //   154: iconst_1
    //   155: putstatic 10	com/estrongs/fs/impl/local/j:a	Z
    //   158: aload_3
    //   159: ifnull +9 -> 168
    //   162: aload_3
    ...
    //   180: ldc -108
    //   182: aload_0
    //   183: invokestatic 154	com/estrongs/android/util/am:d	(Ljava/lang/String;)Ljava/lang/String;
    ...
    //   247: iconst_0
    //   248: putstatic 10	com/estrongs/fs/impl/local/j:a	Z
    //   251: aconst_null
    //   252: areturn
    //   253: astore_3
    //   254: aconst_null
  ...
  private static boolean a(String paramString)
  {
    ...
    //   6: iconst_0
    //   7: ireturn
    //   8: invokestatic 190	com/estrongs/fs/impl/local/j:b	()Z
    //   11: ifne +5 -> 16
    //   14: iconst_0
    //   15: ireturn
    //   16: aload_0
    //   17: invokestatic 193	com/estrongs/android/util/am:bE	(Ljava/lang/String;)Ljava/lang/String;
    //   20: astore 4
    //   22: aload 4
    //   24: astore_3
    //   25: aload 4
    ...
    //   48: astore_3
    //   49: invokestatic 206	com/estrongs/fs/impl/local/j:c	()I
    //   52: istore_1
    //   53: iload_1
    //   54: iconst_m1
    //   55: if_icmpne +5 -> 60
    ...
    //   60: aload_3
    //   61: iload_1
    //   62: invokestatic 208	com/estrongs/fs/impl/local/j:a	(Ljava/lang/String;I)Landroid/net/Uri;
    //   65: astore 4
    //   67: aload 4
    //   69: ifnonnull +5 -> 74
    //   72: iconst_0
    ...
    //   145: invokestatic 227	com/estrongs/fs/impl/local/j:c	(Ljava/lang/String;)Z
    //   148: pop
    //   149: iload_2
    //   150: ireturn
    //   151: astore_0
  ...
  private static boolean b()
  {
    ...
    //   87: iconst_m1
    //   88: invokestatic 253	com/estrongs/android/util/bd:a	(Ljava/io/InputStream;Ljava/lang/String;I)Z
    //   91: ifne +13 -> 104
    //   94: aload_2
    //   95: ifnull +62 -> 157
    //   98: aload_2
    ...
    //   133: iconst_m1
    //   134: invokestatic 253	com/estrongs/android/util/bd:a	(Ljava/io/InputStream;Ljava/lang/String;I)Z
    //   137: ifne +13 -> 150
    //   140: aload_1
    //   141: ifnull +16 -> 157
    //   144: aload_1
  ...
  private static boolean b(String paramString)
  {
    ...
    try
    {
      Uri localUri1 = (Uri)h.a(null, "android.provider.MediaStore$Files", "getContentUri", new String[] { "external" });
    }
  ...
  public static boolean b(String paramString, boolean paramBoolean)
  {
    ...
    //   8: iconst_1
    //   9: istore_3
    //   10: getstatic 10	com/estrongs/fs/impl/local/j:a	Z
    //   13: ifne +5 -> 18
    //   16: iconst_0
    //   17: ireturn
    //   18: iload_1
    ...
    //   22: aload_0
    //   23: iconst_0
    //   24: invokestatic 269	com/estrongs/fs/impl/local/j:a	(Ljava/lang/String;Z)Ljava/io/OutputStream;
    //   27: astore_0
    //   28: aload_0
    //   29: ifnull +366 -> 395
    //   32: iload 5
    ...
    //   189: istore_2
    //   190: aload_0
    //   191: invokestatic 280	com/estrongs/fs/impl/local/j:a	(Ljava/lang/String;)Z
    //   194: istore_1
    //   195: iload_1
    //   196: ireturn
    ...
    //   280: istore_2
    //   281: aload_0
    //   282: invokestatic 280	com/estrongs/fs/impl/local/j:a	(Ljava/lang/String;)Z
    //   285: ireturn
    //   286: iload_3
    //   287: istore_1
    //   288: iload_3
    ...
    //   341: ifne +8 -> 349
    //   344: aload_0
    //   345: invokestatic 280	com/estrongs/fs/impl/local/j:a	(Ljava/lang/String;)Z
    //   348: ireturn
    //   349: aload 7
