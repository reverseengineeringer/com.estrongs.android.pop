  ...
  extends CommandBlockWrapper
{
  ...
  {
    super(paramInt2, CommandBlockWrapper.Direction.IN, (byte)0, (byte)16);
    a = paramInt1;
    b = paramInt2;
    c = paramInt3;
  ...
  {
    return "ScsiRead10 [blockAddress=" + a + ", transferBytes=" + b + ", blockSize=" + c + ", transferBlocks=" + d + ", getdCbwDataTransferLength()=" + b() + "]";
  }
}

/* Location:
 * Qualified Name:     com.estrongs.fs.impl.usb.driver.scsi.c
