...
public class b
{
  ...
  public static String a(String paramString)
  {
    ...
    Object localObject = ap.A(paramString);
    String str1 = ap.C(paramString);
    String str2 = ap.bI(paramString);
    paramString = ap.F(paramString);
  ...
  public static boolean a(String paramString1, String paramString2)
  {
    ...
    try
    {
      ...
      if (!localSmbFile.exists()) {
        throw new FileSystemException(new FileNotFoundException(ap.F(paramString1)));
      }
    }
    catch (MalformedURLException paramString1)
    {
      ...
      if (paramString2.exists()) {
        throw new FileExistException(ap.F(paramString1));
      }
    }
    ...
    for (;;)
    {
      try
      {
        ...
        if (paramString2.charAt(paramString2.length() - 1) == '/')
        {
          ...
          {
            paramString1 = new SmbFile(ap.e(paramString2) + "/" + ap.d(paramString2) + (int)System.currentTimeMillis() + "/");
  ...
  public static long d(String paramString)
  {
    try
    {
      ...
      if (localSmbFile.exists())
      {
        ...
        throw new FileNotFoundException(ap.F(paramString));
      }
    }
    catch (SmbException paramString)
    {
...
/* Location:
 * Qualified Name:     com.estrongs.fs.impl.u.b
