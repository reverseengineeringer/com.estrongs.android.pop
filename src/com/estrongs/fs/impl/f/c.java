...
public class c
  extends com.estrongs.fs.impl.h.b
{
  ...
  public static boolean a()
  {
    try
    {
      ...
      localObject1 = ac.a((HttpParams)localObject2).execute((HttpUriRequest)localObject1);
  ...
  private boolean i(String paramString)
  {
    ...
    catch (Exception localException)
    {
      ...
      for (;;)
      {
        Object localObject2;
        String str;
        Log.w(c, "doDelete - Failed to getFileList: " + (String)localObject1);
        continue;
  ...
  public OutputStream a(String paramString, TypedMap paramTypedMap)
  {
    ...
    for (;;)
    {
      paramTypedMap = ac.a(null);
      Object localObject;
      try
      {
        paramString = Uri.parse(paramString);
        localObject = Uri.encode(am.bk(paramString.getPath()), "/");
        ...
        for (;;)
        {
          try
          {
            ...
            paramString = am.d(paramString.getPath()).replace("+", "%20").replace("%7E", "~");
            if (l1 == 0L)
            {
              l2 = 1L;
          ...
          {
            Log.e(c, "Can't create pipe stream");
            return null;
          }
          long l2 = l1;
        }
  ...
  public boolean b(String paramString)
  {
    ...
    {
      Log.e("ERROR", "ERROR: " + paramString.toString());
    }
    return false;
  }
  ...
  {
    Object localObject = am.bk(Uri.parse(k(paramString)).getPath());
    try
    {
  ...
  public boolean e(String paramString)
  {
    try
    {
      boolean bool = i(e.c(Uri.parse(com.estrongs.fs.impl.h.b.g(k(paramString))).getPath()));
      return bool;
    }
    catch (Exception paramString)
    {
  ...
  public InputStream f(String paramString)
  {
    try
    {
      ...
      paramString = d(e.a(am.bk(paramString), am.d(paramString)));
      return paramString;
    }
