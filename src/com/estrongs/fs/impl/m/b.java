  ...
  extends v
{
  ...
  public static boolean h(String paramString)
  {
    ...
    //   3: dup
    //   4: aload_0
    //   5: invokestatic 57	com/estrongs/fs/impl/m/b:g	(Ljava/lang/String;)Ljava/lang/String;
    ...
    //   28: getstatic 18	com/estrongs/fs/impl/m/b:c	Lorg/apache/http/params/HttpParams;
    //   31: invokestatic 77	com/estrongs/android/util/ah:a	(Lorg/apache/http/params/HttpParams;)Lorg/apache/http/client/HttpClient;
    //   34: aload_0
  ...
  public InputStream a(String paramString, long paramLong, TypedMap paramTypedMap)
  {
    ...
    for (;;)
    {
      ...
      {
        paramString = new com.estrongs.android.g.c((AbstractHttpClient)localObject1, paramTypedMap.getString("NEW_USERNAME"), paramTypedMap.getString("NEW_PASSWORD")).a(localHttpGet);
        continue;
      }
      ...
      if ((i != 200) && (i != 206)) {
        ...
        catch (Exception paramTypedMap)
        {
          for (;;)
          {
            l.e("HttpFileSystem", "Error when HttpGet.abort()" + paramTypedMap);
          }
        }
      }
  ...
  public h b(String paramString, TypedMap paramTypedMap)
  {
    ...
    for (;;)
    {
      ...
      catch (FileSystemException paramString)
      {
        ...
        localObject1 = new com.estrongs.android.g.c((AbstractHttpClient)localHttpClient, paramTypedMap.getString("NEW_USERNAME"), paramTypedMap.getString("NEW_PASSWORD"));
        paramTypedMap = ((com.estrongs.android.g.c)localObject1).a((HttpRequestBase)localObject2);
        localObject1 = ((com.estrongs.android.g.c)localObject1).a();
        continue;
        if (i != 403) {
          break label180;
        }
...
/* Location:
 * Qualified Name:     com.estrongs.fs.impl.m.b
