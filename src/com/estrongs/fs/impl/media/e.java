...
import com.estrongs.android.pop.app.finder.data.d;
  ...
  implements u
{
  ...
  public static List<com.estrongs.fs.h> a(String paramString1, String paramString2, i parami, String paramString3)
  {
    ...
    for (Object localObject1 = q.a(Uri.decode((String)parami.get("keyword")));; localObject1 = null)
    {
      ...
      {
        localr.a(ap.l());
        aj[] arrayOfaj = com.estrongs.android.pop.utils.ad.f();
        String[] arrayOfString = com.estrongs.android.pop.utils.ad.a(arrayOfaj);
        if (arrayOfaj.length > 500) {
          localr.a(new f(arrayOfaj, arrayOfString));
        }
          ...
          catch (Exception localException1)
          {
            ...
            catch (Exception localException2)
            {
                ...
                if ((arrayOfaj.length > 0) && (arrayOfaj.length <= 500))
                {
                  ...
                  for (;;)
                  {
                    if (i < arrayOfaj.length) {
                      if (a)
                      {
                        localObject2 = ap.bV(arrayOfString[i]);
              ...
              for (;;)
              {
                ...
                if (!com.estrongs.android.pop.ad.a(FexApplication.a()).q()) {
                ...
                for (;;)
                {
                  ...
                  try
                  {
                    ...
                    {
                      paramString2 = ap.bV(ap.bj(paramString1));
                      continue;
                    }
                    localObject2 = new com.estrongs.fs.impl.local.f(new File(parami.getString(0)));
                    if (localr.a((com.estrongs.fs.h)localObject2))
                    {
                      localObject2 = new com.estrongs.fs.impl.s.a(paramString1, paramString2, (com.estrongs.fs.h)localObject2);
                      if (paramString3 != null) {
                        a = paramString3.a();
                      }
                      localLinkedList.add(localObject2);
                      continue;
                      Collections.sort(localLinkedList, new g());
                    }
                  }
                  finally
                  {
    ...
    for (;;)
    {
      try
      {
        ...
        if (paramList.size() % 100 == 0)
        {
          ...
          String str2 = ap.bV((String)paramList.get(j * 100 + m));
          str1 = str2;
          if (!str2.endsWith("/")) {
            str1 = str2 + "/";
          }
  ...
  public static void a(List<String> paramList, Set<String> paramSet)
  {
    ...
    //   68: invokestatic 275	com/estrongs/android/util/ap:bV	(Ljava/lang/String;)Ljava/lang/String;
    ...
    //   116: astore 12
    //   118: iload_2
    //   119: invokestatic 227	com/estrongs/android/util/ap:a	()Ljava/util/List;
    ...
    //   136: astore 12
    //   138: aload_1
    //   139: invokestatic 227	com/estrongs/android/util/ap:a	()Ljava/util/List;
    //   142: iload_2
    ...
    //   160: aload 16
    //   162: astore 12
    //   164: invokestatic 227	com/estrongs/android/util/ap:a	()Ljava/util/List;
    //   167: iload_2
    ...
    //   459: aload 13
    //   461: astore 12
    //   463: invokestatic 429	com/estrongs/android/pop/utils/cm:b	()V
    //   466: aload 13
    //   468: ifnull +10 -> 478
    //   471: aload 13
    ...
    //   1427: astore 12
    //   1429: aload 15
    //   1431: invokestatic 506	com/estrongs/android/util/bg:U	(Ljava/lang/String;)Ljava/lang/String;
    //   1434: astore 16
    //   1436: ldc_w 508
    //   1439: aload 16
    ...
    //   1528: ldc_w 528
    //   1531: aload 15
    //   1533: invokestatic 531	com/estrongs/android/util/ap:d	(Ljava/lang/String;)Ljava/lang/String;
    ...
    //   1545: astore 12
    //   1547: aload 15
    //   1549: invokestatic 535	com/estrongs/fs/impl/media/b:b	(Ljava/lang/String;)Z
    //   1552: ifeq +2175 -> 3727
    //   1555: aload 14
    //   1557: astore 13
    //   1559: aload 14
    ...
    //   1713: astore 12
    //   1715: aload 26
    //   1717: invokestatic 552	com/estrongs/android/util/bg:b	(Ljava/lang/String;)I
    //   1720: istore_2
    //   1721: aload 14
    //   1723: astore 13
    //   1725: aload 14
    ...
    //   1744: astore 12
    //   1746: aload 26
    //   1748: invokestatic 535	com/estrongs/fs/impl/media/b:b	(Ljava/lang/String;)Z
    //   1751: istore 6
    //   1753: aload 14
    //   1755: astore 13
    //   1757: aload 14
    //   1759: astore 12
    //   1761: aload 26
    //   1763: invokestatic 554	com/estrongs/fs/impl/media/b:c	(Ljava/lang/String;)Z
    //   1766: istore 7
    //   1768: iload 6
    //   1770: ifne +8 -> 1778
    //   1773: iload 7
    ...
    //   2097: arraylength
    //   2098: iconst_1
    //   2099: invokestatic 583	com/estrongs/android/util/e:a	([BIZ)Ljava/lang/String;
    //   2102: astore 30
    //   2104: aload 23
    //   2106: astore 22
    //   2108: aload 16
    ...
    //   2133: aload 13
    //   2135: astore 21
    //   2137: getstatic 588	com/estrongs/fs/impl/media/c:f	Ljava/util/Set;
    //   2140: aload 30
    ...
    //   2265: aload 26
    //   2267: aload 20
    //   2269: invokestatic 594	com/estrongs/fs/impl/media/c:a	(Landroid/content/ContentValues;Ljava/lang/String;Ljava/lang/String;)V
    //   2272: aload 28
    //   2274: ifnull +17 -> 2291
    //   2277: aload 14
    //   2279: astore 12
    ...
    //   2368: astore 12
    //   2370: aload 26
    //   2372: getstatic 601	com/estrongs/fs/impl/media/c:a	[Ljava/lang/String;
    //   2375: iconst_0
    //   2376: aaload
    ...
    //   2385: astore 12
    //   2387: aload 26
    //   2389: getstatic 601	com/estrongs/fs/impl/media/c:a	[Ljava/lang/String;
    //   2392: iconst_1
    //   2393: aaload
    ...
    //   2405: astore 12
    //   2407: aload 26
    //   2409: getstatic 603	com/estrongs/fs/impl/media/c:b	[Ljava/lang/String;
    //   2412: iconst_0
    //   2413: aaload
    ...
    //   2422: astore 12
    //   2424: aload 26
    //   2426: getstatic 603	com/estrongs/fs/impl/media/c:b	[Ljava/lang/String;
    //   2429: iconst_1
    //   2430: aaload
    ...
    //   2564: aload 26
    //   2566: aconst_null
    //   2567: invokestatic 594	com/estrongs/fs/impl/media/c:a	(Landroid/content/ContentValues;Ljava/lang/String;Ljava/lang/String;)V
    //   2570: aload 14
    //   2572: astore 13
    //   2574: aload 14
    //   2576: astore 12
    ...
    //   2604: aload 14
    //   2606: astore 12
    //   2608: invokestatic 625	com/estrongs/android/util/bk:h	()Z
    //   2611: ifeq -137 -> 2474
    //   2614: aload 14
    //   2616: astore 12
    //   2618: aload 25
    ...
    //   2684: astore 12
    //   2686: aload 26
    //   2688: invokestatic 631	com/estrongs/fs/impl/media/b:a	(Ljava/lang/String;)Z
    //   2691: ifeq +1057 -> 3748
    //   2694: aload 14
    //   2696: astore 13
    //   2698: aload 14
    ...
    //   2720: aload 14
    //   2722: astore 12
    //   2724: invokestatic 637	com/estrongs/android/util/bk:g	()Z
    //   2727: istore 6
    //   2729: iload 6
    //   2731: ifeq +122 -> 2853
    //   2734: aload 14
    ...
    //   2738: aload 14
    //   2740: astore 12
    //   2742: getstatic 22	com/estrongs/fs/impl/media/e:a	Landroid/graphics/BitmapFactory$Options;
    //   2745: iconst_0
    ...
    //   2753: aload 14
    //   2755: astore 12
    //   2757: getstatic 22	com/estrongs/fs/impl/media/e:a	Landroid/graphics/BitmapFactory$Options;
    //   2760: iconst_0
    ...
    //   2770: astore 12
    //   2772: aload 26
    //   2774: getstatic 22	com/estrongs/fs/impl/media/e:a	Landroid/graphics/BitmapFactory$Options;
    ...
    //   2785: aload 14
    //   2787: astore 12
    //   2789: getstatic 22	com/estrongs/fs/impl/media/e:a	Landroid/graphics/BitmapFactory$Options;
    ...
    //   2800: aload 14
    //   2802: astore 12
    //   2804: getstatic 22	com/estrongs/fs/impl/media/e:a	Landroid/graphics/BitmapFactory$Options;
    ...
    //   2971: astore 12
    //   2973: aload_1
    //   2974: invokestatic 670	com/estrongs/fs/impl/media/e:a	(Landroid/media/ExifInterface;)J
    //   2977: lstore 10
    //   2979: lload 10
    //   2981: ldc2_w 115
    //   2984: lcmp
    ...
    //   3169: astore 12
    //   3171: aload_1
    //   3172: invokestatic 689	com/estrongs/fs/impl/media/e:b	(Landroid/media/ExifInterface;)J
    //   3175: lstore 10
    //   3177: lload 10
    //   3179: ldc2_w 115
    //   3182: lcmp
    ...
    //   3533: invokestatic 707	com/estrongs/android/pop/utils/cm:b	(Ljava/lang/String;)V
    //   3536: iload_2
    //   3537: iconst_1
    //   3538: iadd
    //   3539: istore_2
    ...
    for (;;)
    {
      ...
      try
      {
        ...
        if (paramList.size() % 500 == 0)
        {
          ...
          str = ap.bV((String)paramList.get(j * 500 + m));
          if (m != 0) {
            continue;
          }
  ...
  {
    Object localObject = ap.bV(paramString);
    ...
    localHashSet.add(ap.bB(paramString));
  ...
  protected abstract com.estrongs.fs.h a(com.estrongs.fs.impl.local.f paramf);
  
  public com.estrongs.fs.h a(String paramString)
  {
    return null;
  }
  ...
  public List<com.estrongs.fs.h> b(com.estrongs.fs.h paramh, i parami, TypedMap paramTypedMap)
  {
    Object localObject1 = null;
    if (!cm.a(paramTypedMap)) {
      return null;
    }
    Object localObject2 = com.estrongs.android.pop.utils.ad.f();
    Object localObject3 = com.estrongs.android.pop.utils.ad.a((aj[])localObject2);
    r localr = new r(false);
    if (localObject2.length > 500) {
      localr.a(new h(this, (aj[])localObject2, (String[])localObject3));
    }
    localr.a(ap.l());
    if (parami != null) {
      localr.a(parami);
    ...
    if ((localObject2.length > 0) && (localObject2.length <= 500))
    {
      ...
      if (i < localObject2.length)
      {
        if (a)
        {
          paramTypedMap = localObject3[i];
          parami = paramTypedMap;
          if (paramTypedMap.endsWith("/")) {
            parami = paramTypedMap.substring(0, paramTypedMap.length() - 1);
          }
          if (localStringBuffer.length() > 0) {
            localStringBuffer.append(" and ");
          }
          localStringBuffer.append("_data").append("!=").append(DatabaseUtils.sqlEscapeString(parami));
          localStringBuffer.append(" and ").append("_data").append(" not like ").append(DatabaseUtils.sqlEscapeString(parami + "/" + "%"));
        }
        for (;;)
        {
          ...
          localStringBuffer.append("_data").append("!=").append(DatabaseUtils.sqlEscapeString(localObject3[i]));
        }
      }
    }
    for (parami = localStringBuffer.toString();; parami = null)
    {
      localObject2 = MediaStore.Files.getContentUri("external");
      ...
      if (parami == null)
      {
        parami = "(" + (String)localObject3 + ")";
        boolean bool2 = com.estrongs.android.pop.ad.a(FexApplication.a()).q();
        bool1 = bool2;
        if (paramh != null)
        {
          bool1 = bool2;
      ...
      label646:
      label665:
      for (paramh = parami + " and " + "_data" + " not like " + DatabaseUtils.sqlEscapeString("%/.%");; paramh = parami)
      {
        try
        {
          parami = FexApplication.a().getContentResolver().query((Uri)localObject2, new String[] { "_data", "date_modified" }, paramh, null, null);
          if (parami == null)
          {
            if (parami != null) {
              parami.close();
            ...
            return paramTypedMap;
            parami = "(" + (String)localObject3 + ") and " + parami;
            break label361;
          }
          try
          {
            paramh = com.estrongs.a.a.getCurrentTask();
            for (;;)
            {
              if (!parami.moveToNext()) {
                break label646;
