  ...
  extends a
{
  ...
  private com.estrongs.a.a.p g = new bo(this);
  
  bm(Activity paramActivity, List<h> paramList, String paramString)
  {
    a = paramActivity;
    b = d.a(paramActivity);
    d = paramList;
    ...
    if (i < j)
    {
      ...
      paramActivity = am.d(((h)paramList.get(i)).getAbsolutePath());
    }
    label316:
    for (;;)
    {
      ...
      for (;;)
      {
        ...
        if (i + 1 != j)
        {
          ...
          if (i >= 4)
          {
            ...
            e();
            setDescription(a.getString(2131427560) + e);
          }
        }
        try
        {
  ...
  public static bm a(Activity paramActivity, List<h> paramList, String paramString, boolean paramBoolean)
  {
    paramList = new bm(paramActivity, paramList, paramString);
    paramList.addTaskStatusChangeListener(new bn());
    if (paramBoolean)
    {
      paramString = new Intent(paramActivity, ShowDialogActivity.class);
      paramString.setFlags(268435456);
      paramString.putExtra("task_title", paramActivity.getString(2131427462));
  ...
  public boolean task()
  {
    // Byte code:
    //   0: aload_0
    //   1: getfield 122	com/estrongs/fs/b/bm:processData	Lcom/estrongs/a/a/m;
    //   4: lconst_0
    //   5: putfield 335	com/estrongs/a/a/m:c	J
    //   8: aload_0
    //   9: getfield 122	com/estrongs/fs/b/bm:processData	Lcom/estrongs/a/a/m;
    //   12: lconst_0
    //   13: putfield 337	com/estrongs/a/a/m:d	J
    //   16: aload_0
    //   17: getfield 122	com/estrongs/fs/b/bm:processData	Lcom/estrongs/a/a/m;
    //   20: new 79	java/lang/StringBuilder
    //   23: dup
    //   24: invokespecial 80	java/lang/StringBuilder:<init>	()V
    //   27: aload_0
    //   28: getfield 45	com/estrongs/fs/b/bm:a	Landroid/app/Activity;
    //   31: ldc_w 338
    ...
    //   40: aload_0
    //   41: getfield 56	com/estrongs/fs/b/bm:e	Ljava/lang/String;
    ...
    //   53: aload_0
    //   54: aload_0
    //   55: getfield 122	com/estrongs/fs/b/bm:processData	Lcom/estrongs/a/a/m;
    //   58: invokevirtual 328	com/estrongs/fs/b/bm:onProgress	(Lcom/estrongs/a/a/m;)V
    //   61: invokestatic 342	com/estrongs/a/a:getCurrentTask	()Lcom/estrongs/a/a;
    //   64: astore 22
    //   66: new 344	com/estrongs/a/b/c
    //   69: dup
    //   70: aload_0
    //   71: getfield 54	com/estrongs/fs/b/bm:d	Ljava/util/List;
    ...
    //   116: getstatic 356	com/estrongs/fs/m:b	Lcom/estrongs/fs/m;
    //   119: if_acmpne +1827 -> 1946
    //   122: aload_0
    //   123: getfield 122	com/estrongs/fs/b/bm:processData	Lcom/estrongs/a/a/m;
    //   126: astore 19
    //   128: aload 19
    //   130: aload 19
    ...
    //   156: goto -74 -> 82
    //   159: aload_0
    //   160: getfield 122	com/estrongs/fs/b/bm:processData	Lcom/estrongs/a/a/m;
    //   163: lload 10
    //   165: putfield 317	com/estrongs/a/a/m:e	J
    //   168: aload_0
    //   169: getfield 54	com/estrongs/fs/b/bm:d	Ljava/util/List;
    //   172: iconst_0
    ...
    //   188: ifnull +242 -> 430
    //   191: aload_0
    //   192: getfield 122	com/estrongs/fs/b/bm:processData	Lcom/estrongs/a/a/m;
    //   195: aload_0
    //   196: getfield 54	com/estrongs/fs/b/bm:d	Ljava/util/List;
    //   199: iconst_0
    ...
    //   221: aload_0
    //   222: getfield 54	com/estrongs/fs/b/bm:d	Ljava/util/List;
    ...
    //   241: astore 17
    //   243: aload_0
    //   244: getfield 122	com/estrongs/fs/b/bm:processData	Lcom/estrongs/a/a/m;
    //   247: astore 18
    //   249: aload 18
    //   251: aload 17
    //   253: aload 18
    ...
    //   272: aload_0
    //   273: aload_0
    //   274: getfield 122	com/estrongs/fs/b/bm:processData	Lcom/estrongs/a/a/m;
    //   277: invokevirtual 328	com/estrongs/fs/b/bm:onProgress	(Lcom/estrongs/a/a/m;)V
    //   280: aload_0
    //   281: ldc_w 359
    //   284: lload 10
    //   286: invokestatic 34	java/lang/Long:valueOf	(J)Ljava/lang/Long;
    //   289: invokevirtual 223	com/estrongs/fs/b/bm:recordSummary	(Ljava/lang/String;Ljava/lang/Object;)V
    //   292: aload_0
    //   293: getfield 54	com/estrongs/fs/b/bm:d	Ljava/util/List;
    //   296: iconst_0
    ...
    //   328: pop
    //   329: aload_0
    //   330: getfield 56	com/estrongs/fs/b/bm:e	Ljava/lang/String;
    ...
    //   404: dup
    //   405: aload_0
    //   406: getfield 45	com/estrongs/fs/b/bm:a	Landroid/app/Activity;
    //   409: ldc_w 384
    ...
    //   420: invokevirtual 391	com/estrongs/fs/b/bm:setTaskResult	(ILjava/lang/Object;)V
    //   423: aload 18
    //   425: invokevirtual 394	java/net/Socket:close	()V
    //   428: iconst_0
    //   429: ireturn
    //   430: aload_0
    //   431: getfield 122	com/estrongs/fs/b/bm:processData	Lcom/estrongs/a/a/m;
    //   434: aload_0
    //   435: getfield 54	com/estrongs/fs/b/bm:d	Ljava/util/List;
    //   438: iconst_0
    ...
    //   513: astore 19
    //   515: aload_0
    //   516: getfield 54	com/estrongs/fs/b/bm:d	Ljava/util/List;
    ...
    //   576: aload_0
    //   577: getfield 54	com/estrongs/fs/b/bm:d	Ljava/util/List;
    ...
    //   600: aload_0
    //   601: getfield 122	com/estrongs/fs/b/bm:processData	Lcom/estrongs/a/a/m;
    ...
    //   718: goto -203 -> 515
    //   721: aload 17
    //   723: invokestatic 462	com/estrongs/android/util/bc:b	(Lcom/estrongs/fs/h;)Z
    //   726: istore 16
    //   728: iload 16
    //   730: ifeq +323 -> 1053
    ...
    //   1060: invokevirtual 253	com/estrongs/fs/m:a	()Z
    //   1063: ifeq +875 -> 1938
    //   1066: ldc_w 514
    //   1069: astore 17
    //   1071: goto -538 -> 533
    ...
    //   1150: dup
    //   1151: aload_0
    //   1152: getfield 45	com/estrongs/fs/b/bm:a	Landroid/app/Activity;
    //   1155: ldc_w 541
    ...
    //   1165: invokevirtual 391	com/estrongs/fs/b/bm:setTaskResult	(ILjava/lang/Object;)V
    //   1168: aload 20
    ...
    //   1263: putfield 36	com/estrongs/fs/b/bm:c	Ljava/lang/Long;
    //   1266: iconst_0
    //   1267: istore_1
    //   1268: iconst_0
    //   1269: istore_3
    ...
    //   1273: iload_3
    //   1274: aload_0
    //   1275: getfield 54	com/estrongs/fs/b/bm:d	Ljava/util/List;
    //   1278: invokeinterface 86 1 0
    //   1283: if_icmpge +649 -> 1932
    //   1286: aload_0
    //   1287: getfield 54	com/estrongs/fs/b/bm:d	Ljava/util/List;
    //   1290: iload_3
    ...
    //   1393: dup
    //   1394: aload_0
    //   1395: getfield 45	com/estrongs/fs/b/bm:a	Landroid/app/Activity;
    //   1398: ldc_w 567
    ...
    //   1408: invokevirtual 391	com/estrongs/fs/b/bm:setTaskResult	(ILjava/lang/Object;)V
    //   1411: iload_1
    //   1412: ifne +486 -> 1898
    //   1415: iconst_1
    //   1416: ireturn
    ...
    //   1465: getstatic 356	com/estrongs/fs/m:b	Lcom/estrongs/fs/m;
    ...
    //   1516: getstatic 569	com/estrongs/fs/m:a	Lcom/estrongs/fs/m;
    ...
    //   1651: lstore 8
    //   1653: aload_0
    //   1654: getfield 122	com/estrongs/fs/b/bm:processData	Lcom/estrongs/a/a/m;
    //   1657: astore 18
    //   1659: aload 18
    //   1661: aload 18
    ...
    //   1747: aload_0
    //   1748: getfield 52	com/estrongs/fs/b/bm:b	Lcom/estrongs/fs/d;
    //   1751: aload 25
...
/* Location:
 * Qualified Name:     com.estrongs.fs.b.bm
