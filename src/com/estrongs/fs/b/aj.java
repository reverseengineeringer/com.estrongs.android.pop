  ...
  extends com.estrongs.a.a
{
  ...
  public com.estrongs.android.pop.h d;
  com.estrongs.fs.util.a.a e = null;
  i f = null;
  Boolean g = null;
  TypedMap h = new TypedMap();
  public boolean i = false;
  private List<com.estrongs.fs.h> j = null;
  private ak k = null;
  private long l = -1L;
  
  public aj(com.estrongs.fs.d paramd, com.estrongs.android.pop.h paramh)
  {
    a = paramd;
    d = paramh;
  }
  ...
  private boolean a()
  {
    ...
    if ((j == null) && (getTaskResulta != 1)) {
      throw new FileNotFoundException(am.bL(b.getAbsolutePath()));
    }
    if (getTaskResulta == 1)
    {
  ...
  public boolean a(Object... paramVarArgs)
  {
    bool2 = true;
    c = null;
    b = ((com.estrongs.fs.h)paramVarArgs[0]);
  ...
  public boolean task()
  {
    ...
    for (;;)
    {
      ...
      catch (Throwable localThrowable)
      {
        ...
        return true;
        if ((am.b(b.getPath(), h)) && (!h.getBoolean("get_data_from_cache"))) {
...
/* Location:
 * Qualified Name:     com.estrongs.fs.b.aj
