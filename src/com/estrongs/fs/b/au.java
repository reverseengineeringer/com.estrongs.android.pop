  ...
  extends com.estrongs.a.a
{
  ...
  public au(Activity paramActivity, com.estrongs.fs.d paramd, List<h> paramList)
  {
    c = paramd;
    b = paramList;
    canRestart = false;
  ...
  protected void postTask()
  {
    ...
    try
    {
      ...
      {
        if (h.size() > 0) {
          com.estrongs.fs.impl.p.c.b().a(h);
        }
        if (i.size() > 0) {
          com.estrongs.fs.impl.n.d.b().a(i);
        }
        if (j.size() > 0)
        {
          com.estrongs.fs.impl.v.c.b().a(j);
          return;
        }
      }
    }
  ...
  public boolean task()
  {
    ...
    for (;;)
    {
      ...
      else
      {
        ...
        {
          ??? = (h)((Iterator)???).next();
          localObject1 = ap.cl(((h)???).getAbsolutePath());
    ...
    for (;;)
    {
      ...
      synchronized (f)
      {
        e = new aq(c, (List)???, (h)localObject10);
        e.a(this);
        e.g(false);
        e.processData.i = 3;
