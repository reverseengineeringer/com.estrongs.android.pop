  ...
  extends com.estrongs.a.a
{
  ...
  private PcsFileSystem m = (PcsFileSystem)com.estrongs.fs.impl.j.b.a("pcs");
  
  public ap(d paramd, String paramString, com.estrongs.fs.impl.pcs.a parama)
  {
    this(paramd, paramString, parama, null);
  }
  
  public ap(d paramd, String paramString1, com.estrongs.fs.impl.pcs.a parama, String paramString2)
  {
    l = paramString2;
  ...
  public boolean task()
  {
    for (;;)
    {
      ...
      catch (Exception localException1)
      {
        ...
        onProgress(processData);
        if ((processData.f >= processData.e) || (bd.a(c.getExtra("status"), -1) == 0))
        {
          recordSummary("end_time", Long.valueOf(c.lastModified()));
          str = summary().optString("title");
          if ((bd.b(str)) && (!bd.a(c.getName(), str)) && (m.renameFile(j, k, "/files/apps/Downloads/" + c.getName(), "/files/apps/Downloads/" + str))) {
            recordSummary("target", a + str);
          }
          str = c.getPath();
...
/* Location:
 * Qualified Name:     com.estrongs.fs.b.ap
