  ...
  extends a
{
  ...
  private aw(Context paramContext)
  {
    ...
    e = a(paramContext);
    g = paramContext;
    setDescription(paramContext.getString(2131232190));
  }
  
  public static aw a(Activity paramActivity, p paramp, l paraml, boolean paramBoolean)
  {
    aw localaw = new aw(paramActivity);
    localaw.addTaskStatusChangeListener(paramp);
    localaw.addProgressListener(paraml);
    if (paramBoolean)
    {
      new kh(paramActivity, paramActivity.getString(2131232190), localaw).show();
      localaw.execute();
      return localaw;
    }
    localaw.execute();
  ...
  public boolean task()
  {
    // Byte code:
    //   0: aload_0
    //   1: getfield 64	com/estrongs/fs/b/aw:e	[B
    //   4: ifnonnull +5 -> 9
    //   7: iconst_0
    //   8: ireturn
    ...
    //   25: astore 8
    //   27: aload 8
    //   29: new 272	com/estrongs/fs/b/ax
    //   32: dup
    //   33: aload_0
    //   34: invokespecial 275	com/estrongs/fs/b/ax:<init>	(Lcom/estrongs/fs/b/aw;)V
    ...
    //   123: goto -54 -> 69
    //   126: aload_0
    //   127: getfield 64	com/estrongs/fs/b/aw:e	[B
    //   130: iconst_0
    //   131: baload
    //   132: iflt +180 -> 312
    //   135: aload_0
    //   136: getfield 64	com/estrongs/fs/b/aw:e	[B
    //   139: iconst_0
    //   140: baload
    //   141: istore_2
    //   142: aload_0
    //   143: getfield 64	com/estrongs/fs/b/aw:e	[B
    //   146: iconst_1
    //   147: baload
    //   148: iflt +178 -> 326
    //   151: aload_0
    //   152: getfield 64	com/estrongs/fs/b/aw:e	[B
    //   155: iconst_1
    //   156: baload
    //   157: istore_3
    //   158: aload_0
    //   159: getfield 64	com/estrongs/fs/b/aw:e	[B
    //   162: iconst_2
    //   163: baload
    //   164: iflt +176 -> 340
    //   167: aload_0
    //   168: getfield 64	com/estrongs/fs/b/aw:e	[B
    //   171: iconst_2
    //   172: baload
    //   173: istore 4
    //   175: aload 10
    ...
    //   190: iconst_1
    //   191: aload_0
    //   192: getfield 66	com/estrongs/fs/b/aw:g	Landroid/content/Context;
    //   195: ldc_w 300
    ...
    //   205: getstatic 45	com/estrongs/fs/b/aw:d	[[Ljava/lang/String;
    //   208: astore 9
    //   210: aload 9
    //   212: monitorenter
    //   213: aload_0
    //   214: lconst_0
    //   215: putfield 197	com/estrongs/fs/b/aw:f	J
    //   218: aload 9
    //   220: monitorexit
    //   221: iconst_0
    //   222: istore 5
    //   224: iload 5
    //   226: getstatic 32	com/estrongs/fs/b/aw:b	I
    //   229: if_icmpge +170 -> 399
    //   232: getstatic 32	com/estrongs/fs/b/aw:b	I
    //   235: iload_1
    //   236: imul
    //   237: iload 5
    //   239: iadd
    //   240: istore 6
    //   242: new 305	com/estrongs/fs/b/az
    //   245: dup
    //   246: aload_0
    ...
    //   295: iload 6
    //   297: invokespecial 308	com/estrongs/fs/b/az:<init>	(Lcom/estrongs/fs/b/aw;Ljava/lang/String;I)V
    //   300: invokevirtual 311	com/estrongs/fs/b/az:start	()V
    //   303: iload 5
    //   305: iconst_1
    //   306: iadd
    //   307: istore 5
    //   309: goto -85 -> 224
    //   312: getstatic 34	com/estrongs/fs/b/aw:c	I
    //   315: aload_0
    //   316: getfield 64	com/estrongs/fs/b/aw:e	[B
    //   319: iconst_0
    //   320: baload
    //   321: iadd
    //   322: istore_2
    //   323: goto -181 -> 142
    //   326: getstatic 34	com/estrongs/fs/b/aw:c	I
    //   329: aload_0
    //   330: getfield 64	com/estrongs/fs/b/aw:e	[B
    //   333: iconst_1
    //   334: baload
    //   335: iadd
    //   336: istore_3
    //   337: goto -179 -> 158
    //   340: getstatic 34	com/estrongs/fs/b/aw:c	I
    //   343: istore 4
    //   345: aload_0
    //   346: getfield 64	com/estrongs/fs/b/aw:e	[B
    //   349: iconst_2
    //   350: baload
    //   351: istore 5
    //   353: iload 4
    ...
    //   399: getstatic 45	com/estrongs/fs/b/aw:d	[[Ljava/lang/String;
    //   402: astore 9
    //   404: aload 9
    //   406: monitorenter
    //   407: aload_0
    //   408: getfield 197	com/estrongs/fs/b/aw:f	J
    //   411: getstatic 32	com/estrongs/fs/b/aw:b	I
    //   414: i2l
    //   415: lcmp
    //   416: ifne -26 -> 390
    //   419: aload 9
    ...
    //   424: iadd
    //   425: istore_1
    //   426: getstatic 34	com/estrongs/fs/b/aw:c	I
    //   429: getstatic 32	com/estrongs/fs/b/aw:b	I
    //   432: idiv
    //   433: istore_2
    //   434: iload_1
    //   435: iload_2
...
/* Location:
 * Qualified Name:     com.estrongs.fs.b.aw
