...
public class ax
{
  ...
  protected ax(View paramView, int paramInt1, int paramInt2, boolean paramBoolean)
  {
    if (paramView != null)
    {
  ...
  protected ax(View paramView, Rect paramRect)
  {
  ...
  private void a(RelativeLayout.LayoutParams paramLayoutParams)
  {
    ...
    ((Activity)e).getWindow().getDecorView().getWindowVisibleDisplayFrame(localRect);
    int i1 = top;
    if (D == 0)
    {
  ...
  private int d(boolean paramBoolean)
  {
    ...
    for (;;)
    {
      if ((E == null) || (paramBoolean))
      {
        ...
        E.setAnimationListener(new ay(this));
      }
      if ((F == null) || (paramBoolean))
      {
        ...
        F.setAnimationListener(localaz);
      }
      return C;
      if (D == 1)
      {
