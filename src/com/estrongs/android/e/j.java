...
public class j
{
  ...
  public j(Context paramContext, h paramh, ScanResult paramScanResult)
  {
    b = paramScanResult;
    e = paramContext;
  }
  ...
  public String[] b()
  {
    ...
    do
    {
      ...
      {
        arrayOfString[1] = e.getString(2131427469);
        return arrayOfString;
      }
      if (d == NetworkInfo.DetailedState.CONNECTING)
      {
        arrayOfString[1] = e.getString(2131427447);
        return arrayOfString;
      }
      if (d == NetworkInfo.DetailedState.OBTAINING_IPADDR)
      {
        arrayOfString[1] = e.getString(2131427450);
        return arrayOfString;
      }
      if (d == NetworkInfo.DetailedState.SCANNING)
      {
        arrayOfString[1] = e.getString(2131427446);
        return arrayOfString;
      }
    } while (d != NetworkInfo.DetailedState.AUTHENTICATING);
    arrayOfString[1] = e.getString(2131427449);
    return arrayOfString;
  }
...
/* Location:
 * Qualified Name:     com.estrongs.android.e.j
