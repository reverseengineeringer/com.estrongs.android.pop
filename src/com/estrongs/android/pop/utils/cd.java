...
public class cd
{
  ...
  public static boolean a(TypedMap paramTypedMap)
  {
    ...
    do
    {
      ...
      if ((paramTypedMap != null) && (paramTypedMap.getBoolean("updateMediaStore")))
      {
        ...
        arrayOfBroadcastReceiver[0] = new ce(locala);
  ...
  public static int c(String paramString)
  {
    try
    {
      int i = bd.a(new ExifInterface(paramString).getAttribute("Orientation"));
      switch (i)
      {
      case 0: 
      case 1: 
