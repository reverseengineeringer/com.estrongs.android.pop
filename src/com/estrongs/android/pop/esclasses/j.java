...
public class j
{
  ...
  {
    if ((!(paramActivity instanceof ESPreferenceActivity)) && (!(paramActivity instanceof ESActivity))) {
    ...
    for (;;)
    {
      try
      {
        ...
        if (localPreference != null)
        {
          ...
          {
            ((ListPreference)localPreference).setNegativeButtonText(i.getText(2131427340));
          ...
          else
          {
            ...
            {
              ((EditTextPreference)localPreference).setPositiveButtonText(i.getText(2131427339));
              ((EditTextPreference)localPreference).setNegativeButtonText(i.getText(2131427340));
...
/* Location:
 * Qualified Name:     com.estrongs.android.pop.esclasses.j
