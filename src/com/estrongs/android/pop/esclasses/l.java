...
public class l
{
  ...
  private View a(String paramString, AttributeSet paramAttributeSet, View paramView)
  {
    ...
    if (!p)
    {
      ...
      if (resourceId > 0)
      {
        str = o.getResources().getResourceTypeName(resourceId);
        ...
        paramString.setBackgroundDrawable(at.a(o).a(resourceId));
    ...
    if ((paramString instanceof TextView))
    {
      ...
      if (!p)
      {
        ...
        if (resourceId > 0) {
          ((TextView)paramString).setTextColor(at.a(o).c(resourceId));
        }
        ...
        if ((paramView[0] != null) || (paramView[1] != null) || (paramView[2] != null) || (paramView[3] != null))
        {
          ...
          if (resourceId > 0)
          {
            paramView[0] = at.a(o).b(resourceId);
            i1 = 1;
          }
          localObject = new TypedValue();
          ...
          if (resourceId > 0)
          {
            paramView[1] = at.a(o).b(resourceId);
            i1 = 1;
          }
          localObject = new TypedValue();
          ...
          if (resourceId > 0)
          {
            paramView[2] = at.a(o).b(resourceId);
            i1 = 1;
          }
          localObject = new TypedValue();
          ...
          if (resourceId > 0)
          {
            paramView[3] = at.a(o).b(resourceId);
            i1 = 1;
          }
          if (i1 != 0) {
    ...
    for (;;)
    {
      ...
      paramString.setBackgroundColor(at.a(o).c(resourceId));
      break;
      if ((!p) && ((paramString instanceof ImageView)))
      {
        ...
        if (resourceId > 0) {
          ((ImageView)paramString).setImageDrawable(at.a(o).a(resourceId));
        }
        paramAttributeSet.recycle();
      }
    }
...
/* Location:
 * Qualified Name:     com.estrongs.android.pop.esclasses.l
