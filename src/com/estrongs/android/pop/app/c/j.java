...
public class j
{
  ...
  private long a(long paramLong1, long paramLong2)
  {
    ...
    //   6: lconst_0
    //   7: lreturn
    //   8: invokestatic 44	com/estrongs/android/pop/app/c/l:a	()Lcom/estrongs/android/pop/app/c/l;
    //   11: invokevirtual 47	com/estrongs/android/pop/app/c/l:c	()Landroid/database/sqlite/SQLiteDatabase;
    //   14: astore 7
    //   16: aload_0
    //   17: getfield 24	com/estrongs/android/pop/app/c/j:a	J
    //   20: lstore 5
    //   22: aload 7
  ...
  public void b(String paramString)
  {
    ...
    if (ap.bC(paramString)) {
      str = ap.bV(paramString);
    }
    paramString = new i(str, c().size());
    c = a;
    c().add(paramString);
    if (a != -1L) {
      paramString.b();
  ...
  public List<i> c()
  {
    ...
    d = new ArrayList();
    Object localObject4 = l.a().b().query("audio_playlists_map", null, "playlist_id=" + a, null, null, null, "play_order");
    ...
    if (localObject4 != null)
    {
      ...
      while (((Cursor)localObject4).moveToNext())
      {
        ...
        localObject1 = new i(l2, str, l2, l3, (String)localObject1, (String)localObject2, (String)localObject3, l1);
        d.add(localObject1);
        if (!ap.bl(str)) {
          break label753;
        }
    ...
    for (;;)
    {
      ...
      try
      {
        ...
        while (((Cursor)localObject2).moveToNext())
        {
          ...
          localObject5 = (i)localHashMap.get(localObject5);
      ...
      for (int i = 1;; i = 0)
      {
        ...
        for (;;)
        {
          ...
          try
          {
            if (j < d.size())
            {
              ((SQLiteStatement)localObject2).clearBindings();
              if (i != 0) {
                d.get(j)).c = a;
              }
...
/* Location:
 * Qualified Name:     com.estrongs.android.pop.app.c.j
