...
public class m
{
  ...
  private m()
  {
    String[] arrayOfString = o.a(new o(this));
  ...
  public boolean b(String paramString)
  {
    ...
    for (;;)
    {
      ...
      while (i < a.size())
      {
        if (paramString.equals(((j)a.get(i)).a())) {
          return true;
        }
        i += 1;
      }
  ...
  public j e()
  {
    ...
    {
      d = new j(2131230921);
      boolean bool = ad.a(FexApplication.a()).az();
      d.a(false);
  ...
  public void i()
  {
    ...
    {
      o localo = new o(this);
      String[] arrayOfString1 = o.a(localo);
      if (arrayOfString1 != null)
      {
        ...
        while (i < k)
        {
          ...
          String[] arrayOfString2 = o.a(localo, str);
          j localj = new j(str);
          int m = arrayOfString2.length;
          int j = 0;
          while (j < m)
          {
            localj.b(arrayOfString2[j]);
            j += 1;
          }
          localj.e();
          a().j().add(localj);
  ...
  public List<j> j()
  {
    // Byte code:
    //   0: aload_0
    //   1: getfield 25	com/estrongs/android/pop/app/c/m:a	Ljava/util/List;
    //   4: ifnull +8 -> 12
    //   7: aload_0
    //   8: getfield 25	com/estrongs/android/pop/app/c/m:a	Ljava/util/List;
    //   11: areturn
    //   12: aload_0
    //   13: new 81	java/util/ArrayList
    //   16: dup
    //   17: invokespecial 82	java/util/ArrayList:<init>	()V
    //   20: putfield 25	com/estrongs/android/pop/app/c/m:a	Ljava/util/List;
    //   23: invokestatic 100	com/estrongs/android/pop/app/c/l:a	()Lcom/estrongs/android/pop/app/c/l;
    //   26: invokevirtual 271	com/estrongs/android/pop/app/c/l:b	()Landroid/database/sqlite/SQLiteDatabase;
    //   29: astore_2
    //   30: aload_2
    //   31: ldc -110
    //   33: aconst_null
    ...
    //   96: astore_2
    //   97: aload_0
    //   98: getfield 25	com/estrongs/android/pop/app/c/m:a	Ljava/util/List;
    //   101: new 59	com/estrongs/android/pop/app/c/j
    //   104: dup
    //   105: iload_1
    //   106: i2l
    //   107: aload 4
    //   109: invokespecial 288	com/estrongs/android/pop/app/c/j:<init>	(JLjava/lang/String;)V
    ...
    //   123: aload_3
    //   124: astore_2
    //   125: invokestatic 290	com/estrongs/android/pop/app/c/l:e	()Ljava/lang/String;
    //   128: astore 5
    //   130: aload_3
    //   131: astore_2
    //   132: aload 5
    ...
    //   202: invokestatic 311	com/estrongs/fs/impl/local/i:a	(Ljava/lang/String;Ljava/lang/String;)Z
    //   205: pop
    //   206: aload_3
    //   207: astore_2
    //   208: invokestatic 100	com/estrongs/android/pop/app/c/l:a	()Lcom/estrongs/android/pop/app/c/l;
    //   211: pop
    //   212: aload_3
    //   213: astore_2
    //   214: invokestatic 313	com/estrongs/android/pop/app/c/l:d	()V
    //   217: aload_3
    //   218: astore_2
    //   219: invokestatic 100	com/estrongs/android/pop/app/c/l:a	()Lcom/estrongs/android/pop/app/c/l;
    //   222: pop
    //   223: aload_3
    //   224: astore_2
    //   225: aload 4
    ...
    //   240: aload_0
    //   241: getfield 25	com/estrongs/android/pop/app/c/m:a	Ljava/util/List;
    //   244: areturn
    //   245: aload_3
    //   246: ifnull -6 -> 240
    //   249: aload_3
...
/* Location:
 * Qualified Name:     com.estrongs.android.pop.app.c.m
