  ...
  extends ad
{
  ...
  void a(int paramInt, Object paramObject)
  {
    ...
    paramObject = y.e(a).getString(2131232315);
  ...
  long b(String paramString)
  {
    ...
    do
    {
      ...
      if (i > 0) {
        return bk.b(paramString.substring(0, i)) * 1024L;
      }
      i = paramString.indexOf("MB");
    } while (i <= 0);
    return bk.b(paramString.substring(0, i)) * 1048576L;
  }
}

/* Location:
 * Qualified Name:     com.estrongs.android.pop.app.f.ab
