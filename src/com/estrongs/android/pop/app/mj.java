...
class mj
  implements Runnable
{
  mj(StreamingMediaPlayer paramStreamingMediaPlayer, boolean paramBoolean) {}
  ...
  public void run()
  {
    ...
    for (;;)
    {
      ...
      StreamingMediaPlayer.q(b).setVideoPath(StreamingMediaPlayer.p(b).getAbsolutePath());
...
/* Location:
 * Qualified Name:     com.estrongs.android.pop.app.mj
