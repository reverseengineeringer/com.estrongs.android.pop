...
import com.estrongs.android.pop.app.bc;
  ...
  implements Observer
{
  ...
  private void a(f paramf)
  {
    // Byte code:
    //   0: aload_0
    //   1: getfield 83	com/estrongs/android/pop/app/b/c:r	Ljava/lang/Object;
    //   4: astore_2
    //   5: aload_2
    //   6: monitorenter
    //   7: aload_1
    ...
    //   13: return
    //   14: aload_0
    //   15: getfield 79	com/estrongs/android/pop/app/b/c:p	Ljava/util/LinkedHashMap;
    //   18: invokevirtual 109	java/util/LinkedHashMap:keySet	()Ljava/util/Set;
    //   21: invokeinterface 115 1 0
    //   26: astore_3
    //   27: aload_1
    //   28: getfield 120	com/estrongs/android/pop/app/b/f:g	I
    ...
    //   94: ifeq -26 -> 68
    //   97: aload_0
    //   98: getfield 79	com/estrongs/android/pop/app/b/c:p	Ljava/util/LinkedHashMap;
    //   101: aload 4
  ...
  public void a(String paramString, a parama, ArrayList<f> paramArrayList, boolean paramBoolean)
  {
    ...
    for (;;)
    {
      try
      {
        ...
        Log.e(c, "scanLan error: invalid bssid or scan type");
        e();
      }
      finally
      {
        try
        {
          Object localObject = InetAddress.getByName(ak.a());
      ...
      l = new al();
      l.setDescription(h.getString(2131427845));
      l.execute();
    }
  }
  ...
  public void g()
  {
    ...
    //   1: monitorenter
    //   2: aload_0
    //   3: getfield 83	com/estrongs/android/pop/app/b/c:r	Ljava/lang/Object;
    //   6: astore_1
    //   7: aload_1
    //   8: monitorenter
    //   9: aload_0
    //   10: getfield 74	com/estrongs/android/pop/app/b/c:o	Ljava/util/Map;
  ...
  public void update(Observable paramObservable, Object paramObject)
  {
    ...
    if ((paramObject != null) && ((paramObject instanceof o)))
    {
      ...
      if ((d != 0) || (c < 0))
      {
        Log.e(c, "get invalid scan status");
        return;
      }
      localObject1 = b;
      ...
      catch (Exception paramObject)
      {
        ...
        {
          label202:
          Log.w(c, "Failed to get host name by NbtAddress - " + paramObservable);
      ...
      localObject1 = "adb://" + a;
      if (!((String)localObject1).contains(ak.a())) {
        break label624;
      }
...
/* Location:
 * Qualified Name:     com.estrongs.android.pop.app.b.c
