  ...
  extends a
{
  ...
  private Bitmap a(InputStream paramInputStream, BitmapFactory.Options paramOptions, int paramInt)
  {
    ...
    for (;;)
    {
      ...
      if (paramOptions == null) {
        paramInputStream = BitmapFactory.decodeResource(a.getResources(), 2130837660);
      }
  ...
  protected Bitmap c(h paramh)
  {
    ...
    //   0: aload_0
    //   1: aload_1
    //   2: invokespecial 139	com/estrongs/android/d/g:i	(Lcom/estrongs/fs/h;)Ljava/io/InputStream;
    //   5: astore_3
    //   6: aload_3
    //   7: ifnonnull +23 -> 30
    //   10: aload_3
    ...
    //   16: ldc -115
    //   18: ldc -113
    //   20: invokestatic 148	android/util/Log:e	(Ljava/lang/String;Ljava/lang/String;)I
    //   23: pop
    //   24: aload_3
    //   25: invokestatic 152	com/estrongs/fs/util/j:a	(Ljava/io/InputStream;)V
    //   28: aconst_null
    //   29: areturn
    //   30: aload_3
    //   31: astore 4
    ...
    //   39: dup
    //   40: invokespecial 155	android/graphics/BitmapFactory$Options:<init>	()V
    //   43: astore 6
    //   45: aload_3
    //   46: astore 4
    //   48: aload_3
    ...
    //   61: astore 5
    //   63: aload_3
    //   64: invokevirtual 113	java/io/InputStream:markSupported	()Z
    //   67: ifeq +15 -> 82
    //   70: aload_3
    //   71: astore 4
    //   73: aload_3
    ...
    //   76: aload_3
    //   77: ldc -100
    //   79: invokevirtual 160	java/io/InputStream:mark	(I)V
    //   82: aload_3
    //   83: astore 4
    //   85: aload_3
    //   86: astore 5
    ...
    //   100: astore 5
    //   102: aload_3
    //   103: invokevirtual 113	java/io/InputStream:markSupported	()Z
    //   106: istore_2
    //   107: iload_2
    //   108: ifeq +64 -> 172
    //   111: aload_3
    ...
    //   115: astore 5
    //   117: aload_3
    //   118: invokevirtual 163	java/io/InputStream:reset	()V
    //   121: aload_3
    //   122: astore 4
    //   124: aload_3
    //   125: astore 5
    ...
    //   129: aload 6
    //   131: aload_1
    //   132: invokestatic 169	com/estrongs/android/d/f:h	(Lcom/estrongs/fs/h;)I
    //   135: invokespecial 171	com/estrongs/android/d/g:a	(Ljava/io/InputStream;Landroid/graphics/BitmapFactory$Options;I)Landroid/graphics/Bitmap;
    //   138: astore_1
    //   139: aload_3
    //   140: invokestatic 152	com/estrongs/fs/util/j:a	(Ljava/io/InputStream;)V
    //   143: aload_1
    //   144: areturn
    //   145: astore 4
    //   147: aload_3
    ...
    //   151: astore 5
    //   153: aload_3
    //   154: invokestatic 152	com/estrongs/fs/util/j:a	(Ljava/io/InputStream;)V
    //   157: aload_3
    //   158: astore 4
    //   160: aload_3
    //   161: astore 5
    //   163: aload_0
    //   164: aload_1
    //   165: invokespecial 139	com/estrongs/android/d/g:i	(Lcom/estrongs/fs/h;)Ljava/io/InputStream;
    //   168: astore_3
    //   169: goto -48 -> 121
    //   172: aload_3
    //   173: astore 4
    ...
    //   176: astore 5
    //   178: aload_3
    //   179: invokestatic 152	com/estrongs/fs/util/j:a	(Ljava/io/InputStream;)V
    //   182: aload_3
    //   183: astore 4
    //   185: aload_3
    //   186: astore 5
    //   188: aload_0
    //   189: aload_1
    //   190: invokespecial 139	com/estrongs/android/d/g:i	(Lcom/estrongs/fs/h;)Ljava/io/InputStream;
    //   193: astore_3
    //   194: goto -73 -> 121
    //   197: astore_1
    //   198: aconst_null
    ...
    //   219: aload_1
    //   220: invokevirtual 183	java/lang/Throwable:getMessage	()Ljava/lang/String;
    //   223: invokevirtual 180	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   226: invokevirtual 186	java/lang/StringBuilder:toString	()Ljava/lang/String;
    //   229: invokestatic 189	android/util/Log:w	(Ljava/lang/String;Ljava/lang/String;)I
    //   232: pop
    //   233: aload 5
    //   235: invokestatic 152	com/estrongs/fs/util/j:a	(Ljava/io/InputStream;)V
    //   238: aconst_null
    //   239: areturn
    //   240: astore_1
    //   241: aconst_null
    //   242: astore 4
    //   244: aload 4
    //   246: invokestatic 152	com/estrongs/fs/util/j:a	(Ljava/io/InputStream;)V
    //   249: aload_1
    //   250: athrow
    //   251: astore_1
    //   252: goto -8 -> 244
  ...
  {
    if (bc.e(paramh.getAbsolutePath())) {
...
/* Location:
 * Qualified Name:     com.estrongs.android.d.g
