  ...
  implements j
{
  ...
  private void a(Bitmap paramBitmap, String paramString, Bitmap.CompressFormat paramCompressFormat)
  {
    ...
    //   15: aload_3
    //   16: aload_0
    //   17: invokevirtual 68	com/estrongs/android/d/a:c	()I
    //   20: aload_2
  ...
  private Drawable i(com.estrongs.fs.h paramh)
  {
    for (boolean bool = true;; bool = false) {
      for (;;)
      {
        ...
        try
        {
          ...
          int i = cd.c(paramh.getAbsolutePath());
          if (i != 0)
          {
            paramh = new Matrix();
            paramh.setRotate(i);
        ...
        paramh = (com.estrongs.fs.h)localObject;
      }
    }
  }
  ...
  public Drawable a(com.estrongs.fs.h paramh)
  {
    boolean bool2 = false;
    if (!b(paramh)) {
      return null;
  ...
  public Drawable a(com.estrongs.fs.h paramh, String paramString)
  {
    paramh = f(paramh);
  ...
  protected boolean b(com.estrongs.fs.h paramh)
  {
    return true;
  }
  ...
  protected abstract Bitmap c(com.estrongs.fs.h paramh);
  
  protected File d(com.estrongs.fs.h paramh)
  {
    return new File(e(paramh));
  }
  
  protected String e(com.estrongs.fs.h paramh)
  {
    return b + "/" + f.f(paramh);
  }
  
  protected String f(com.estrongs.fs.h paramh)
  {
    return b + "/" + String.valueOf(am.bE(paramh.getAbsolutePath()).hashCode()) + paramh.lastModified();
  }
  
  protected Bitmap.CompressFormat g(com.estrongs.fs.h paramh)
  {
    return Bitmap.CompressFormat.JPEG;
  }
  
  public boolean h(com.estrongs.fs.h paramh)
  {
    if ((com.estrongs.fs.impl.local.h.a(a(paramh.getAbsolutePath()))) && (!f.i(paramh)))
    {
      if (com.estrongs.fs.impl.local.h.a(e(paramh))) {
        new File(e(paramh)).delete();
      }
      return true;
    }
    return com.estrongs.fs.impl.local.h.a(e(paramh));
  }
}
