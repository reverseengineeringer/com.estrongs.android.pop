...
public class ak
{
    ...
    for (;;)
    {
      ...
      try
      {
        if (ac.a() >= 19)
        {
          ...
          if (localObject != null)
          {
            al.a(localObject).a("setTdlsEnabled", new Class[] { InetAddress.class, Boolean.TYPE }, new Object[] { paramInetAddress, Boolean.valueOf(paramBoolean) });
            return;
          }
        }
      }
  ...
  public static boolean b()
  {
    ...
    return (localNetworkInfo != null) && ((localNetworkInfo.getType() == 1) || (localNetworkInfo.getType() == 9));
  }
  ...
  private static String e()
  {
    ...
    {
      Log.e("WifiPreference IpAddress", localException.toString());
    }
    return null;
  }
}
