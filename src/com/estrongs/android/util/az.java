...
{
  az(ax paramax, String paramString, File paramFile, Context paramContext) {}
  ...
  public void onClick(android.content.DialogInterface paramDialogInterface, int paramInt)
  {
    ...
    //   28: aload_0
    //   29: getfield 20	com/estrongs/android/util/az:a	Ljava/lang/String;
    ...
    //   50: istore_2
    //   51: aload_0
    //   52: getfield 22	com/estrongs/android/util/az:b	Ljava/io/File;
    //   55: aload 7
    ...
    //   93: dup
    //   94: aconst_null
    //   95: invokespecial 87	com/estrongs/io/a/a/b:<init>	(Lcom/estrongs/io/archive/e;)V
    //   98: astore 8
    //   100: iload 6
    //   102: istore_2
    //   103: aload 8
    ...
    //   109: iload 6
    //   111: istore_2
    //   112: new 92	com/estrongs/io/archive/j
    //   115: dup
    //   116: aload_0
    //   117: getfield 20	com/estrongs/android/util/az:a	Ljava/lang/String;
    //   120: aload 8
    //   122: aload_1
    //   123: invokespecial 95	com/estrongs/io/archive/j:<init>	(Ljava/lang/String;Lcom/estrongs/io/a/d;Ljava/util/Map;)V
    //   126: astore_1
    //   127: iload 6
    //   129: istore_2
    ...
    //   141: istore_2
    //   142: aload 8
    //   144: invokestatic 102	com/estrongs/android/util/ax:a	()Ljava/lang/String;
    ...
    //   154: aload_1
    //   155: aload 8
    //   157: invokevirtual 109	com/estrongs/io/archive/j:a	(Ljava/util/List;)V
    //   160: iload 6
    //   162: istore_2
    //   163: aload_0
    //   164: getfield 18	com/estrongs/android/util/az:d	Lcom/estrongs/android/util/ax;
    //   167: invokestatic 112	com/estrongs/android/util/ax:a	(Lcom/estrongs/android/util/ax;)V
    //   170: iload 6
    //   172: istore_2
    //   173: new 45	java/io/File
    //   176: dup
    //   177: invokestatic 102	com/estrongs/android/util/ax:a	()Ljava/lang/String;
    //   180: invokespecial 61	java/io/File:<init>	(Ljava/lang/String;)V
    //   183: invokevirtual 116	java/io/File:delete	()Z
    //   186: pop
    //   187: aload_0
    //   188: getfield 20	com/estrongs/android/util/az:a	Ljava/lang/String;
    //   191: astore_1
    //   192: aload_1
    //   193: invokestatic 121	com/estrongs/android/util/bk:b	(Ljava/lang/CharSequence;)Z
    //   196: ifeq +39 -> 235
    //   199: aload_1
    //   200: ldc 123
    ...
    //   235: aload_0
    //   236: getfield 24	com/estrongs/android/util/az:c	Landroid/content/Context;
    //   239: invokestatic 141	com/estrongs/android/pop/ad:a	(Landroid/content/Context;)Lcom/estrongs/android/pop/ad;
    //   242: aload_0
    //   243: getfield 20	com/estrongs/android/util/az:a	Ljava/lang/String;
    //   246: invokevirtual 144	com/estrongs/android/pop/ad:J	(Ljava/lang/String;)V
    //   249: aload_0
    //   250: getfield 24	com/estrongs/android/util/az:c	Landroid/content/Context;
    //   253: ldc -111
    //   255: iconst_1
    //   256: invokestatic 150	com/estrongs/android/ui/view/ak:a	(Landroid/content/Context;II)V
    //   259: aload 7
    ...
    //   300: aload 7
    //   302: aload_0
    //   303: getfield 22	com/estrongs/android/util/az:b	Ljava/io/File;
    //   306: invokevirtual 65	java/io/File:renameTo	(Ljava/io/File;)Z
    //   309: pop
    //   310: aload_0
    //   311: getfield 24	com/estrongs/android/util/az:c	Landroid/content/Context;
    //   314: ldc -100
    //   316: iconst_1
    //   317: invokestatic 150	com/estrongs/android/ui/view/ak:a	(Landroid/content/Context;II)V
    //   320: return
    //   321: astore_1
    //   322: iload 4
    //   324: istore_3
    ...
    //   335: aload 7
    //   337: aload_0
    //   338: getfield 22	com/estrongs/android/util/az:b	Ljava/io/File;
    //   341: invokevirtual 65	java/io/File:renameTo	(Ljava/io/File;)Z
    //   344: pop
    //   345: aload_0
    //   346: getfield 24	com/estrongs/android/util/az:c	Landroid/content/Context;
    //   349: ldc -100
    //   351: iconst_1
    //   352: invokestatic 150	com/estrongs/android/ui/view/ak:a	(Landroid/content/Context;II)V
    //   355: return
    //   356: astore_1
    //   357: iload 5
    //   359: istore_2
    ...
    //   364: aload 7
    //   366: aload_0
    //   367: getfield 22	com/estrongs/android/util/az:b	Ljava/io/File;
    //   370: invokevirtual 65	java/io/File:renameTo	(Ljava/io/File;)Z
    //   373: pop
    //   374: aload_0
    //   375: getfield 24	com/estrongs/android/util/az:c	Landroid/content/Context;
    //   378: ldc -100
    //   380: iconst_1
    //   381: invokestatic 150	com/estrongs/android/ui/view/ak:a	(Landroid/content/Context;II)V
    //   384: return
    //   385: astore_1
    //   386: iload_2
    //   387: ifne +23 -> 410
    //   390: aload 7
    //   392: aload_0
    //   393: getfield 22	com/estrongs/android/util/az:b	Ljava/io/File;
    //   396: invokevirtual 65	java/io/File:renameTo	(Ljava/io/File;)Z
    //   399: pop
    //   400: aload_0
    //   401: getfield 24	com/estrongs/android/util/az:c	Landroid/content/Context;
    //   404: ldc -100
    //   406: iconst_1
    //   407: invokestatic 150	com/estrongs/android/ui/view/ak:a	(Landroid/content/Context;II)V
    //   410: aload_1
    //   411: athrow
    //   412: astore_1
    //   413: iconst_1
...
/* Location:
 * Qualified Name:     com.estrongs.android.util.az
