...
public final class bk
{
  ...
  {
    // Byte code:
    //   0: new 151	com/estrongs/android/util/i
    //   3: dup
    //   4: ldc -103
    //   6: invokespecial 156	com/estrongs/android/util/i:<init>	(Ljava/lang/String;)V
    //   9: aload_0
    //   10: invokevirtual 160	java/lang/String:getBytes	()[B
    //   13: invokevirtual 163	com/estrongs/android/util/i:b	([B)[B
    ...
    //   23: ifeq +8 -> 31
    //   26: aload_0
    //   27: invokestatic 174	com/estrongs/android/util/ap:bz	(Ljava/lang/String;)Ljava/lang/String;
    //   30: astore_2
    //   31: aload_2
    //   32: areturn
    //   33: astore_2
  ...
  public static String b(String paramString, boolean paramBoolean)
  {
    try
    {
      i locali = new i("MTc0OTUwOTEzMTU4ODM4NDYxOTk");
      String str = paramString;
      if (paramBoolean) {
        str = ap.bA(paramString);
      }
      paramString = new String(locali.c(HttpUtils.base64Decode(str)));
      return paramString;
    }
    catch (Exception paramString)
    {
  ...
  {
    return (o()) || (cu.d(FexApplication.a()));
  }
  
  public static boolean q()
  {
    Activity localActivity = ESActivity.H();
    if (localActivity == null) {}
    while ((!(localActivity instanceof PopAudioPlayer)) && (!(localActivity instanceof PopVideoPlayer))) {
      return false;
    }
    return true;
  }
...
/* Location:
 * Qualified Name:     com.estrongs.android.util.bk
