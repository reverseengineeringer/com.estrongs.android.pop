...
public class bc
{
  ...
  static
  {
    ...
    a(65554, new String[] { ".bmp", ".wbmp" }, "image/bmp", 1);
    ...
    a(262192, new String[] { ".doc", ".docx" }, "application/msword", 100);
    a(262193, new String[] { ".xls", ".xlsx", ".xla", ".xlc", ".xlm", ".xlt", ".xlsm", ".xlsb" }, "application/vnd.ms-excel", 100);
    ...
    a(262199, new String[] { ".ppt", ".pps", ".ppx", ".pptx", ".odp" }, "application/vnd.ms-powerpoint", 100);
    ...
    a(327736, new String[] { ".zip", ".tar", ".gz", ".cab", ".esi", ".7z" }, "application/zip", 5);
  ...
  public static final int a(h paramh)
  {
    ...
    if (n == -2)
    {
      if ((!am.aG(paramh.getPath())) || (!paramh.getFileType().b())) {
        break label51;
      }
      m = 65553;
    }
