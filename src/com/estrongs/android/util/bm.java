...
public class bm
{
  ...
  private static LinkedList<bn> e = new LinkedList();
  ...
  private void a(LinkedList<bn> paramLinkedList, bn parambn, boolean paramBoolean)
  {
    ...
    if (paramBoolean)
    {
      paramLinkedList.addFirst(parambn);
      return;
    }
    paramLinkedList.addLast(parambn);
  }
  ...
  public static bm c()
  {
    ...
    //   2: ldc 2
    //   4: monitorenter
    //   5: getstatic 26	com/estrongs/android/util/bm:b	Lcom/estrongs/android/util/bm;
    //   8: ifnonnull +225 -> 233
    //   11: getstatic 24	com/estrongs/android/util/bm:a	Ljava/lang/String;
    //   14: ifnull +9 -> 23
    //   17: getstatic 112	com/estrongs/android/pop/z:ao	Z
    //   20: ifeq +16 -> 36
    //   23: new 2	com/estrongs/android/util/bm
    //   26: dup
    //   27: invokespecial 113	com/estrongs/android/util/bm:<init>	()V
    //   30: astore_0
    //   31: ldc 2
    //   33: monitorexit
    //   34: aload_0
    //   35: areturn
    //   36: getstatic 24	com/estrongs/android/util/bm:a	Ljava/lang/String;
    //   39: invokestatic 115	com/estrongs/android/util/bm:b	(Ljava/lang/String;)Ljava/lang/String;
    //   42: pop
    //   43: new 2	com/estrongs/android/util/bm
    //   46: dup
    //   47: invokespecial 113	com/estrongs/android/util/bm:<init>	()V
    //   50: putstatic 26	com/estrongs/android/util/bm:b	Lcom/estrongs/android/util/bm;
    //   53: getstatic 26	com/estrongs/android/util/bm:b	Lcom/estrongs/android/util/bm;
    //   56: new 49	java/lang/StringBuilder
    //   59: dup
    //   60: invokespecial 50	java/lang/StringBuilder:<init>	()V
    //   63: getstatic 24	com/estrongs/android/util/bm:a	Ljava/lang/String;
    ...
    //   81: putfield 44	com/estrongs/android/util/bm:c	Landroid/database/sqlite/SQLiteDatabase;
    //   84: getstatic 26	com/estrongs/android/util/bm:b	Lcom/estrongs/android/util/bm;
    //   87: getfield 44	com/estrongs/android/util/bm:c	Landroid/database/sqlite/SQLiteDatabase;
    ...
    //   104: getstatic 24	com/estrongs/android/util/bm:a	Ljava/lang/String;
    ...
    //   124: pop
    //   125: getstatic 26	com/estrongs/android/util/bm:b	Lcom/estrongs/android/util/bm;
    //   128: new 49	java/lang/StringBuilder
    //   131: dup
    //   132: invokespecial 50	java/lang/StringBuilder:<init>	()V
    //   135: getstatic 24	com/estrongs/android/util/bm:a	Ljava/lang/String;
    ...
    //   153: putfield 44	com/estrongs/android/util/bm:c	Landroid/database/sqlite/SQLiteDatabase;
    //   156: getstatic 26	com/estrongs/android/util/bm:b	Lcom/estrongs/android/util/bm;
    //   159: getfield 44	com/estrongs/android/util/bm:c	Landroid/database/sqlite/SQLiteDatabase;
    //   162: ifnonnull +68 -> 230
    //   165: aconst_null
    //   166: putstatic 26	com/estrongs/android/util/bm:b	Lcom/estrongs/android/util/bm;
    //   169: goto -138 -> 31
    //   172: astore_0
    //   173: aconst_null
    //   174: putstatic 26	com/estrongs/android/util/bm:b	Lcom/estrongs/android/util/bm;
    //   177: new 73	java/io/File
    //   180: dup
    //   181: new 49	java/lang/StringBuilder
    //   184: dup
    //   185: invokespecial 50	java/lang/StringBuilder:<init>	()V
    //   188: getstatic 24	com/estrongs/android/util/bm:a	Ljava/lang/String;
    ...
    //   213: new 2	com/estrongs/android/util/bm
    //   216: dup
    //   217: invokespecial 113	com/estrongs/android/util/bm:<init>	()V
    //   220: astore_0
    //   221: goto -190 -> 31
    //   224: astore_0
    //   225: ldc 2
    ...
    //   228: aload_0
    //   229: athrow
    //   230: invokestatic 128	com/estrongs/android/util/bm:j	()V
    //   233: getstatic 26	com/estrongs/android/util/bm:b	Lcom/estrongs/android/util/bm;
    //   236: astore_0
    //   237: goto -206 -> 31
    //   240: astore_0
    //   241: aconst_null
    //   242: putstatic 26	com/estrongs/android/util/bm:b	Lcom/estrongs/android/util/bm;
    //   245: new 73	java/io/File
    //   248: dup
    //   249: new 49	java/lang/StringBuilder
    //   252: dup
    //   253: invokespecial 50	java/lang/StringBuilder:<init>	()V
    //   256: getstatic 24	com/estrongs/android/util/bm:a	Ljava/lang/String;
    ...
    //   276: pop
    //   277: new 2	com/estrongs/android/util/bm
    //   280: dup
    //   281: invokespecial 113	com/estrongs/android/util/bm:<init>	()V
    //   284: astore_0
    //   285: goto -254 -> 31
    //   288: astore_0
    //   289: aconst_null
    //   290: putstatic 26	com/estrongs/android/util/bm:b	Lcom/estrongs/android/util/bm;
    //   293: aload_0
    //   294: invokevirtual 102	java/lang/Exception:printStackTrace	()V
    //   297: new 2	com/estrongs/android/util/bm
    //   300: dup
    //   301: invokespecial 113	com/estrongs/android/util/bm:<init>	()V
    //   304: astore_0
    //   305: goto -274 -> 31
  ...
  {
    // Byte code:
    //   0: getstatic 26	com/estrongs/android/util/bm:b	Lcom/estrongs/android/util/bm;
    //   3: getfield 44	com/estrongs/android/util/bm:c	Landroid/database/sqlite/SQLiteDatabase;
    //   6: ldc -110
    //   8: iconst_1
    ...
    //   41: aload_3
    //   42: astore_2
    //   43: getstatic 26	com/estrongs/android/util/bm:b	Lcom/estrongs/android/util/bm;
    //   46: getfield 44	com/estrongs/android/util/bm:c	Landroid/database/sqlite/SQLiteDatabase;
    //   49: ldc -95
  ...
  private static void l()
  {
    ...
    //   0: getstatic 26	com/estrongs/android/util/bm:b	Lcom/estrongs/android/util/bm;
    //   3: ifnull +12 -> 15
    //   6: getstatic 26	com/estrongs/android/util/bm:b	Lcom/estrongs/android/util/bm;
    //   9: getfield 44	com/estrongs/android/util/bm:c	Landroid/database/sqlite/SQLiteDatabase;
    //   12: ifnonnull +4 -> 16
    //   15: return
    //   16: getstatic 26	com/estrongs/android/util/bm:b	Lcom/estrongs/android/util/bm;
    //   19: getfield 44	com/estrongs/android/util/bm:c	Landroid/database/sqlite/SQLiteDatabase;
    //   22: ldc 117
    //   24: iconst_2
    ...
    //   100: astore_2
    //   101: aload 4
    //   103: invokestatic 184	com/estrongs/android/util/ap:bX	(Ljava/lang/String;)Ljava/lang/String;
    //   106: astore 5
    //   108: aload_3
    //   109: astore_2
    //   110: aload 5
    ...
    //   134: aload 5
    //   136: invokestatic 192	com/estrongs/android/util/bm:c	(Ljava/lang/String;)Ljava/lang/String;
    ...
    //   182: invokestatic 192	com/estrongs/android/util/bm:c	(Ljava/lang/String;)Ljava/lang/String;
    ...
    //   193: aload_3
    //   194: astore_2
    //   195: getstatic 26	com/estrongs/android/util/bm:b	Lcom/estrongs/android/util/bm;
    //   198: getfield 44	com/estrongs/android/util/bm:c	Landroid/database/sqlite/SQLiteDatabase;
    //   201: aload 4
  ...
  private void m()
  {
    ...
    //   9: getfield 44	com/estrongs/android/util/bm:c	Landroid/database/sqlite/SQLiteDatabase;
    //   12: ifnull +9 -> 21
    //   15: getstatic 28	com/estrongs/android/util/bm:d	I
    //   18: ifne +4 -> 22
    //   21: return
    //   22: getstatic 26	com/estrongs/android/util/bm:b	Lcom/estrongs/android/util/bm;
    //   25: getfield 44	com/estrongs/android/util/bm:c	Landroid/database/sqlite/SQLiteDatabase;
    //   28: ldc -49
    //   30: iconst_2
    ...
    //   119: aload 4
    //   121: astore_3
    //   122: getstatic 40	com/estrongs/android/util/bm:f	Ljava/util/HashMap;
    ...
    //   169: aload 4
    //   171: astore_3
    //   172: getstatic 40	com/estrongs/android/util/bm:f	Ljava/util/HashMap;
    //   175: aload 4
    //   177: iconst_0
  ...
  public void a(String arg1, String paramString2, int paramInt, Bitmap paramBitmap, boolean paramBoolean)
  {
    ...
    for (;;)
    {
      label4:
      return;
      if ((!com.estrongs.android.pop.ad.a(FexApplication.a()).h()) || (paramInt == 1))
      {
        int i = ap.I(paramString2);
        if ((d == 0) || (ap.bh(paramString2)) || (ap.br(paramString2)) || (i == 3) || (i == 13) || (i == 17) || (i == 24) || (i == 12) || (i == 14) || (i == 16) || (ap.w(paramString2))) {
          break;
        }
      }
      try
      {
        localObject1 = FileExplorerActivity.X();
        if (localObject1 != null)
        {
          localObject1 = ((FileExplorerActivity)localObject1).O();
          if (localObject1 != null)
          {
            bool = com.estrongs.android.pop.utils.ad.b(paramString2, localObject1.hashCode());
            if (bool) {
              continue;
            }
          }
    ...
    synchronized (e)
    {
      ...
      {
        localbn = (bn)((Iterator)localObject2).next();
    ...
    for (boolean bool = true;; bool = false)
    {
      f = bool;
      if (e.size() < d) {
        a(e, (bn)localObject2, paramBoolean);
      }
      for (;;)
      {
        return;
  ...
  {
    if ((com.estrongs.android.pop.ad.a(FexApplication.a()).h()) && (!paramBoolean)) {
      return;
    }
  ...
  public bn[] e()
  {
    bn[] arrayOfbn = new bn[e.size()];
    return (bn[])e.toArray(arrayOfbn);
  }
  ...
  public void h()
  {
    ...
    for (;;)
    {
      ...
      try
      {
        ...
        {
          localObject = (bn)localIterator1.next();
  ...
  public void i()
  {
    ...
    //   0: aconst_null
    //   1: astore 5
    //   3: getstatic 26	com/estrongs/android/util/bm:b	Lcom/estrongs/android/util/bm;
    //   6: ifnull +18 -> 24
    //   9: getstatic 26	com/estrongs/android/util/bm:b	Lcom/estrongs/android/util/bm;
    //   12: getfield 44	com/estrongs/android/util/bm:c	Landroid/database/sqlite/SQLiteDatabase;
    //   15: ifnull +9 -> 24
    //   18: getstatic 28	com/estrongs/android/util/bm:d	I
    //   21: ifne +4 -> 25
    //   24: return
    //   25: aload_0
    //   26: invokespecial 428	com/estrongs/android/util/bm:m	()V
    ...
    //   35: invokevirtual 296	com/estrongs/android/pop/ad:h	()Z
    //   38: ifeq +248 -> 286
    //   41: ldc_w 430
    //   44: astore_3
    //   45: iconst_1
    ...
    //   54: ldc_w 432
    //   57: aastore
    //   58: getstatic 26	com/estrongs/android/util/bm:b	Lcom/estrongs/android/util/bm;
    //   61: getfield 44	com/estrongs/android/util/bm:c	Landroid/database/sqlite/SQLiteDatabase;
    //   64: ldc 117
    //   66: iconst_3
    ...
    //   129: istore_1
    //   130: iload_1
    //   131: getstatic 28	com/estrongs/android/util/bm:d	I
    //   134: if_icmple +65 -> 199
    //   137: aload_3
    //   138: iload_1
    //   139: getstatic 28	com/estrongs/android/util/bm:d	I
    //   142: isub
    //   143: invokeinterface 215 2 0
    //   148: istore_2
    //   149: getstatic 35	com/estrongs/android/util/bm:e	Ljava/util/LinkedList;
    ...
    //   174: invokestatic 435	com/estrongs/android/util/ap:bY	(Ljava/lang/String;)Ljava/lang/String;
    //   177: aload_3
    //   178: iconst_1
    //   179: invokeinterface 171 2 0
    //   184: aconst_null
    //   185: iconst_0
    //   186: invokevirtual 347	com/estrongs/android/util/bm:a	(Ljava/lang/String;Ljava/lang/String;ILandroid/graphics/Bitmap;Z)V
    //   189: aload_3
...
/* Location:
 * Qualified Name:     com.estrongs.android.util.bm
