...
public class c
{
  ...
  /* Error */
  public static java.util.List<c> a(String paramString)
  {
    // Byte code:
    //   0: iconst_0
    //   1: istore_1
    //   2: new 102	java/io/File
    //   5: dup
    //   6: aload_0
    //   7: invokespecial 105	java/io/File:<init>	(Ljava/lang/String;)V
    //   10: astore_0
    //   11: aload_0
    //   12: invokevirtual 109	java/io/File:exists	()Z
    //   15: ifne +5 -> 20
    //   18: aconst_null
    //   19: areturn
    //   20: aload_0
    //   21: invokevirtual 113	java/io/File:length	()J
    //   24: invokestatic 119	java/lang/Long:valueOf	(J)Ljava/lang/Long;
    //   27: invokevirtual 123	java/lang/Long:intValue	()I
    //   30: istore_2
    //   31: iload_2
    //   32: newarray <illegal type>
    //   34: astore_3
    //   35: new 125	java/io/RandomAccessFile
    //   38: dup
    //   39: aload_0
    //   40: ldc 127
    //   42: invokespecial 130	java/io/RandomAccessFile:<init>	(Ljava/io/File;Ljava/lang/String;)V
    //   45: astore_0
    //   46: aload_0
    //   47: aload_3
    //   48: iconst_0
    //   49: iload_2
    //   50: invokevirtual 134	java/io/RandomAccessFile:read	([BII)I
    //   53: pop
    //   54: aload_0
    //   55: invokevirtual 137	java/io/RandomAccessFile:close	()V
    //   58: new 139	java/io/ByteArrayOutputStream
    //   61: dup
    //   62: invokespecial 140	java/io/ByteArrayOutputStream:<init>	()V
    //   65: astore_0
    //   66: new 142	java/io/ByteArrayInputStream
    //   69: dup
    //   70: aload_3
    //   71: invokespecial 145	java/io/ByteArrayInputStream:<init>	([B)V
    //   74: astore_3
    //   75: sipush 1024
    ...
    //   85: iconst_0
    //   86: sipush 1024
    //   89: invokevirtual 146	java/io/ByteArrayInputStream:read	([BII)I
    //   92: istore_2
    //   93: iload_2
    //   94: ifle +23 -> 117
    //   97: aload_0
    ...
    //   100: iconst_0
    //   101: iload_2
    //   102: invokevirtual 150	java/io/ByteArrayOutputStream:write	([BII)V
    //   105: goto -23 -> 82
    //   108: astore_3
    //   109: aconst_null
    //   110: astore_0
    //   111: aload_3
    //   112: invokevirtual 153	java/io/FileNotFoundException:printStackTrace	()V
    //   115: aload_0
    //   116: areturn
    //   117: new 65	java/lang/String
    //   120: dup
    //   121: aload_0
    //   122: invokevirtual 157	java/io/ByteArrayOutputStream:toByteArray	()[B
    //   125: invokespecial 158	java/lang/String:<init>	([B)V
    //   128: astore_3
    //   129: aload_0
    //   130: invokevirtual 159	java/io/ByteArrayOutputStream:close	()V
    //   133: new 161	org/json/simple/parser/JSONParser
    //   136: dup
    //   137: invokespecial 162	org/json/simple/parser/JSONParser:<init>	()V
    //   140: aload_3
    //   141: invokevirtual 166	org/json/simple/parser/JSONParser:parse	(Ljava/lang/String;)Ljava/lang/Object;
    //   144: checkcast 168	org/json/simple/JSONArray
    //   147: astore_3
    //   148: aload_3
    //   149: instanceof 168
    //   152: ifeq +88 -> 240
    //   155: new 170	java/util/ArrayList
    //   158: dup
    //   159: invokespecial 171	java/util/ArrayList:<init>	()V
    //   162: astore_0
    //   163: iload_1
    //   164: aload_3
    //   165: invokevirtual 174	org/json/simple/JSONArray:size	()I
    //   168: if_icmpge +69 -> 237
    //   171: aload_3
    //   172: iload_1
    //   173: invokevirtual 177	org/json/simple/JSONArray:get	(I)Ljava/lang/Object;
    //   176: checkcast 45	org/json/simple/JSONObject
    //   179: invokestatic 179	com/estrongs/android/ui/g/c:a	(Lorg/json/simple/JSONObject;)Lcom/estrongs/android/ui/g/c;
    //   182: astore 4
    //   184: aload 4
    //   186: ifnull +12 -> 198
    //   189: aload_0
    ...
    //   207: astore_0
    //   208: aload_3
    //   209: invokevirtual 186	java/io/IOException:printStackTrace	()V
    //   212: goto -97 -> 115
    //   215: astore_3
    //   216: aconst_null
    //   217: astore_0
    //   218: aload_3
    //   219: invokevirtual 187	org/json/simple/parser/ParseException:printStackTrace	()V
    //   222: goto -107 -> 115
    //   225: astore_3
    //   226: goto -8 -> 218
    //   229: astore_3
