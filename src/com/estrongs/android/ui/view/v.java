  ...
  extends WebViewClient
{
  ...
  public void onPageStarted(WebView paramWebView, String paramString, Bitmap paramBitmap)
  {
    ...
    for (;;)
    {
      ...
      else
      {
        ...
        break;
        label141:
        if ((CreateOAuthNetDisk.a(a).equals("onedrive")) || (CreateOAuthNetDisk.a(a).equals("kuaipan")) || (CreateOAuthNetDisk.a(a).equals("vdisk")))
        {
      ...
      paramWebView = CreateOAuthNetDisk.b(a).obtainMessage(CreateOAuthNetDisk.e);
      CreateOAuthNetDisk.b(a).sendMessage(paramWebView);
      return;
      label412:
      i = 0;
  ...
  {
    if ((bk.f()) && (paramString != null) && (paramString.contains("openapi.qzone.qq.com")))
    {
