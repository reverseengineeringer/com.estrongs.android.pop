  ...
  implements DialogInterface.OnClickListener
{
  ...
  public void onClick(DialogInterface paramDialogInterface, int paramInt)
  {
    ...
    for (a |= 0x800;; a &= 0xF7FF)
    {
      m.h.c = -1;
      if (!m.a(hq.g(m), m.h)) {
        ak.a(m.aF(), 2131231901, 0);
      }
      m.h = m.f(hq.g(m));
      m.a.setText(m.a(m.h.c));
      m.b.setText(m.b(m.h.b));
      m.g = hq.a(m, m.h);
      hq.h(m).setText(m.g.substring(0, 3) + " " + m.g.substring(3, 6) + " " + m.g.substring(6, 9));
      return;
      paramDialogInterface = m.h;
      a &= 0xFFFFFFFE;
      break;
...
/* Location:
 * Qualified Name:     com.estrongs.android.ui.dialog.ht
