  ...
  extends a
{
  ...
  protected String a()
  {
    String str2 = ap.a(b(), ".albumart", true);
    String str1 = str2;
    if (str2 == null) {
      str1 = ap.a(a.getCacheDir(), ".albumart", false);
    }
    return str1;
  }
  ...
  protected Bitmap c(h paramh)
  {
    ...
    for (paramh = ap.bV((String)localObject);; paramh = (h)localObject)
    {
      ...
      for (;;)
      {
        ...
        if (paramh != null)
        {
          if (b == null)
          {
            ...
            inScaled = false;
            b = BitmapFactory.decodeResource(a.getResources(), 2130838025, (BitmapFactory.Options)localObject);
...
/* Location:
 * Qualified Name:     com.estrongs.android.h.c
