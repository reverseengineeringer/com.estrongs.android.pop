  ...
  extends a
{
  ...
  protected Bitmap c(h paramh)
  {
    ...
    //   0: aload_0
    //   1: aload_1
    //   2: invokespecial 122	com/estrongs/android/h/b:i	(Lcom/estrongs/fs/h;)Ljava/io/InputStream;
    //   5: astore_3
    //   6: aload_3
    //   7: ifnonnull +22 -> 29
    //   10: aload_3
    ...
    //   16: ldc 124
    //   18: ldc 126
    //   20: invokestatic 132	com/estrongs/android/util/l:e	(Ljava/lang/String;Ljava/lang/String;)V
    //   23: aload_3
    //   24: invokestatic 136	com/estrongs/fs/util/j:a	(Ljava/io/InputStream;)V
    //   27: aconst_null
    //   28: areturn
    //   29: aload_3
    //   30: astore 4
    ...
    //   38: dup
    //   39: invokespecial 139	android/graphics/BitmapFactory$Options:<init>	()V
    //   42: astore 6
    //   44: aload_3
    //   45: astore 4
    //   47: aload_3
    ...
    //   60: astore 5
    //   62: aload_3
    //   63: invokevirtual 90	java/io/InputStream:markSupported	()Z
    //   66: ifeq +15 -> 81
    //   69: aload_3
    //   70: astore 4
    //   72: aload_3
    ...
    //   75: aload_3
    //   76: ldc -116
    //   78: invokevirtual 144	java/io/InputStream:mark	(I)V
    //   81: aload_3
    //   82: astore 4
    //   84: aload_3
    //   85: astore 5
    ...
    //   99: astore 5
    //   101: aload_3
    //   102: invokevirtual 90	java/io/InputStream:markSupported	()Z
    //   105: istore_2
    //   106: iload_2
    //   107: ifeq +64 -> 171
    //   110: aload_3
    ...
    //   114: astore 5
    //   116: aload_3
    //   117: invokevirtual 147	java/io/InputStream:reset	()V
    //   120: aload_3
    //   121: astore 4
    //   123: aload_3
    //   124: astore 5
    ...
    //   128: aload 6
    //   130: aload_1
    //   131: invokestatic 153	com/estrongs/android/h/f:h	(Lcom/estrongs/fs/h;)I
    //   134: invokespecial 155	com/estrongs/android/h/b:a	(Ljava/io/InputStream;Landroid/graphics/BitmapFactory$Options;I)Landroid/graphics/Bitmap;
    //   137: astore_1
    //   138: aload_3
    //   139: invokestatic 136	com/estrongs/fs/util/j:a	(Ljava/io/InputStream;)V
    //   142: aload_1
    //   143: areturn
    //   144: astore 4
    //   146: aload_3
    ...
    //   150: astore 5
    //   152: aload_3
    //   153: invokestatic 136	com/estrongs/fs/util/j:a	(Ljava/io/InputStream;)V
    //   156: aload_3
    //   157: astore 4
    //   159: aload_3
    //   160: astore 5
    //   162: aload_0
    //   163: aload_1
    //   164: invokespecial 122	com/estrongs/android/h/b:i	(Lcom/estrongs/fs/h;)Ljava/io/InputStream;
    //   167: astore_3
    //   168: goto -48 -> 120
    //   171: aload_3
    //   172: astore 4
    ...
    //   175: astore 5
    //   177: aload_3
    //   178: invokestatic 136	com/estrongs/fs/util/j:a	(Ljava/io/InputStream;)V
    //   181: aload_3
    //   182: astore 4
    //   184: aload_3
    //   185: astore 5
    //   187: aload_0
    //   188: aload_1
    //   189: invokespecial 122	com/estrongs/android/h/b:i	(Lcom/estrongs/fs/h;)Ljava/io/InputStream;
    //   192: astore_3
    //   193: goto -73 -> 120
    //   196: astore_1
    //   197: aconst_null
    ...
    //   202: astore 4
    //   204: ldc 124
    //   206: new 157	java/lang/StringBuilder
    //   209: dup
    ...
    //   218: aload_1
    //   219: invokevirtual 167	java/lang/Throwable:getMessage	()Ljava/lang/String;
    //   222: invokevirtual 164	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   225: invokevirtual 170	java/lang/StringBuilder:toString	()Ljava/lang/String;
    //   228: invokestatic 173	com/estrongs/android/util/l:d	(Ljava/lang/String;Ljava/lang/String;)V
    //   231: aload 5
    //   233: invokestatic 136	com/estrongs/fs/util/j:a	(Ljava/io/InputStream;)V
    //   236: aconst_null
    //   237: areturn
    //   238: astore_1
    //   239: aconst_null
    //   240: astore 4
    //   242: aload 4
    //   244: invokestatic 136	com/estrongs/fs/util/j:a	(Ljava/io/InputStream;)V
    //   247: aload_1
    //   248: athrow
    //   249: astore_1
    //   250: goto -8 -> 242
...
/* Location:
 * Qualified Name:     com.estrongs.android.h.b
