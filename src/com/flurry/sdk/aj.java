  ...
  implements Closeable
{
  ...
  public aj(InputStream paramInputStream, int paramInt, Charset paramCharset)
  {
  ...
  public aj(InputStream paramInputStream, Charset paramCharset)
  {
  ...
  public String a()
  {
    ...
    for (;;)
    {
      ...
      for (int j = i - 1;; j = i)
      {
        ...
        localObject2 = new aj.1(this, e - d + 80);
        for (;;)
        {
