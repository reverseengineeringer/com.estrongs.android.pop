...
.field private h:Landroid/support/design/widget/cs;
...
.method constructor <init>(Landroid/support/design/widget/TabLayout;Landroid/content/Context;)V
    ...
    iput-object p1, p0, Landroid/support/design/widget/ce;->a:Landroid/support/design/widget/TabLayout;

    invoke-direct {p0, p2}, Landroid/widget/LinearLayout;-><init>(Landroid/content/Context;)V

    iput v0, p0, Landroid/support/design/widget/ce;->d:I
    ...
    iput-object v0, p0, Landroid/support/design/widget/ce;->c:Landroid/graphics/Paint;

    return-void
.end method

.method static synthetic a(Landroid/support/design/widget/ce;F)F
    .locals 0

    iput p1, p0, Landroid/support/design/widget/ce;->e:F

    return p1
.end method

.method static synthetic a(Landroid/support/design/widget/ce;I)I
    .locals 0

    iput p1, p0, Landroid/support/design/widget/ce;->d:I

    return p1
.end method

.method static synthetic a(Landroid/support/design/widget/ce;II)V
    .locals 0

    invoke-direct {p0, p1, p2}, Landroid/support/design/widget/ce;->b(II)V
...
.method private c()V
    ...
    iget v0, p0, Landroid/support/design/widget/ce;->d:I
    ...
    iget v2, p0, Landroid/support/design/widget/ce;->e:F
    ...
    iget v2, p0, Landroid/support/design/widget/ce;->d:I
    ...
    iget v3, p0, Landroid/support/design/widget/ce;->e:F
    ...
    iget v4, p0, Landroid/support/design/widget/ce;->e:F
    ...
    :cond_0
    :goto_0
    invoke-direct {p0, v1, v0}, Landroid/support/design/widget/ce;->b(II)V
...
.method a(I)V
    ...
    iget-object v0, p0, Landroid/support/design/widget/ce;->c:Landroid/graphics/Paint;
...
.method a(IF)V
    ...
    iget-object v0, p0, Landroid/support/design/widget/ce;->h:Landroid/support/design/widget/cs;
    ...
    iput p2, p0, Landroid/support/design/widget/ce;->e:F

    invoke-direct {p0}, Landroid/support/design/widget/ce;->c()V
...
.method a(II)V
    ...
    iput-object v6, p0, Landroid/support/design/widget/ce;->h:Landroid/support/design/widget/cs;

    sget-object v0, Landroid/support/design/widget/a;->b:Landroid/view/animation/Interpolator;

    invoke-virtual {v6, v0}, Landroid/support/design/widget/cs;->a(Landroid/view/animation/Interpolator;)V

    invoke-virtual {v6, p2}, Landroid/support/design/widget/cs;->a(I)V

    const/4 v0, 0x0

    const/high16 v1, 0x3f800000    # 1.0f

    invoke-virtual {v6, v0, v1}, Landroid/support/design/widget/cs;->a(FF)V
    ...
    invoke-virtual {v6, v0}, Landroid/support/design/widget/cs;->a(Landroid/support/design/widget/cx;)V
    ...
    invoke-virtual {v6, v0}, Landroid/support/design/widget/cs;->a(Landroid/support/design/widget/cv;)V

    invoke-virtual {v6}, Landroid/support/design/widget/cs;->a()V

    goto :goto_1

    :cond_5
    iget-object v1, p0, Landroid/support/design/widget/ce;->a:Landroid/support/design/widget/TabLayout;
...
.method a()Z
    ...
    invoke-virtual {p0, v1}, Landroid/support/design/widget/ce;->getChildAt(I)Landroid/view/View;
...
.method b()F
    ...
    iget v1, p0, Landroid/support/design/widget/ce;->e:F
...
.method public draw(Landroid/graphics/Canvas;)V
    ...
    iget v2, p0, Landroid/support/design/widget/ce;->b:I
    ...
    iget-object v5, p0, Landroid/support/design/widget/ce;->c:Landroid/graphics/Paint;
...
.method protected onLayout(ZIIII)V
    ...
    invoke-virtual {v0}, Landroid/support/design/widget/cs;->g()J
    ...
    iget-object v4, p0, Landroid/support/design/widget/ce;->h:Landroid/support/design/widget/cs;

    invoke-virtual {v4}, Landroid/support/design/widget/cs;->f()F
    ...
    invoke-virtual {p0, v2, v0}, Landroid/support/design/widget/ce;->a(II)V
...
.method protected onMeasure(II)V
    ...
    :cond_1
    iget-object v0, p0, Landroid/support/design/widget/ce;->a:Landroid/support/design/widget/TabLayout;
