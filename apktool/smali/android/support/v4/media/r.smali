...
.method constructor <init>(Landroid/support/v4/media/n;Landroid/support/v4/media/k;Ljava/lang/String;Landroid/os/Bundle;)V
    ...
    iput-object p1, p0, Landroid/support/v4/media/r;->d:Landroid/support/v4/media/n;

    iput-object p2, p0, Landroid/support/v4/media/r;->a:Landroid/support/v4/media/k;

    iput-object p3, p0, Landroid/support/v4/media/r;->b:Ljava/lang/String;

    iput-object p4, p0, Landroid/support/v4/media/r;->c:Landroid/os/Bundle;
...
.method public run()V
    ...
    iget-object v0, p0, Landroid/support/v4/media/r;->a:Landroid/support/v4/media/k;

    invoke-interface {v0}, Landroid/support/v4/media/k;->a()Landroid/os/IBinder;

    move-result-object v0

    iget-object v1, p0, Landroid/support/v4/media/r;->d:Landroid/support/v4/media/n;
    ...
    iget-object v2, p0, Landroid/support/v4/media/r;->b:Ljava/lang/String;
    ...
    iget-object v3, p0, Landroid/support/v4/media/r;->c:Landroid/os/Bundle;

    invoke-static {v1, v2, v0, v3}, Landroid/support/v4/media/MediaBrowserServiceCompat;->b(Landroid/support/v4/media/MediaBrowserServiceCompat;Ljava/lang/String;Landroid/support/v4/media/i;Landroid/os/Bundle;)Z
