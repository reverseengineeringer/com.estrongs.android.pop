...
.field private mListener:Landroid/support/v4/view/fo;

.field private final mProxyListener:Landroid/support/v4/view/fp;
...
.method public constructor <init>()V
    ...
    iput-object v0, p0, Landroid/support/v7/view/ViewPropertyAnimatorCompatSet;->mProxyListener:Landroid/support/v4/view/fp;
...
.method static synthetic access$000(Landroid/support/v7/view/ViewPropertyAnimatorCompatSet;)Landroid/support/v4/view/fo;
    .locals 1

    iget-object v0, p0, Landroid/support/v7/view/ViewPropertyAnimatorCompatSet;->mListener:Landroid/support/v4/view/fo;
...
.method public play(Landroid/support/v4/view/ex;)Landroid/support/v7/view/ViewPropertyAnimatorCompatSet;
    .locals 1
...
.method public playSequentially(Landroid/support/v4/view/ex;Landroid/support/v4/view/ex;)Landroid/support/v7/view/ViewPropertyAnimatorCompatSet;
    .locals 2
    ...
    invoke-virtual {p1}, Landroid/support/v4/view/ex;->a()J

    move-result-wide v0

    invoke-virtual {p2, v0, v1}, Landroid/support/v4/view/ex;->b(J)Landroid/support/v4/view/ex;
...
.method public setListener(Landroid/support/v4/view/fo;)Landroid/support/v7/view/ViewPropertyAnimatorCompatSet;
    .locals 1
    ...
    iput-object p1, p0, Landroid/support/v7/view/ViewPropertyAnimatorCompatSet;->mListener:Landroid/support/v4/view/fo;
...
.method public start()V
    ...
    :cond_2
    iget-object v2, p0, Landroid/support/v7/view/ViewPropertyAnimatorCompatSet;->mListener:Landroid/support/v4/view/fo;

    if-eqz v2, :cond_3

    iget-object v2, p0, Landroid/support/v7/view/ViewPropertyAnimatorCompatSet;->mProxyListener:Landroid/support/v4/view/fp;
