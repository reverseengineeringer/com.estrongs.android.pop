...
.method static synthetic access$1000(Landroid/support/v7/widget/ActionMenuPresenter;)Landroid/support/v7/view/menu/z;
    .locals 1

    iget-object v0, p0, Landroid/support/v7/widget/ActionMenuPresenter;->mMenuView:Landroid/support/v7/view/menu/z;
...
.method static synthetic access$400(Landroid/support/v7/widget/ActionMenuPresenter;)Landroid/support/v7/view/menu/i;
    .locals 1

    iget-object v0, p0, Landroid/support/v7/widget/ActionMenuPresenter;->mMenu:Landroid/support/v7/view/menu/i;

    return-object v0
.end method

.method static synthetic access$500(Landroid/support/v7/widget/ActionMenuPresenter;)Landroid/support/v7/view/menu/i;
    .locals 1
...
.method static synthetic access$700(Landroid/support/v7/widget/ActionMenuPresenter;)Landroid/support/v7/view/menu/z;
    .locals 1
...
.method static synthetic access$900(Landroid/support/v7/widget/ActionMenuPresenter;)Landroid/support/v7/view/menu/i;
    .locals 1
...
# virtual methods
.method public bindItemView(Landroid/support/v7/view/menu/m;Landroid/support/v7/view/menu/aa;)V
    .locals 2
...
.method public filterLeftoverView(Landroid/view/ViewGroup;I)Z
    ...
    :cond_0
    invoke-super {p0, p1, p2}, Landroid/support/v7/view/menu/d;->filterLeftoverView(Landroid/view/ViewGroup;I)Z
...
.method public flagActionItems()Z
    ...
    iget-object v2, v0, Landroid/support/v7/widget/ActionMenuPresenter;->mMenu:Landroid/support/v7/view/menu/i;
    ...
    iget-object v2, v0, Landroid/support/v7/widget/ActionMenuPresenter;->mMenuView:Landroid/support/v7/view/menu/z;
    ...
    invoke-virtual {v0, v3, v6, v2}, Landroid/support/v7/widget/ActionMenuPresenter;->getItemView(Landroid/support/v7/view/menu/m;Landroid/view/View;Landroid/view/ViewGroup;)Landroid/view/View;
    ...
    invoke-virtual {v0, v3, v8, v2}, Landroid/support/v7/widget/ActionMenuPresenter;->getItemView(Landroid/support/v7/view/menu/m;Landroid/view/View;Landroid/view/ViewGroup;)Landroid/view/View;
...
.method public getItemView(Landroid/support/v7/view/menu/m;Landroid/view/View;Landroid/view/ViewGroup;)Landroid/view/View;
    .locals 3
    ...
    :cond_0
    invoke-super {p0, p1, p2, p3}, Landroid/support/v7/view/menu/d;->getItemView(Landroid/support/v7/view/menu/m;Landroid/view/View;Landroid/view/ViewGroup;)Landroid/view/View;
...
.method public getMenuView(Landroid/view/ViewGroup;)Landroid/support/v7/view/menu/z;
    ...
    invoke-super {p0, p1}, Landroid/support/v7/view/menu/d;->getMenuView(Landroid/view/ViewGroup;)Landroid/support/v7/view/menu/z;
...
.method public initForMenu(Landroid/content/Context;Landroid/support/v7/view/menu/i;)V
    ...
    invoke-super {p0, p1, p2}, Landroid/support/v7/view/menu/d;->initForMenu(Landroid/content/Context;Landroid/support/v7/view/menu/i;)V
...
.method public onCloseMenu(Landroid/support/v7/view/menu/i;Z)V
    ...
    invoke-super {p0, p1, p2}, Landroid/support/v7/view/menu/d;->onCloseMenu(Landroid/support/v7/view/menu/i;Z)V
...
.method public onRestoreInstanceState(Landroid/os/Parcelable;)V
    ...
    invoke-virtual {p0, v0}, Landroid/support/v7/widget/ActionMenuPresenter;->onSubMenuSelected(Landroid/support/v7/view/menu/ad;)Z
...
.method public onSubMenuSelected(Landroid/support/v7/view/menu/ad;)Z
    ...
    iget-object v3, p0, Landroid/support/v7/widget/ActionMenuPresenter;->mMenu:Landroid/support/v7/view/menu/i;
    ...
    invoke-direct {v1, p0, v2, p1}, Landroid/support/v7/widget/ActionMenuPresenter$ActionButtonSubmenu;-><init>(Landroid/support/v7/widget/ActionMenuPresenter;Landroid/content/Context;Landroid/support/v7/view/menu/ad;)V
    ...
    invoke-super {p0, p1}, Landroid/support/v7/view/menu/d;->onSubMenuSelected(Landroid/support/v7/view/menu/ad;)Z
...
.method public onSubUiVisibilityChanged(Z)V
    ...
    invoke-super {p0, v0}, Landroid/support/v7/view/menu/d;->onSubMenuSelected(Landroid/support/v7/view/menu/ad;)Z
...
.method public setMenuView(Landroid/support/v7/widget/ActionMenuView;)V
    ...
    iput-object p1, p0, Landroid/support/v7/widget/ActionMenuPresenter;->mMenuView:Landroid/support/v7/view/menu/z;

    iget-object v0, p0, Landroid/support/v7/widget/ActionMenuPresenter;->mMenu:Landroid/support/v7/view/menu/i;

    invoke-virtual {p1, v0}, Landroid/support/v7/widget/ActionMenuView;->initialize(Landroid/support/v7/view/menu/i;)V
...
.method public shouldIncludeItem(ILandroid/support/v7/view/menu/m;)Z
    .locals 1
...
.method public showOverflowMenu()Z
    ...
    invoke-direct/range {v0 .. v5}, Landroid/support/v7/widget/ActionMenuPresenter$OverflowPopup;-><init>(Landroid/support/v7/widget/ActionMenuPresenter;Landroid/content/Context;Landroid/support/v7/view/menu/i;Landroid/view/View;Z)V
...
.method public updateMenuView(Z)V
    ...
    :cond_0
    invoke-super {p0, p1}, Landroid/support/v7/view/menu/d;->updateMenuView(Z)V
    ...
    iget-object v1, p0, Landroid/support/v7/widget/ActionMenuPresenter;->mMenuView:Landroid/support/v7/view/menu/z;
