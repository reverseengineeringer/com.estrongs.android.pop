...
.field listMenuPresenter:Landroid/support/v7/view/menu/g;

.field listPresenterContext:Landroid/content/Context;

.field menu:Landroid/support/v7/view/menu/i;
...
.method applyFrozenState()V
    ...
    iget-object v0, p0, Landroid/support/v7/app/AppCompatDelegateImplV7$PanelFeatureState;->menu:Landroid/support/v7/view/menu/i;
    ...
    invoke-virtual {v0, v1}, Landroid/support/v7/view/menu/i;->b(Landroid/os/Bundle;)V
...
.method public clearMenuPresenters()V
    ...
    iget-object v1, p0, Landroid/support/v7/app/AppCompatDelegateImplV7$PanelFeatureState;->listMenuPresenter:Landroid/support/v7/view/menu/g;
    ...
    iput-object v0, p0, Landroid/support/v7/app/AppCompatDelegateImplV7$PanelFeatureState;->listMenuPresenter:Landroid/support/v7/view/menu/g;

    return-void
.end method

.method getListMenuView(Landroid/support/v7/view/menu/y;)Landroid/support/v7/view/menu/z;
    .locals 3
    ...
    :cond_0
    iget-object v0, p0, Landroid/support/v7/app/AppCompatDelegateImplV7$PanelFeatureState;->listMenuPresenter:Landroid/support/v7/view/menu/g;
...
.method public hasPanelItems()Z
    ...
    iget-object v2, p0, Landroid/support/v7/app/AppCompatDelegateImplV7$PanelFeatureState;->listMenuPresenter:Landroid/support/v7/view/menu/g;
...
.method onSaveInstanceState()Landroid/os/Parcelable;
    ...
    iget-object v1, p0, Landroid/support/v7/app/AppCompatDelegateImplV7$PanelFeatureState;->menu:Landroid/support/v7/view/menu/i;
    ...
    invoke-virtual {v1, v2}, Landroid/support/v7/view/menu/i;->a(Landroid/os/Bundle;)V

    :cond_0
    return-object v0
.end method

.method setMenu(Landroid/support/v7/view/menu/i;)V
    .locals 2
    ...
    :cond_2
    iput-object p1, p0, Landroid/support/v7/app/AppCompatDelegateImplV7$PanelFeatureState;->menu:Landroid/support/v7/view/menu/i;
