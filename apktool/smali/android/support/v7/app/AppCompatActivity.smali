...
# interfaces
.implements Landroid/support/v4/app/cj;
...
.method public dispatchKeyEvent(Landroid/view/KeyEvent;)Z
    ...
    invoke-static {p1, v1}, Landroid/support/v4/view/aa;->a(Landroid/view/KeyEvent;I)Z
...
.method public getSupportParentActivityIntent()Landroid/content/Intent;
    ...
    invoke-static {p0}, Landroid/support/v4/app/bo;->a(Landroid/app/Activity;)Landroid/content/Intent;
...
.method public onCreateSupportNavigateUpTaskStack(Landroid/support/v4/app/ci;)V
    .locals 0

    invoke-virtual {p1, p0}, Landroid/support/v4/app/ci;->a(Landroid/app/Activity;)Landroid/support/v4/app/ci;
...
.method public onPrepareSupportNavigateUpTaskStack(Landroid/support/v4/app/ci;)V
    .locals 0
...
.method public onSupportNavigateUp()Z
    ...
    invoke-static {p0}, Landroid/support/v4/app/ci;->a(Landroid/content/Context;)Landroid/support/v4/app/ci;

    move-result-object v0

    invoke-virtual {p0, v0}, Landroid/support/v7/app/AppCompatActivity;->onCreateSupportNavigateUpTaskStack(Landroid/support/v4/app/ci;)V

    invoke-virtual {p0, v0}, Landroid/support/v7/app/AppCompatActivity;->onPrepareSupportNavigateUpTaskStack(Landroid/support/v4/app/ci;)V

    invoke-virtual {v0}, Landroid/support/v4/app/ci;->a()V
...
.method public supportNavigateUpTo(Landroid/content/Intent;)V
    ...
    invoke-static {p0, p1}, Landroid/support/v4/app/bo;->b(Landroid/app/Activity;Landroid/content/Intent;)V
...
.method public supportShouldUpRecreateTask(Landroid/content/Intent;)Z
    ...
    invoke-static {p0, p1}, Landroid/support/v4/app/bo;->a(Landroid/app/Activity;Landroid/content/Intent;)Z
