...
.method public constructor <init>(Lcom/estrongs/android/pop/app/AudioPlayerService;)V
    ...
    iput-object p1, p0, Lcom/estrongs/android/ui/notification/b;->a:Lcom/estrongs/android/pop/app/AudioPlayerService;

    const/4 v0, 0x0

    iput-boolean v0, p0, Lcom/estrongs/android/ui/notification/b;->b:Z
...
.method public a()V
    ...
    invoke-virtual {p0}, Lcom/estrongs/android/ui/notification/b;->b()V
    ...
    :cond_1
    invoke-virtual {p0}, Lcom/estrongs/android/ui/notification/b;->c()V
...
.method public a(Ljava/lang/String;Ljava/lang/CharSequence;)V
    ...
    :try_start_0
    iget-object v0, p0, Lcom/estrongs/android/ui/notification/b;->a:Lcom/estrongs/android/pop/app/AudioPlayerService;
    ...
    iget-object v2, p0, Lcom/estrongs/android/ui/notification/b;->a:Lcom/estrongs/android/pop/app/AudioPlayerService;
    ...
    iget-object v1, p0, Lcom/estrongs/android/ui/notification/b;->a:Lcom/estrongs/android/pop/app/AudioPlayerService;
...
.method public b()V
    ...
    iget-object v3, p0, Lcom/estrongs/android/ui/notification/b;->a:Lcom/estrongs/android/pop/app/AudioPlayerService;
    ...
    invoke-static {v2, v3}, Lcom/estrongs/android/ui/d/g;->a(Landroid/graphics/Bitmap;I)Landroid/graphics/Bitmap;
    :try_end_0
    .catch Ljava/lang/Exception; {:try_start_0 .. :try_end_0} :catch_0
    ...
    invoke-virtual {p0}, Lcom/estrongs/android/ui/notification/b;->d()Landroid/app/PendingIntent;

    move-result-object v3

    invoke-virtual {v1, v2, v3}, Landroid/widget/RemoteViews;->setOnClickPendingIntent(ILandroid/app/PendingIntent;)V

    invoke-virtual {p0}, Lcom/estrongs/android/ui/notification/b;->e()Landroid/app/PendingIntent;
    ...
    invoke-virtual {p0}, Lcom/estrongs/android/ui/notification/b;->f()Landroid/app/PendingIntent;
    ...
    invoke-virtual {p0}, Lcom/estrongs/android/ui/notification/b;->g()Landroid/app/PendingIntent;
    ...
    :goto_1
    new-instance v2, Lcom/estrongs/android/ui/notification/d;

    iget-object v3, p0, Lcom/estrongs/android/ui/notification/b;->a:Lcom/estrongs/android/pop/app/AudioPlayerService;

    const/4 v4, 0x0

    invoke-direct {v2, v3, v4}, Lcom/estrongs/android/ui/notification/d;-><init>(Landroid/content/Context;Z)V

    invoke-virtual {v2, v1}, Lcom/estrongs/android/ui/notification/d;->a(Landroid/widget/RemoteViews;)V

    invoke-virtual {v2, v5}, Lcom/estrongs/android/ui/notification/d;->a(Z)V
    ...
    invoke-virtual {v2, v1, v5}, Lcom/estrongs/android/ui/notification/d;->a(Landroid/content/Intent;Z)V

    const v1, 0x7f0202c2

    invoke-virtual {v2, v1}, Lcom/estrongs/android/ui/notification/d;->a(I)V
    ...
    invoke-virtual {v2, v1}, Lcom/estrongs/android/ui/notification/d;->a(Ljava/lang/CharSequence;)V

    invoke-virtual {v2}, Lcom/estrongs/android/ui/notification/d;->d()Landroid/app/Notification;
    ...
    :goto_2
    iget-object v1, p0, Lcom/estrongs/android/ui/notification/b;->c:Landroid/graphics/Bitmap;
    ...
    :cond_1
    :goto_3
    iput-object v0, p0, Lcom/estrongs/android/ui/notification/b;->c:Landroid/graphics/Bitmap;
...
.method public c()V
    ...
    invoke-virtual {p0, v0, v1}, Lcom/estrongs/android/ui/notification/b;->a(Ljava/lang/String;Ljava/lang/CharSequence;)V
    ...
    :goto_2
    invoke-virtual {p0, v1, v0}, Lcom/estrongs/android/ui/notification/b;->a(Ljava/lang/String;Ljava/lang/CharSequence;)V
...
.method public h()Z
    ...
    iget-boolean v0, p0, Lcom/estrongs/android/ui/notification/b;->b:Z
