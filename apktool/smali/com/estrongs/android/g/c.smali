.class public Lcom/estrongs/android/g/c;
...
.method static constructor <clinit>()V
    ...
    sput-object v0, Lcom/estrongs/android/g/c;->d:Lde/aflx/sardine/util/Logger;

    new-instance v0, Ljava/util/HashMap;

    invoke-direct {v0}, Ljava/util/HashMap;-><init>()V

    sput-object v0, Lcom/estrongs/android/g/c;->b:Ljava/util/HashMap;
...
.method public constructor <init>()V
    ...
    invoke-direct {p0, v0, v0}, Lcom/estrongs/android/g/c;-><init>(Ljava/lang/String;Ljava/lang/String;)V
...
.method public constructor <init>(Ljava/lang/String;Ljava/lang/String;)V
    ...
    invoke-direct {p0, p1, p2, v0}, Lcom/estrongs/android/g/c;-><init>(Ljava/lang/String;Ljava/lang/String;Ljava/net/ProxySelector;)V
...
.method public constructor <init>(Ljava/lang/String;Ljava/lang/String;Ljava/net/ProxySelector;)V
    ...
    iput-boolean v0, p0, Lcom/estrongs/android/g/c;->a:Z

    const/4 v0, 0x0

    iput-object v0, p0, Lcom/estrongs/android/g/c;->e:Lorg/apache/http/Header;

    new-instance v0, Lorg/apache/http/protocol/BasicHttpContext;

    invoke-direct {v0}, Lorg/apache/http/protocol/BasicHttpContext;-><init>()V

    iput-object v0, p0, Lcom/estrongs/android/g/c;->g:Lorg/apache/http/protocol/HttpContext;

    new-instance v0, Lcom/estrongs/android/g/d;

    invoke-direct {v0, p0}, Lcom/estrongs/android/g/d;-><init>(Lcom/estrongs/android/g/c;)V

    iput-object v0, p0, Lcom/estrongs/android/g/c;->c:Lorg/apache/http/HttpRequestInterceptor;

    invoke-virtual {p0, p3}, Lcom/estrongs/android/g/c;->a(Ljava/net/ProxySelector;)Lorg/apache/http/impl/client/AbstractHttpClient;

    move-result-object v0

    invoke-direct {p0, v0, p1, p2}, Lcom/estrongs/android/g/c;->a(Lorg/apache/http/impl/client/AbstractHttpClient;Ljava/lang/String;Ljava/lang/String;)V
...
.method public constructor <init>(Lorg/apache/http/impl/client/AbstractHttpClient;Ljava/lang/String;Ljava/lang/String;)V
    ...
    invoke-direct {p0, p1, p2, p3}, Lcom/estrongs/android/g/c;->a(Lorg/apache/http/impl/client/AbstractHttpClient;Ljava/lang/String;Ljava/lang/String;)V

    return-void
.end method

.method static synthetic a(Lcom/estrongs/android/g/c;)Lorg/apache/http/Header;
    .locals 1

    iget-object v0, p0, Lcom/estrongs/android/g/c;->e:Lorg/apache/http/Header;
...
.method private a(Lorg/apache/http/impl/client/AbstractHttpClient;Ljava/lang/String;Ljava/lang/String;)V
    ...
    iput-object p1, p0, Lcom/estrongs/android/g/c;->f:Lorg/apache/http/impl/client/AbstractHttpClient;

    iget-object v0, p0, Lcom/estrongs/android/g/c;->f:Lorg/apache/http/impl/client/AbstractHttpClient;

    iget-object v1, p0, Lcom/estrongs/android/g/c;->c:Lorg/apache/http/HttpRequestInterceptor;
    ...
    invoke-virtual {p0, p2, p3}, Lcom/estrongs/android/g/c;->a(Ljava/lang/String;Ljava/lang/String;)V

    sget-object v0, Lcom/estrongs/android/g/c;->d:Lde/aflx/sardine/util/Logger;
...
.method public a(Lorg/apache/http/client/methods/HttpRequestBase;)Lorg/apache/http/HttpResponse;
    ...
    iget-object v3, p0, Lcom/estrongs/android/g/c;->g:Lorg/apache/http/protocol/HttpContext;
    ...
    iget-object v0, p0, Lcom/estrongs/android/g/c;->g:Lorg/apache/http/protocol/HttpContext;
    ...
    sget-object v0, Lcom/estrongs/android/g/c;->b:Ljava/util/HashMap;
    ...
    invoke-static {v5}, Lcom/estrongs/android/util/bk;->b(Ljava/lang/CharSequence;)Z
    ...
    iput-object v5, p0, Lcom/estrongs/android/g/c;->e:Lorg/apache/http/Header;
    :try_end_1
    ...
    :goto_0
    :try_start_3
    sget-object v1, Lcom/estrongs/android/g/c;->b:Ljava/util/HashMap;
    ...
    invoke-virtual {p0, p1}, Lcom/estrongs/android/g/c;->a(Lorg/apache/http/client/methods/HttpRequestBase;)Lorg/apache/http/HttpResponse;
    :try_end_4
...
.method protected a(Lorg/apache/http/conn/scheme/SchemeRegistry;)Lorg/apache/http/conn/ClientConnectionManager;
    ...
    invoke-virtual {p0}, Lcom/estrongs/android/g/c;->b()Lorg/apache/http/params/HttpParams;
...
.method protected a(Ljava/net/ProxySelector;)Lorg/apache/http/impl/client/AbstractHttpClient;
    ...
    invoke-virtual {p0}, Lcom/estrongs/android/g/c;->c()Lorg/apache/http/conn/scheme/SchemeRegistry;

    move-result-object v0

    invoke-virtual {p0, v0}, Lcom/estrongs/android/g/c;->a(Lorg/apache/http/conn/scheme/SchemeRegistry;)Lorg/apache/http/conn/ClientConnectionManager;
    ...
    invoke-virtual {p0, v0, p1}, Lcom/estrongs/android/g/c;->a(Lorg/apache/http/conn/scheme/SchemeRegistry;Ljava/net/ProxySelector;)Lorg/apache/http/conn/routing/HttpRoutePlanner;
...
.method public a(Ljava/lang/String;Ljava/lang/String;)V
    ...
    invoke-virtual {p0, p1, p2, v0, v1}, Lcom/estrongs/android/g/c;->a(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)V
...
.method protected c()Lorg/apache/http/conn/scheme/SchemeRegistry;
    ...
    invoke-virtual {p0}, Lcom/estrongs/android/g/c;->d()Lorg/apache/http/conn/scheme/PlainSocketFactory;
    ...
    invoke-direct {v2, v1}, Lcom/estrongs/android/util/n;-><init>(Ljava/security/KeyStore;)V
