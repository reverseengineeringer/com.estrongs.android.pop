.class public Lcom/estrongs/android/h/h;
.super Ljava/lang/Object;


# static fields
.field private static e:Lcom/estrongs/android/h/h;
...
.method protected constructor <init>(Landroid/content/Context;)V
    ...
    iput-object v0, p0, Lcom/estrongs/android/h/h;->c:Ljava/lang/String;

    iput-object v0, p0, Lcom/estrongs/android/h/h;->d:Ljava/lang/String;

    iput-object p1, p0, Lcom/estrongs/android/h/h;->b:Landroid/content/Context;

    invoke-direct {p0}, Lcom/estrongs/android/h/h;->a()V

    invoke-direct {p0}, Lcom/estrongs/android/h/h;->b()V

    invoke-static {p1}, Lcom/estrongs/fs/d;->a(Landroid/content/Context;)Lcom/estrongs/fs/d;

    move-result-object v0

    iput-object v0, p0, Lcom/estrongs/android/h/h;->a:Lcom/estrongs/fs/d;
...
.method private a(Ljava/lang/String;Landroid/graphics/BitmapFactory$Options;ILjava/io/InputStream;)Landroid/graphics/Bitmap;
    ...
    invoke-direct {p0, p1, p4}, Lcom/estrongs/android/h/h;->c(Ljava/lang/String;Ljava/io/InputStream;)Landroid/os/MemoryFile;
    ...
    :cond_0
    invoke-direct {p0, p1}, Lcom/estrongs/android/h/h;->b(Ljava/lang/String;)Ljava/io/InputStream;
    ...
    :goto_2
    invoke-static {p2, p3}, Lcom/estrongs/android/h/h;->a(Landroid/graphics/BitmapFactory$Options;I)I
    ...
    iget-object v0, p0, Lcom/estrongs/android/h/h;->b:Landroid/content/Context;
...
.method public static a(Landroid/content/Context;)Lcom/estrongs/android/h/h;
    .locals 1

    sget-object v0, Lcom/estrongs/android/h/h;->e:Lcom/estrongs/android/h/h;
    ...
    :cond_0
    new-instance v0, Lcom/estrongs/android/h/h;

    invoke-direct {v0, p0}, Lcom/estrongs/android/h/h;-><init>(Landroid/content/Context;)V

    sput-object v0, Lcom/estrongs/android/h/h;->e:Lcom/estrongs/android/h/h;
...
.method private a(Ljava/lang/String;)Ljava/lang/String;
    ...
    iget-object v1, p0, Lcom/estrongs/android/h/h;->c:Ljava/lang/String;
...
.method private b(Ljava/lang/String;)Ljava/io/InputStream;
    ...
    iget-object v0, p0, Lcom/estrongs/android/h/h;->a:Lcom/estrongs/fs/d;
...
.method private c(Ljava/lang/String;Ljava/io/InputStream;)Landroid/os/MemoryFile;
    ...
    iget-object v2, p0, Lcom/estrongs/android/h/h;->a:Lcom/estrongs/fs/d;
...
.method public a(ILjava/lang/String;Landroid/graphics/BitmapFactory$Options;)Landroid/graphics/Bitmap;
    ...
    invoke-virtual {p0, p1, p2, p3, v0}, Lcom/estrongs/android/h/h;->a(ILjava/lang/String;Landroid/graphics/BitmapFactory$Options;Ljava/io/InputStream;)Landroid/graphics/Bitmap;
...
.method public a(ILjava/lang/String;Landroid/graphics/BitmapFactory$Options;Ljava/io/InputStream;)Landroid/graphics/Bitmap;
    ...
    :cond_0
    :try_start_0
    invoke-direct {p0, p2, p3, p1, p4}, Lcom/estrongs/android/h/h;->a(Ljava/lang/String;Landroid/graphics/BitmapFactory$Options;ILjava/io/InputStream;)Landroid/graphics/Bitmap;
    :try_end_0
...
.method public a(Ljava/lang/String;Ljava/io/InputStream;)V
    ...
    invoke-direct {p0, p1}, Lcom/estrongs/android/h/h;->a(Ljava/lang/String;)Ljava/lang/String;
    ...
    :cond_0
    invoke-virtual {p0, p1, p2}, Lcom/estrongs/android/h/h;->b(Ljava/lang/String;Ljava/io/InputStream;)V
...
.method public b(Ljava/lang/String;Ljava/io/InputStream;)V
    ...
    :try_start_0
    invoke-virtual {p0, v1, p1, v2, p2}, Lcom/estrongs/android/h/h;->a(ILjava/lang/String;Landroid/graphics/BitmapFactory$Options;Ljava/io/InputStream;)Landroid/graphics/Bitmap;
    ...
    invoke-direct {p0, v1, v2}, Lcom/estrongs/android/h/h;->a(Landroid/graphics/Bitmap;Ljava/io/OutputStream;)V

    invoke-virtual {v2}, Ljava/io/FileOutputStream;->close()V

    invoke-static {v0}, Lcom/estrongs/android/h/a/e;->b(Ljava/lang/String;)Landroid/graphics/drawable/Drawable;
    :try_end_0
