...
.method private a(Lcom/estrongs/fs/b/an;IJ)V
    ...
    invoke-static {p2}, Lcom/estrongs/android/util/bc;->C(I)Z
    ...
    :cond_0
    invoke-static {p2}, Lcom/estrongs/android/util/bc;->e(I)Z
    ...
    :cond_1
    invoke-static {p2}, Lcom/estrongs/android/util/bc;->g(I)Z
    ...
    :cond_2
    invoke-static {p2}, Lcom/estrongs/android/util/bc;->a(I)Z
    ...
    :cond_3
    invoke-static {p2}, Lcom/estrongs/android/util/bc;->j(I)Z

    move-result v0

    if-nez v0, :cond_4

    invoke-static {p2}, Lcom/estrongs/android/util/bc;->u(I)Z

    move-result v0

    if-nez v0, :cond_4

    invoke-static {p2}, Lcom/estrongs/android/util/bc;->y(I)Z

    move-result v0

    if-nez v0, :cond_4

    invoke-static {p2}, Lcom/estrongs/android/util/bc;->v(I)Z

    move-result v0

    if-nez v0, :cond_4

    invoke-static {p2}, Lcom/estrongs/android/util/bc;->m(I)Z
