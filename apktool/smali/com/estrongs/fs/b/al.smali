...
.field public d:Lcom/estrongs/android/pop/i;
...
.field private k:Lcom/estrongs/fs/b/am;

.field private l:J


# direct methods
.method public constructor <init>(Lcom/estrongs/fs/d;Lcom/estrongs/android/pop/i;)V
    .locals 2
    ...
    iput-object v0, p0, Lcom/estrongs/fs/b/al;->c:Ljava/lang/Throwable;

    iput-object v0, p0, Lcom/estrongs/fs/b/al;->e:Lcom/estrongs/fs/util/a/a;

    iput-object v0, p0, Lcom/estrongs/fs/b/al;->f:Lcom/estrongs/fs/i;

    iput-object v0, p0, Lcom/estrongs/fs/b/al;->g:Ljava/lang/Boolean;

    iput-object v0, p0, Lcom/estrongs/fs/b/al;->j:Ljava/util/List;

    iput-object v0, p0, Lcom/estrongs/fs/b/al;->k:Lcom/estrongs/fs/b/am;

    new-instance v0, Lcom/estrongs/android/util/TypedMap;

    invoke-direct {v0}, Lcom/estrongs/android/util/TypedMap;-><init>()V

    iput-object v0, p0, Lcom/estrongs/fs/b/al;->h:Lcom/estrongs/android/util/TypedMap;

    const/4 v0, 0x0

    iput-boolean v0, p0, Lcom/estrongs/fs/b/al;->i:Z

    const-wide/16 v0, -0x1

    iput-wide v0, p0, Lcom/estrongs/fs/b/al;->l:J

    iput-object p1, p0, Lcom/estrongs/fs/b/al;->a:Lcom/estrongs/fs/d;

    iput-object p2, p0, Lcom/estrongs/fs/b/al;->d:Lcom/estrongs/android/pop/i;
...
.method private a()Z
    ...
    iget-object v1, p0, Lcom/estrongs/fs/b/al;->j:Ljava/util/List;

    if-nez v1, :cond_0

    invoke-virtual {p0}, Lcom/estrongs/fs/b/al;->getTaskResult()Lcom/estrongs/a/p;
    ...
    iget-object v1, p0, Lcom/estrongs/fs/b/al;->b:Lcom/estrongs/fs/h;
    ...
    invoke-virtual {p0, v0, v1}, Lcom/estrongs/fs/b/al;->setTaskResult(ILjava/lang/Object;)V
...
.method public a(Lcom/estrongs/fs/b/am;)V
    ...
    iput-object p1, p0, Lcom/estrongs/fs/b/al;->k:Lcom/estrongs/fs/b/am;
...
.method public a(Z)V
    ...
    invoke-virtual {p0}, Lcom/estrongs/fs/b/al;->requestStop()V
...
.method public varargs a([Ljava/lang/Object;)Z
    ...
    iput-object v0, p0, Lcom/estrongs/fs/b/al;->b:Lcom/estrongs/fs/h;
    ...
    iget-object v3, p0, Lcom/estrongs/fs/b/al;->b:Lcom/estrongs/fs/h;
    ...
    iget-object v3, p0, Lcom/estrongs/fs/b/al;->g:Ljava/lang/Boolean;
    ...
    iget-object v0, p0, Lcom/estrongs/fs/b/al;->b:Lcom/estrongs/fs/h;
...
.method public varargs handleMessage(I[Ljava/lang/Object;)V
    ...
    invoke-virtual {p0}, Lcom/estrongs/fs/b/al;->getTaskStatus()I
...
.method public onProgress(Lcom/estrongs/a/a/m;)V
    ...
    iget-wide v2, p0, Lcom/estrongs/fs/b/al;->l:J
...
.method public task()Z
    ...
    iput-object v2, p0, Lcom/estrongs/fs/b/al;->j:Ljava/util/List;

    :try_start_0
    invoke-static {}, Ljava/lang/System;->currentTimeMillis()J

    iget-object v2, p0, Lcom/estrongs/fs/b/al;->b:Lcom/estrongs/fs/h;
    ...
    iget-object v4, p0, Lcom/estrongs/fs/b/al;->a:Lcom/estrongs/fs/d;
    ...
    iget-object v5, p0, Lcom/estrongs/fs/b/al;->h:Lcom/estrongs/android/util/TypedMap;
    ...
    iget-object v2, p0, Lcom/estrongs/fs/b/al;->h:Lcom/estrongs/android/util/TypedMap;
    ...
    invoke-static {v2}, Lcom/estrongs/android/util/ap;->bi(Ljava/lang/String;)Z
    ...
    iget-object v6, p0, Lcom/estrongs/fs/b/al;->k:Lcom/estrongs/fs/b/am;

    invoke-virtual {v2, v5, v6}, Lcom/estrongs/android/util/TypedMap;->put(Ljava/lang/String;Ljava/lang/Object;)Lcom/estrongs/android/util/TypedMap;

    :cond_1
    iget-object v2, p0, Lcom/estrongs/fs/b/al;->a:Lcom/estrongs/fs/d;

    iget-object v5, p0, Lcom/estrongs/fs/b/al;->b:Lcom/estrongs/fs/h;

    iget-object v6, p0, Lcom/estrongs/fs/b/al;->g:Ljava/lang/Boolean;

    invoke-virtual {v6}, Ljava/lang/Boolean;->booleanValue()Z

    move-result v6

    iget-object v7, p0, Lcom/estrongs/fs/b/al;->f:Lcom/estrongs/fs/i;

    iget-object v8, p0, Lcom/estrongs/fs/b/al;->h:Lcom/estrongs/android/util/TypedMap;
    ...
    iget-object v2, p0, Lcom/estrongs/fs/b/al;->k:Lcom/estrongs/fs/b/am;
    ...
    :cond_2
    iget-object v2, p0, Lcom/estrongs/fs/b/al;->j:Ljava/util/List;

    if-eqz v2, :cond_4

    iget-object v2, p0, Lcom/estrongs/fs/b/al;->e:Lcom/estrongs/fs/util/a/a;
    ...
    :cond_3
    :try_start_1
    iget-object v3, p0, Lcom/estrongs/fs/b/al;->j:Ljava/util/List;
    ...
    :cond_4
    :try_start_2
    invoke-direct {p0}, Lcom/estrongs/fs/b/al;->a()Z
    ...
    invoke-static {v0, v2}, Lcom/estrongs/android/util/ap;->b(Ljava/lang/String;Lcom/estrongs/android/util/TypedMap;)Z

    move-result v0

    if-eqz v0, :cond_7

    iget-object v0, p0, Lcom/estrongs/fs/b/al;->h:Lcom/estrongs/android/util/TypedMap;
    ...
    invoke-virtual {p0, v0, v2}, Lcom/estrongs/fs/b/al;->setTaskResult(ILjava/lang/Object;)V
    :try_end_4
    ...
    :goto_2
    iget-object v2, p0, Lcom/estrongs/fs/b/al;->g:Ljava/lang/Boolean;
    ...
    iget-object v4, p0, Lcom/estrongs/fs/b/al;->b:Lcom/estrongs/fs/h;

    const/4 v5, 0x1

    iget-object v6, p0, Lcom/estrongs/fs/b/al;->f:Lcom/estrongs/fs/i;

    iget-object v7, p0, Lcom/estrongs/fs/b/al;->h:Lcom/estrongs/android/util/TypedMap;
    ...
    iget-object v4, p0, Lcom/estrongs/fs/b/al;->e:Lcom/estrongs/fs/util/a/a;
    ...
    iget-object v4, p0, Lcom/estrongs/fs/b/al;->j:Ljava/util/List;

    invoke-interface {v2, p0, v4}, Lcom/estrongs/fs/b/am;->a(Lcom/estrongs/fs/b/al;Ljava/util/List;)V
    ...
    iget-object v3, p0, Lcom/estrongs/fs/b/al;->h:Lcom/estrongs/android/util/TypedMap;
    ...
    iget-object v3, p0, Lcom/estrongs/fs/b/al;->a:Lcom/estrongs/fs/d;
    ...
    iput-object v3, p0, Lcom/estrongs/fs/b/al;->j:Ljava/util/List;
