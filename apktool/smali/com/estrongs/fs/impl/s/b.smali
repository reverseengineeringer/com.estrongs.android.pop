.class public Lcom/estrongs/fs/impl/s/b;
...
.field private static b:Lcom/estrongs/fs/impl/s/b;
...
.method static constructor <clinit>()V
    ...
    sput-object v0, Lcom/estrongs/fs/impl/s/b;->a:Ljava/util/Map;
...
.method public static a()Lcom/estrongs/fs/impl/s/b;
    .locals 1

    sget-object v0, Lcom/estrongs/fs/impl/s/b;->b:Lcom/estrongs/fs/impl/s/b;

    if-nez v0, :cond_0

    new-instance v0, Lcom/estrongs/fs/impl/s/b;

    invoke-direct {v0}, Lcom/estrongs/fs/impl/s/b;-><init>()V

    sput-object v0, Lcom/estrongs/fs/impl/s/b;->b:Lcom/estrongs/fs/impl/s/b;
...
.method private a(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Lcom/estrongs/a/b/o;Lcom/estrongs/fs/b/am;Ljava/util/List;Z)Ljava/util/List;
    .locals 9
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
            ...
            "Ljava/lang/String;",
            ">;",
            "Lcom/estrongs/fs/b/am;",
            "Ljava/util/List",
            "<",
            "Lcom/estrongs/android/pop/app/f/u;",
            ">;Z)",
            "Ljava/util/List",
            "<",
            "Lcom/estrongs/fs/h;",
    ...
    invoke-static {p3}, Lcom/estrongs/android/pop/app/f/q;->b(Ljava/lang/String;)Ljava/util/Map;
    ...
    :cond_0
    new-instance v4, Lcom/estrongs/android/pop/app/f/r;

    const/4 v1, 0x1

    invoke-direct {v4, v0, v1}, Lcom/estrongs/android/pop/app/f/r;-><init>(Ljava/util/Map;Z)V
    ...
    invoke-direct/range {v0 .. v8}, Lcom/estrongs/fs/impl/s/b;->a(Ljava/lang/String;Ljava/util/List;Ljava/lang/String;Lcom/estrongs/fs/i;ZZLcom/estrongs/fs/b/am;Ljava/util/List;)V
...
.method private a(Ljava/lang/String;Ljava/util/List;Ljava/lang/String;Lcom/estrongs/fs/i;ZZLcom/estrongs/fs/b/am;Ljava/util/List;)V
    .locals 16
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    check-cast v2, Lcom/estrongs/android/pop/app/f/r;

    invoke-virtual {v2}, Lcom/estrongs/android/pop/app/f/r;->a()Lcom/estrongs/android/pop/app/f/v;
    ...
    invoke-direct {v4, v2}, Lcom/estrongs/fs/x;-><init>(Ljava/lang/String;)V
    ...
    invoke-static {v4}, Lcom/estrongs/android/util/ap;->ca(Ljava/lang/String;)Ljava/lang/String;
    ...
    invoke-virtual {v2, v4, v5, v6}, Lcom/estrongs/android/pop/app/b/j;->a(Lcom/estrongs/fs/h;Lcom/estrongs/fs/i;Lcom/estrongs/android/util/TypedMap;)Ljava/util/List;
    ...
    new-instance v2, Lcom/estrongs/android/view/bn;
    ...
    invoke-direct {v2, v3, v6}, Lcom/estrongs/android/view/bn;-><init>(Ljava/lang/String;I)V
    ...
    invoke-direct {v2, v0}, Lcom/estrongs/fs/x;-><init>(Ljava/lang/String;)V
    ...
    invoke-static {v4}, Lcom/estrongs/android/util/ap;->bU(Ljava/lang/String;)Ljava/lang/String;
    ...
    invoke-static {v6}, Lcom/estrongs/android/util/ap;->bl(Ljava/lang/String;)Z
    ...
    invoke-static {v6}, Lcom/estrongs/android/util/ap;->a(Ljava/io/File;)Z
    ...
    :cond_b
    invoke-virtual {v3, v2}, Lcom/estrongs/android/view/bn;->a(Lcom/estrongs/fs/h;)Z
    ...
    :cond_f
    new-instance v6, Lcom/estrongs/fs/impl/s/a;

    move-object/from16 v0, p1

    move-object/from16 v1, p3

    invoke-direct {v6, v0, v1, v2}, Lcom/estrongs/fs/impl/s/a;-><init>(Ljava/lang/String;Ljava/lang/String;Lcom/estrongs/fs/h;)V

    if-eqz v10, :cond_10

    invoke-virtual {v10}, Lcom/estrongs/android/pop/app/f/v;->a()I

    move-result v2

    iput v2, v6, Lcom/estrongs/fs/impl/s/a;->a:I
    ...
    new-instance v2, Lcom/estrongs/fs/impl/s/c;

    move-object/from16 v0, p0

    invoke-direct {v2, v0}, Lcom/estrongs/fs/impl/s/c;-><init>(Lcom/estrongs/fs/impl/s/b;)V
    ...
    invoke-interface {v0, v2, v4}, Lcom/estrongs/fs/b/am;->a(Lcom/estrongs/fs/b/al;Ljava/util/List;)V
...
.method private e(Ljava/lang/String;)Ljava/util/List;
    ...
    invoke-static {v0, p1}, Lcom/estrongs/android/pop/app/f/q;->a(Ljava/lang/String;Ljava/lang/String;)Ljava/lang/String;
    ...
    invoke-static {v0}, Lcom/estrongs/android/pop/app/f/q;->a(Ljava/lang/String;)Ljava/util/List;
    ...
    new-instance v4, Lcom/estrongs/android/pop/app/f/u;
    ...
    invoke-direct {v4, v0}, Lcom/estrongs/android/pop/app/f/u;-><init>(Ljava/lang/String;)V
...
.method public a(Lcom/estrongs/fs/h;Lcom/estrongs/fs/i;Lcom/estrongs/android/util/TypedMap;)Ljava/util/List;
    ...
    check-cast v5, Lcom/estrongs/fs/b/am;

    const-string v0, "searchPath"

    invoke-static {v0, v3}, Lcom/estrongs/android/pop/app/f/q;->a(Ljava/lang/String;Ljava/lang/String;)Ljava/lang/String;
    ...
    invoke-direct {p0, v3}, Lcom/estrongs/fs/impl/s/b;->e(Ljava/lang/String;)Ljava/util/List;

    move-result-object v6

    invoke-static {v1, p3}, Lcom/estrongs/android/util/ap;->a(Ljava/lang/String;Lcom/estrongs/android/util/TypedMap;)Z
    ...
    invoke-direct/range {v0 .. v7}, Lcom/estrongs/fs/impl/s/b;->a(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Lcom/estrongs/a/b/o;Lcom/estrongs/fs/b/am;Ljava/util/List;Z)Ljava/util/List;

    invoke-static {v1, v2, p2, v3}, Lcom/estrongs/fs/impl/media/e;->a(Ljava/lang/String;Ljava/lang/String;Lcom/estrongs/fs/i;Ljava/lang/String;)Ljava/util/List;
    ...
    check-cast v0, Lcom/estrongs/fs/b/al;

    invoke-interface {v5, v0, v3}, Lcom/estrongs/fs/b/am;->a(Lcom/estrongs/fs/b/al;Ljava/util/List;)V
    ...
    invoke-static {v2}, Lcom/estrongs/android/util/ap;->bw(Ljava/lang/String;)Z
    ...
    new-instance v3, Lcom/estrongs/fs/impl/s/a;
    ...
    invoke-direct {v3, v7, v4, v0}, Lcom/estrongs/fs/impl/s/a;-><init>(Ljava/lang/String;Ljava/lang/String;Lcom/estrongs/fs/h;)V
