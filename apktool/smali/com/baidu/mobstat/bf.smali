...
.method private a(Landroid/content/Context;)Landroid/content/SharedPreferences;
    ...
    iget-object v0, p0, Lcom/baidu/mobstat/bf;->a:Landroid/content/SharedPreferences;
    ...
    iput-object v0, p0, Lcom/baidu/mobstat/bf;->a:Landroid/content/SharedPreferences;
...
.method private b(Landroid/content/Context;)Landroid/content/SharedPreferences;
    ...
    iget-object v0, p0, Lcom/baidu/mobstat/bf;->b:Landroid/content/SharedPreferences;
    ...
    iput-object v0, p0, Lcom/baidu/mobstat/bf;->b:Landroid/content/SharedPreferences;
...
.method public getBoolean(Landroid/content/Context;Ljava/lang/String;Z)Z
    ...
    invoke-direct {p0, p1}, Lcom/baidu/mobstat/bf;->a(Landroid/content/Context;)Landroid/content/SharedPreferences;
...
.method public getSharedBoolean(Landroid/content/Context;Ljava/lang/String;Z)Z
    ...
    invoke-direct {p0, p1}, Lcom/baidu/mobstat/bf;->b(Landroid/content/Context;)Landroid/content/SharedPreferences;
...
.method public updateShareBoolean(Landroid/content/Intent;Landroid/app/Activity;Ljava/lang/String;)Z
    ...
    invoke-virtual {p0, p1, p2, p3, v0}, Lcom/baidu/mobstat/bf;->updateShareBoolean(Landroid/content/Intent;Landroid/app/Activity;Ljava/lang/String;Z)Z
...
.method public updateShareBoolean(Landroid/content/Intent;Landroid/app/Activity;Ljava/lang/String;Z)Z
    ...
    invoke-virtual {p0, p2, p3, p4}, Lcom/baidu/mobstat/bf;->getSharedBoolean(Landroid/content/Context;Ljava/lang/String;Z)Z

    move-result v1

    if-eq v0, v1, :cond_0

    invoke-virtual {p0, p2, p3, v0}, Lcom/baidu/mobstat/bf;->putSharedBoolean(Landroid/content/Context;Ljava/lang/String;Z)V
...
.method public updateShareInt(Landroid/content/Intent;Landroid/app/Activity;Ljava/lang/String;I)Z
    ...
    invoke-virtual {p0, p2, p3, p4}, Lcom/baidu/mobstat/bf;->getSharedInt(Landroid/content/Context;Ljava/lang/String;I)I

    move-result v1

    if-eq v0, v1, :cond_0

    invoke-virtual {p0, p2, p3, v0}, Lcom/baidu/mobstat/bf;->putSharedInt(Landroid/content/Context;Ljava/lang/String;I)V
...
.method public updateShareString(Landroid/content/Intent;Landroid/app/Activity;Ljava/lang/String;)Z
    ...
    :cond_0
    invoke-virtual {p0, p2, p3, v1}, Lcom/baidu/mobstat/bf;->getSharedString(Landroid/content/Context;Ljava/lang/String;Ljava/lang/String;)Ljava/lang/String;
    ...
    invoke-virtual {p0, p2, p3, v0}, Lcom/baidu/mobstat/bf;->putSharedString(Landroid/content/Context;Ljava/lang/String;Ljava/lang/String;)V
